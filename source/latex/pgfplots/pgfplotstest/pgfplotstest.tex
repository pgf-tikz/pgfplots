...
\include{pgfplotstest.file}% CONVERTIERT
\include{pgfplotstest.scanline}% CONVERTIERT
\include{pgfplotstest.colormap}% CONVERTIERT
\include{pgfplotstest.marks}% CONVERTIERT
\include{pgfplotstest.function}% CONVERTIERT
