...
{
	% once more again with 'compat=default' mode:
	\pgfplotsset{compat=default}
	\makeatletter
	\let\testsection@old=\testsection
	\let\testsubsection@old=\testsubsection
	\let\testsubsubsection@old=\testsubsubsection
	\def\testsection#1{\testsection@old{[compat=default] #1}}
	\def\testsubsection#1{\testsubsection@old{[compat=default] #1}}
	\def\testsubsubsection#1{\testsubsubsection@old{[compat=default] #1}}
	\makeatother
	%\pgfplotstestcases
}
