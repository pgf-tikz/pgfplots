...
\pgfplotsset{
	...
	\pgfplotsassertequalstok{Sorry, the color component value 4.47052000000000 (no. 1) is out of range. The allowed range is 0 <= value <= 1. The error occured near `rgb255(5cm)=(238,1140,238)'}{\pgfplotsERRORMESSAGE}{}%
\end{document}
