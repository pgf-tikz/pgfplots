...
\testsubsection{With xgrid stop at y map}
\begin{tikzpicture}
%\tracingmacros=2 \tracingcommands=2
	\begin{smithchartaxis}[
		width=10cm,
		...
		xmin=0,xmax=5,
		ymin=-5,ymax=5,
		xgrid stop at y map={0.2:0.2 1:2 5:5},
		%xtick={0,30,...,360},
	]
	\end{smithchartaxis}
\end{tikzpicture}

\testsubsection{With ygrid stop at x map}
\begin{tikzpicture}
%\tracingmacros=2 \tracingcommands=2
	\begin{smithchartaxis}[
		width=10cm,
		...
		xmin=0,xmax=5,
		ymin=-5,ymax=5,
		ygrid stop at x map={0.2:1 1:5 2:0.5 5:5},
		%xtick={0,30,...,360},
	]
	\end{smithchartaxis}
\end{tikzpicture}
