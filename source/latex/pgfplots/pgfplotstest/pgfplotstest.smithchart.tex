...
%\tracingmacros=2 \tracingcommands=2
	\begin{smithchartaxis}[
		...
		extra tick style={xticklabel=\relax,yticklabel=\relax},
		ygrid stop at x={1,2,3,5,10:3,20:3},
		%xtick={0,30,...,360},
	]
	\addplot+[domain=-5:5] (0.5,\x);
	\addlegendentry{$x=0.5$}
...
\testsubsection{With ygrid stop at x and xgrid stop at y}
\begin{tikzpicture}
%\tracingmacros=2 \tracingcommands=2
	\begin{smithchartaxis}[
		width=10cm,
...
\testsubsubsection{manual limits + ticks + ygrid stop at x}
\begin{tikzpicture}
	\begin{smithchartaxis}[
		width=10cm,
		height=10cm,
