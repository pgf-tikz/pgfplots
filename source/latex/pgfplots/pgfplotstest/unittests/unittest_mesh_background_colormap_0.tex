...
%\tracingmacros=2 \tracingcommands=2
	...
	zmin=-1,zmax=4,
		...
		colormap/blackwhite,
		mesh/background colormap name={hot},
	]
...
%\tracingmacros=2 \tracingcommands=2
	...
	\draw[-stealth,blue] (axis cs:0,0,0)  \pgfextra{\pgfpathlineto\pgfplotspointviewdir};
	\end{axis}
\end{tikzpicture}
...
%  \addplot3 [/tikz/clip,red,samples=30,domain=0:2*pi,samples y=1] ({cos(deg(x))},{sin(deg(x))},{1});
  \addplot3 [surf, shader=flat] ({x*cos(deg(y))},{x*sin(deg(y))},{x});
%  \endscope
