...
\pgfplotsfillbetween[of=A and arc,on layer=,split,every even segment/.style={fill=none,draw=none}]{blue,opacity=50}


\pgfplotsfillbetween[of=B and arc,on layer=,split,
