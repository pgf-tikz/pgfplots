...
\def\pgfplots@contour@start{%
    ...
    \pgfplotsloop{%
        ...
        \wcontour{Running the array at \the\c@pgfplots@contour@level\ with value \pgfplots@contour@curlevel}
...
%          \wcontour{Running loop now: \the\c@pgfplots@contour@edge@loop}
...
%            \ifnum\pgfplots@contour@get@macro\c@pgfplots@contour@edge{edge}=0
              \def\pgfplots@contour@tmpA{x}
              \pgfplots@contour@calc@edge@matrix@elem#1,#2\of\c@pgfplots@contour@edge\to\pgfplots@contour@tmpB%
              \edef\pgfplots@contour@tmpB{\pgfplots@contour@tmpB}
              \wcontour{HelloA \E\E\pgfplots@contour@tmpB\relax\ifx\pgfplots@contour@tmpB\pgfplots@contour@tmpA Go through\else Has been runned for sure\fi}
%            \fi
            \ifx\pgfplots@contour@tmpB\pgfplots@contour@tmpA
%            \ifx\relax\relax
            % 
            % We now have to check if the current edge has a contour
              ...
              \wcontour{We are going to process: \pgfplots@contour@tmpC}
              ...
              % First calculate the intersection point x[i] and y[i]
                \ifnum\pgfplots@contour@tmpC=1
                  \xdef\pgfplots@contour@tmpA{\pgfplots@contour@get@macro\c@pgfplots@contour@edge{X}}
                  \xdef\pgfplots@contour@tmpB{\pgfplots@contour@get@macro\c@pgfplots@contour@edge{Y}}
                \else
