...
\def\pgfplots@contour@start{%
    ...
    \pgfplotsloop{%
        \ifnum\c@pgfplots@contour@level=3
...
%        \pgfmathsubtract{\pgfmathresult}{1}
...
%    \message{Fetching matrix values: \tmp}
    ...
    \ifpgfplots@contour@process
      ...
      \pgfplotsloop{%
          \ifnum\the\c@pgfplots@contour@edge@loop=4%
            \pgfplotsloopcontinuefalse%
          \else
            \pgfplotsloopcontinuetrue%
          \fi%          
...
%        \message{Hello \the\c@pgfplots@col}
        ...
        % \pgfplotsloop{%
        %     \ifnum\c@pgfplots@row@end=\the\c@pgfplots@row\relax%
        %       \pgfplotsloopcontinuefalse%
        %     \else%
        %       \pgfplotsloopcontinuetrue%
        %     \fi%
        ...
        % }{%
%            \message{RESETTING \the\c@pgfplots@row,\the\c@pgfplots@col}%
