...
\pgfkeys{
	...
	/pgf/decoration/soft clip path/.code={%
		\pgfplotslibfillbetween@softclip{\pgfplotslibfillbetween@softclip@assign}#1\pgfplots@EOI
	},
	/pgf/decoration/every soft clipped path/.style={},%
}

% #1 a macro containing a soft path
\def\pgfplotslibfillbetween@softclip@assign#1{%
	\let\pgf@decoration@soft@clip=#1%
}%

\pgfplotslibfillbetween@softclip@assign{\pgfutil@empty}%
...
% \pgfplotslibfillbetween@softclip{<\macro>} (<A>) rectangle (<B>)\pgf@stop
...
%  - \pgfplotslibfillbetween@softclip@trg contains a macro which will
...
\def\pgfplotslibfillbetween@softclip@@activate{%
	...
	\endpgfinterruptpath
	%
	\pgfplotslibfillbetween@softclip@trg\pgfplots@glob@TMPa
}%
% ---------------------------------------------------------------------------------
