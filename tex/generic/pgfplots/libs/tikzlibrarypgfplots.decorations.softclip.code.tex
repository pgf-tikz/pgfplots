...
\pgfkeys{
	...
	/pgf/decoration/soft clip path/.code={%
		\pgfplotslibsoftclip@setkey{\pgfplotslibsoftclip@setkey@assign}#1\pgfplots@EOI
	},
	/pgf/decoration/every soft clipped path/.style={},%
}

% #1 a macro containing a soft path
\def\pgfplotslibsoftclip@setkey@assign#1{%
	\let\pgf@decoration@soft@clip=#1%
}%

\pgfplotslibsoftclip@setkey@assign{\pgfutil@empty}%
...
% Defines "\def\pgfretval{0}" if (the first point of #1 is inside of or on the path #2)
...
% \pgfplotslibsoftclip@setkey{<\macro>} (<A>) rectangle (<B>)\pgf@stop
% #1: a macro which is called with the resulting clip path as argument #1.
\def\pgfplotslibsoftclip@setkey#1{%
	\def\pgfplotslibsoftclip@setkey@trg{#1}%
	\tikz@scan@one@point\pgfplotslibsoftclip@setkey@bb@scan@a
}%

\def\pgfplotslibsoftclip@setkey@bb@scan@a#1{%
	\def\pgfplotslibsoftclip@setkey@bb@a{#1}%
	\pgfutil@ifnextchar r{%
		\pgfplotslibsoftclip@setkey@bb@scan@rectangle
	}{%
		\pgfplotslibsoftclip@setkey@@error
	}%
}%

\def\pgfplotslibsoftclip@setkey@bb@scan@rectangle rectangle{%
	\tikz@scan@one@point\pgfplotslibsoftclip@setkey@bb@scan@b
}%

\def\pgfplotslibsoftclip@setkey@bb@scan@b#1{%
	\def\pgfplotslibsoftclip@setkey@bb@b{#1}%
	\pgfutil@ifnextchar \pgfplots@EOI{%
		\pgfplotslibsoftclip@setkey@@activate
...
\def\pgfplotslibsoftclip@setkey@@error#1\pgfplots@EOI{%
...
% INPUT:
%  - two PGF points \pgfplotslibsoftclip@setkey@bb@a and \pgfplotslibsoftclip@setkey@bb@b.
%  - \pgfplotslibsoftclip@setkey@trg contains a macro which will
...
\def\pgfplotslibsoftclip@setkey@@activate{%
	% Expand points to {<x>}{<y>} ...
	\pgf@process{\pgfplotslibsoftclip@setkey@bb@a}%
	\edef\pgfplotslibsoftclip@setkey@bb@a{{\the\pgf@x}{\the\pgf@y}}%
	\pgf@process{\pgfplotslibsoftclip@setkey@bb@b}%
	\edef\pgfplotslibsoftclip@setkey@bb@b{{\the\pgf@x}{\the\pgf@y}}%
	%
	\pgfinterruptpath
	\pgf@relevantforpicturesizefalse%
	\expandafter\pgfqpoint\pgfplotslibsoftclip@setkey@bb@a
	\pgf@xa=\pgf@x
	\pgf@ya=\pgf@y
	\expandafter\pgfqpoint\pgfplotslibsoftclip@setkey@bb@b
	\pgf@xb=\pgf@x
	\pgf@yb=\pgf@y
	%
	...
	\endpgfinterruptpath
	%
	\pgfplotslibsoftclip@setkey@trg\pgfplots@glob@TMPa
}%
% ---------------------------------------------------------------------------------
