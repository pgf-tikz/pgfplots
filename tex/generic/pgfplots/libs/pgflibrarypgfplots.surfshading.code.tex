...
\def\pgfplotslibrarysurf@bytespercomponent{3}%
\def\pgfplotslibrarysurf@bitspercomponent{24}%
...
\def\pgfplotslibrarysurf@encode@cdata#1{%
	...
	\else
		...
		% {<colorspaces>}{<comma-separated-components>}
		\edef\pgfplots@loc@TMPa{\expandafter\pgfutil@secondoftwo#1}%
		% now, \pgfplots@loc@TMPa contains the components (only).
