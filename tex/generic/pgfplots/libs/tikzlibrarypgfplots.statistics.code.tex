...
\def\pgfplotsplothandler@boxplot@init@percentile@estimator{%
	...
	\else
		...
		\or
			% R1:
			\pgfplots@error{not yet implemented in TeX: 'estimator=\pgfplots@boxplot@estimator'. This is only available using 'lua backend' and lualatex.}%
		\or	
			% R2:
			\pgfplots@error{not yet implemented in TeX: 'estimator=\pgfplots@boxplot@estimator'. This is only available using 'lua backend' and lualatex.}%
		\or	
		...
		\or	
			% R7:
			\let\pgfplotsplothandler@boxplot@percentile@estimator@=\pgfplotsplothandler@boxplot@percentile@estimator@R@seven
		\or	
			% R8:
			\pgfplots@error{not yet implemented in TeX: 'estimator=\pgfplots@boxplot@estimator'. This is only available using 'lua backend' and lualatex.}%
		\or	
...
\def\pgfplotsplothandler@boxplot@percentile@estimator@R@seven#1#2{%
