...
\pgfplotsset{
	...
	boxplot/draw/whisker/.code 2 args={%
		\draw[/pgfplots/boxplot/every whisker/.try]
			...
			(boxplot cs:#2,+0.5*\pgfkeysvalueof{/pgfplots/boxplot/whisker length})
			--
			(boxplot cs:#2,-0.5*\pgfkeysvalueof{/pgfplots/boxplot/whisker length})
		;
	},%
	...
	boxplot/draw/box/.code={%
		\draw[/pgfplots/boxplot/every box/.try]
			(boxplot cs:\pgfkeysvalueof{/pgfplots/boxplot/lower quartile},-0.5*\pgfkeysvalueof{/pgfplots/boxplot/box length})
			rectangle
			(boxplot cs:\pgfkeysvalueof{/pgfplots/boxplot/upper quartile},+0.5*\pgfkeysvalueof{/pgfplots/boxplot/box length})
		;
	},%
	%
	boxplot/draw/median/.code={%
		\draw[/pgfplots/boxplot/every median/.try]
			(boxplot cs:\pgfkeysvalueof{/pgfplots/boxplot/median},+0.5*\pgfkeysvalueof{/pgfplots/boxplot/box length})
			--
			(boxplot cs:\pgfkeysvalueof{/pgfplots/boxplot/median},-0.5*\pgfkeysvalueof{/pgfplots/boxplot/box length})
		;
	},%
...
\def\pgfplotsplothandlerboxplotprepared{%
	...
	\else
		...
		\fi
	\fi
	\expandafter\let\expandafter\pgfplotsplothandlerboxplotprepared@assign\csname pgfplotsplothandlerboxplotprepared@assign@\pgfplots@loc@TMPa\endcsname
	...
	\def\pgfplotsboxplotpointab##1##2{%
		\begingroup
			...
			\expandafter\pgfplotsboxplotpointab@\pgfplots@glob@TMPa%
			\pgf@process{}%
		\endgroup
	}%
}%

\def\pgfplotsplothandlerboxplotprepared@assign@x#1{%
	\edef\pgfplots@current@point@x{#1}%
	\let\pgfplots@current@point@y=\pgfplotsplothandlerboxplotprepared@drawposition
	\def\pgfplotsplothandlerboxplot@modified@draw@position{\pgfplots@current@point@y}%
}%
\def\pgfplotsplothandlerboxplotprepared@assign@y#1{%
	\edef\pgfplots@current@point@y{#1}%
	\let\pgfplots@current@point@x=\pgfplotsplothandlerboxplotprepared@drawposition
	\def\pgfplotsplothandlerboxplot@modified@draw@position{\pgfplots@current@point@x}%
}%
...
\def\pgfplotsplothandlersurveypoint@boxplotprepared{%
	...
	\ifpgfplotsaxisparsecoordinateok
		...
		\edef\pgfplots@loc@TMPa{\pgfplotsplothandlerboxplot@modified@draw@position}%
		\pgfkeyslet{/pgfplots/box plot/draw position}\pgfplots@loc@TMPa
	\fi
...
\def\pgfplotsplothandlersurveyend@boxplot@prepared{%
	...
	%
	\pgfplotsplothandlerboxplotprepared@assign{\pgfkeysvalueof{/pgfplots/boxplot/lower whisker}}%
	\pgfplotsplothandlersurveypoint@boxplotprepared
	%
	\pgfplotsplothandlerboxplotprepared@assign{\pgfkeysvalueof{/pgfplots/boxplot/lower quartile}}%
	\pgfplotsplothandlersurveypoint@boxplotprepared
	%
	\pgfplotsplothandlerboxplotprepared@assign{\pgfkeysvalueof{/pgfplots/boxplot/median}}%
	\pgfplotsplothandlersurveypoint@boxplotprepared
	%
	\pgfplotsplothandlerboxplotprepared@assign{\pgfkeysvalueof{/pgfplots/boxplot/upper quartile}}%
	\pgfplotsplothandlersurveypoint@boxplotprepared
	%
	\pgfplotsplothandlerboxplotprepared@assign{\pgfkeysvalueof{/pgfplots/boxplot/upper whisker}}%
	\pgfplotsplothandlersurveypoint@boxplotprepared
	%
	\edef\pgfplots@loc@TMPa{/pgfplots/boxplot/draw position=\pgfkeysvalueof{/pgfplots/boxplot/draw position}}%
