...
\pgfplotsset{
	...
	boxplot/draw/box/.code={%
		\draw[/pgfplots/boxplot/every box/.try]
			(boxplot box cs:\pgfkeysvalueof{/pgfplots/boxplot/lower quartile},0)
			rectangle
			(boxplot box cs:\pgfkeysvalueof{/pgfplots/boxplot/upper quartile},1)
		;
	},%
	%
	...
	boxplot/draw/median/.code={%
		\draw[/pgfplots/boxplot/every median/.try]
			(boxplot box cs:\pgfkeysvalueof{/pgfplots/boxplot/median},0)
			--
			(boxplot box cs:\pgfkeysvalueof{/pgfplots/boxplot/median},1)
		;
	},%
}
...
\def\pgfplotsplothandlersurveyend@boxplot@computestats{ 
	...
	%
	\pgfplotscoordmath{float}{parsenumber}{\pgfkeysvalueof{/pgfplots/boxplot/whisker range}}%
	\let\pgfplots@loc@TMPa=\pgfmathresult
...
\def\pgfplotsplothandlersurveyend@boxplot@prepared{%
	...
	%
	\pgfmathparse{\pgfkeysvalueof{/pgfplots/boxplot/draw position}}%
	\let\pgfplots@loc@TMPa=\pgfmathresult
	\ifpgfplots@usefpu
...
\def\pgfplots@boxplot@anchor@value#1{%
	(#1-\pgfkeysvalueof{/pgfplots/boxplot/draw relative anchor})*\pgfkeysvalueof{/pgfplots/boxplot/box extend}%
}
...
\def\pgfplots@boxplot@anchor@value@whisker#1{%
	(#1-\pgfkeysvalueof{/pgfplots/boxplot/draw relative anchor})*\pgfkeysvalueof{/pgfplots/boxplot/whisker extend}%
}
