...
\def\use@@pgfplotslibrary#1{%
  ...
  \pgfutil@for\pgf@temp:=\pgf@list\do{%
    \expandafter\ifx\csname tikz@pgfplots@library@\pgf@temp @loaded\endcsname\relax%
      \expandafter\global\expandafter\let\csname tikz@pgfplots@library@\pgf@temp @loaded\endcsname=\pgfutil@empty%
      \expandafter\edef\csname tikz@pgfplots@library@#1@atcode\endcsname{\the\catcode`\@}
      \expandafter\edef\csname tikz@pgfplots@library@#1@barcode\endcsname{\the\catcode`\|}
      \catcode`\@=11
      \catcode`\|=12
      \input tikzlibrarypgfplots.\pgf@temp.code.tex
      \catcode`\@=\csname tikz@pgfplots@library@#1@atcode\endcsname
      \catcode`\|=\csname tikz@pgfplots@library@#1@barcode\endcsname
    \fi%
  }%
}
