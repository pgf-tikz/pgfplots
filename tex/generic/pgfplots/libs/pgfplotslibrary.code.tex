...
\def\use@@pgfplotslibrary#1{%
  ...
  \pgfutil@for\pgf@temp:=\pgf@list\do{%
    \expandafter\ifx\csname pgfplots@library@\pgf@temp @loaded\endcsname\relax%
      \expandafter\global\expandafter\let\csname pgfplots@library@\pgf@temp @loaded\endcsname=\pgfutil@empty%
