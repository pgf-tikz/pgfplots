...
% Initialises the '#1grid stop at #2' feature. All it does is to prepare the
...
\def\pgfplots@gridlines@init@grid@stop@points@for#1#2{%
	...
	\else
		...
		\c@sortindex=\pgfkeysvalueof{/pgfplots/#1grid stop at #2 start} % this is assigned to the '0.0' gridline (if any)
