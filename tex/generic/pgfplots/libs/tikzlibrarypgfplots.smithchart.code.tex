...
% Initialises the '#1grid stop each nth at #2' feature. All it does is to prepare the
...
\def\pgfplots@get@current@grid@stop@point#1#2{%
	\def\pgfplotsretval{}%
...
%		{\pgfpointxy@orig{0}{\pgfplots@radius}}%
	...
	\pgfplots@get@current@grid@stop@point xy%
...
\def\pgfplots@smithchart@draw@yarc#1{%
	\pgfplotsmath@ifapproxequal@dim{#1pt}{0pt}{0.002pt}{%
		...
		%
		% compute end angle.
		\pgfplots@get@current@grid@stop@point yx%
