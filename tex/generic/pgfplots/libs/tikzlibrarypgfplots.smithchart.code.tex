...
\def\pgfplots@gridlines@init@grid@stop@points@for#1#2{%
	%
	\expandafter\let\csname pgfplots@#1grid@stop@points\endcsname=\pgfutil@empty
	%
...
\def\pgfplots@get@current@grid@stop@point#1#2{%
	\def\pgfplotsretval{}%
	\ifx\pgfplots@ygrid@stop@points\pgfutil@empty
	\else
		...
		\pgfutil@ifundefined{pgfplots@#1tickpos@to@sortidx@\pgfplots@ticknum}{%
			...
			%
			\pgfplotslistforeachungrouped\pgfplots@ygrid@stop@points\as\pgfplots@loc@TMPa{%
				\ifx\pgfplotsretval\pgfutil@empty
