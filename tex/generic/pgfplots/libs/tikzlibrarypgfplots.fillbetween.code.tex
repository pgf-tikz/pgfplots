...
\pgfkeys{%
	...
	/pgfplots/fill between/soft clip/.code={%
		\pgfplotslibfillbetween@softclip{\pgffillbetweensetsoftclippath}#1\pgfplots@EOI
	},
	/pgfplots/fill between/soft clip first/.code={%
		\pgfplotslibfillbetween@softclip{\pgffillbetweensetsoftclippathfirst}#1\pgfplots@EOI
	},%
	/pgfplots/fill between/soft clip second/.code={%
		\pgfplotslibfillbetween@softclip{\pgffillbetweensetsoftclippathsecond}#1\pgfplots@EOI
	},%
	%
	% #1: drawing options.
...
\def\pgfplotslibraryfillbetween@addplot#1#2#3{%
	%
	\pgfplots@start@plot@with@behavioroptions@setkeys{/pgfplots/every fill between,#1}%
	%
