...
\pgfplotsdeclarepatchclass{quadratic spline}{%
	...
	fill path={%
		...
		\pgfplots@edge
		\pgfplotsplothandlermesh@setlastpoint{\expandafter\pgfplotspointpatchvertex\PB\endvertex}%
		\endgroup
	},
...
%
% It expects points in the order
%
% JIHG
% KPOF
% LMNE
...
\pgfplotsdeclarepatchclass{bicubic}{%
	...
	fill path={%
		...
		\pgfpathmoveto{\expandafter\pgfplotspointpatchvertex\pgfplotspatchclass@tensor@A\endvertex}%
		\pgfplotspathcubicfrominterpolation
			{\pgfplotspatchclass@tensor@A}
			{\pgfplotspatchclass@tensor@B}
			{\pgfplotspatchclass@tensor@C}
			{\pgfplotspatchclass@tensor@D}
		\pgfplotspathcubicfrominterpolation
			{\pgfplotspatchclass@tensor@D}
			{\pgfplotspatchclass@tensor@E}
			{\pgfplotspatchclass@tensor@F}
			{\pgfplotspatchclass@tensor@G}
		\pgfplotspathcubicfrominterpolation
			{\pgfplotspatchclass@tensor@G}
			{\pgfplotspatchclass@tensor@H}
			{\pgfplotspatchclass@tensor@I}
			{\pgfplotspatchclass@tensor@J}
		\pgfplotspathcubicfrominterpolation
			{\pgfplotspatchclass@tensor@J}
			{\pgfplotspatchclass@tensor@K}
			{\pgfplotspatchclass@tensor@L}
			{\pgfplotspatchclass@tensor@A}
		\pgfpathclose
	},
	stream to shader={%
		\begingroup
		% Step 1: convert from the strange "circular" input format to
		% a matrix 
		%
		% AD BD CD DD
		% AC BC CC DC
		% AB BB CB DB
		% AA BA CA DA
		\let\P@AA=\pgfplotspatchclass@tensor@A
		\let\P@BA=\pgfplotspatchclass@tensor@B
		\let\P@CA=\pgfplotspatchclass@tensor@C
		\let\P@DA=\pgfplotspatchclass@tensor@D
		\let\P@AB=\pgfplotspatchclass@tensor@L
		\let\P@BB=\pgfplotspatchclass@tensor@M
		\let\P@CB=\pgfplotspatchclass@tensor@N
		\let\P@DB=\pgfplotspatchclass@tensor@E
		\let\P@AC=\pgfplotspatchclass@tensor@K
		\let\P@BC=\pgfplotspatchclass@tensor@P
		\let\P@CC=\pgfplotspatchclass@tensor@O
		\let\P@DC=\pgfplotspatchclass@tensor@F
		\let\P@AD=\pgfplotspatchclass@tensor@J
		\let\P@BD=\pgfplotspatchclass@tensor@I
		\let\P@CD=\pgfplotspatchclass@tensor@H
		\let\P@DD=\pgfplotspatchclass@tensor@G
		%
		% Step 2: convert to tensor bezier representation.
		% 
