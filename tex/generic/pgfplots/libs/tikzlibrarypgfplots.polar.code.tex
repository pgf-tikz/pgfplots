...
\def\pgfplots@clippath@prepare@for@axistype@polaraxis{%
	\def\pgfplots@clippath@install##1{%
		\pgfpathcircle{\pgfplotspointaxisorigin}{\pgfplots@xmax}%
...
\def\pgfplotspointouternormalvectorofaxis@polaraxis#1#2#3\relax{%
	\if v#1%
		...
		% FIXME : aspect ratios!
		% perhaps pgfpointpolarxy?
		\pgfpointpolar{\pgfplotsretval}{1pt}%
	\else
		\if v#2%
			\if#10%
...
\let\pgfplots@check@invalid@range@orig=\pgfplots@check@invalid@range
\def\pgfplots@check@invalid@range@polar{% UNUSED
	\pgfplots@check@invalid@range@orig
	\pgfplotscoordmath{x}{parsenumber}{0}%
	\let\pgfplots@loc@TMPa\pgfmathresult
	\pgfplotscoordmath{x}{parsenumber}{360}%
	\let\pgfplots@loc@TMPb\pgfmathresult
	\pgfplotscoordmath{x}{if less than}{\pgfplots@loc@TMPb}{\pgfplots@xmin}{%
		\pgfplotscoordmath{x}{op}{mod}{{\pgfplots@xmin}{\pgfplots@loc@TMPb}}%
		\global\let\pgfplots@xmin=\pgfmathresult
	}{}%
	\pgfplotscoordmath{x}{if less than}{\pgfplots@loc@TMPb}{\pgfplots@xmax}{%
		\pgfplotscoordmath{x}{op}{mod}{{\pgfplots@xmax}{\pgfplots@loc@TMPb}}%
		\global\let\pgfplots@xmax=\pgfmathresult
	}{}%
	\global\let\pgfplots@data@xmin=\pgfplots@xmin
	\global\let\pgfplots@data@xmax=\pgfplots@xmax
