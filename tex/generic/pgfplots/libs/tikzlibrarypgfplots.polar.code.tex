...
%
%
% TODO : the x limits are too strict; they don't respect the periodic
% nature. Try, for example, 
%    \addplot+[domain=0:1] (2*360*x,x);
% which has limits 0:720 and 0:1 .
%
% Cure: use mod 360 for the purpose of pgfplots' computations and the
% original limits for arcs (for which the relative size of the angles
% is used for left/right distinctions as far as I remember)
%
...
\def\pgfplotspoint@initialisation@axes@polar{%
	...
	% FIXME : also support arcs here... what is the arc length?
