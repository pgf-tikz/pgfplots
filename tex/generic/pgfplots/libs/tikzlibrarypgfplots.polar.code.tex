...
\message{checkng disablelastticxk = \pgfplots@xtick@disable@last@tick.^^J}%
	\if0\pgfplots@xtick@disable@last@tick
		...
		\divide\pgf@xa by360
\message{partial arc len = \the\pgf@xa.}%
		\ifdim\pgf@xa<1pt
...
\message{pgfplotspointxaxislength = \pgfplotspointxaxislength^^J}%
	%
	\pgfpointdiff
		{\pgfplotsqpointxy{\pgfplots@xmax}{\pgfplots@ymin}}%
		{\pgfplotsqpointxy{\pgfplots@xmax}{\pgfplots@ymax}}%
