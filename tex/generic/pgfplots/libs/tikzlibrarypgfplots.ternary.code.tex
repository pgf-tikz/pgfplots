...
\pgfplotsset{
	...
	tieline/tieline handler/.style={/tikz/sharp plot},
	tieline/curve handler/.style={/tikz/sharp plot},
...
\def\pgfplotsplothandlervis@streamend@tieline{%
	\begingroup
		...
		\path[/pgfplots/tieline/curve handler]%
		\pgfextra
		\pgfplotsresetplothandler
		\tikz@plot@handler
		\pgf@plotstreamstart
	...
	%
	%
	\pgfplotsset{/pgfplots/tieline/tieline handler}%
	\pgfplotsresetplothandler
	\tikz@plot@handler
	\pgf@plotstreamstart
	%
...
\def\pgfplotsplothandlersurveypoint@tieline@init{%
	\ifnum\pgfplotstablecols<6
		\pgfplots@error{Sorry, 'tieline' plots expect at least 6 columns in the input table, but found only \pgfplotstablecols}%
	\else
		\def\pgfplotsplothandlertieline@Ax{\getthisrowno{0}\pgfmathresult}%
		\def\pgfplotsplothandlertieline@Ay{\getthisrowno{1}\pgfmathresult}%
		\def\pgfplotsplothandlertieline@Az{\getthisrowno{2}\pgfmathresult}%
		\def\pgfplotsplothandlertieline@Bx{\getthisrowno{3}\pgfmathresult}%
		\def\pgfplotsplothandlertieline@By{\getthisrowno{4}\pgfmathresult}%
		\def\pgfplotsplothandlertieline@Bz{\getthisrowno{5}\pgfmathresult}%
	\fi
...
\def\pgfplotsplothandlersurveypoint@tieline{%
	...
	\fi
	\pgfplotsplothandlertieline@Ax\let\pgfplots@current@point@x=\pgfmathresult
	\pgfplotsplothandlertieline@Ay\let\pgfplots@current@point@y=\pgfmathresult
	\pgfplotsplothandlertieline@Az\let\pgfplots@current@point@z=\pgfmathresult
