...
\def\pgfplots@ternary@initsizes@setunitvector#1#2#3#4{%
	...
	\ifcase#2%
		\pgfsetxvec{\pgfplots@ternary@qpointxyz\pgfplots@xmax0\pgfplots@zmax}%
	\or
		\pgfsetyvec{\pgfplots@ternary@qpointxyz\pgfplots@xmax\pgfplots@ymax0}%
	\or
		\pgfsetzvec{\pgfplots@ternary@qpointxyz0\pgfplots@ymax\pgfplots@zmax}%
	\fi
