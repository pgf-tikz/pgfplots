...
%\message{Got T^{-1}(H#1) = \Hmacro}%
		...
		\else
			...
			\pgfplotscoordmath{#1}{log from display log}{\Hmacro}%
...
%\message{final H=\pgf@sys@tonumber{\H} * log(10)}%
			\pgfplotscoordmath{#1}{log to display log}{\pgf@sys@tonumber\H}%
			\H=\pgfmathresult pt
			...
			\pgfplotscoordmath{#1}{log from display log}{\pgf@sys@tonumber\MIN}%
			\MIN=\pgfmathresult pt
			...
			\ifdim\MIN<0pt
				...
				\advance\c@pgf@counta by-1
			\fi
			\pgfplotscoordmath{#1}{log to display log}{1}%
			\MIN=\pgfmathresult pt
...
%\message{**TOO FEW TICK LABELS. RECURSION with try min ticks=\axisdefaulttryminticks.**}%
				...
				\H=\MAX
				\advance\H by-\MIN
				\pgfplotscoordmath{#1}{log from display log}{\pgf@sys@tonumber\H}%
				\H=\pgfmathresult pt
...
%\message{determined step size 10^{\Hmacro}}%
				...
				\MIN=\pgfplots@@scale\MIN\relax
				\H=\pgfplots@@scale\H\relax
				\MINH=\MIN\relax
