...
\def\pgfplotsdeclareborderanchorforticklabelaxis#1#2{%
	...
	\pgfdeclaregenericanchor{#2*}{%
		...
		\pgftransformreset
		\tikz@transform
		% FIXME : what with shifts!?
		% I only need to apply it to direction vectors! There should
		% be no shift!
		\pgf@pt@x=0pt
		\pgf@pt@y=0pt
		\pgftransforminvert
		...
		% I use \pgfsettransform to employ the matrix inversion code.
		\pgfsettransform{%
		...
		\pgf@pos@transform\pgf@x\pgf@y
		% GOT IT!
		\edef\pgfplots@r{\pgf@sys@tonumber\pgf@x}%
		%
		% compute x_c + r*n:
		\pgfpointadd
			{\pgfplots@loc@center}%
	...
	\pgfdeclaregenericanchor{#2*nuranker}{%
		\begingroup
		\pgftransformreset
		\tikz@transform
		\pgftransforminvert
