...
%\message{Got T^{-1}(H#1) = \Hmacro}%
			%
			\pgfplots@assign@default@tick@foraxis@normalizetickdist\Hmacro
			\let\Hmacro=\pgfmathresult
			%
...
%
% The result will be assigned to \pgfmathresult.
%
% Example:
% \pgfmathfloatparsenumber{1234}
% \pgfplots@assign@default@tick@foraxis@normalizetickdist\pgfmathresult
% -->
%  \pgfmathresult={1200}
% or something like that. 
\def\pgfplots@assign@default@tick@foraxis@normalizetickdist#1{%
	\begingroup
	\let\H=\pgf@xb
	\expandafter\pgfmathfloat@decompose#1\relax\pgfmathfloat@a@S\H\pgfmathfloat@a@E
	% modify the mantisse:
	\ifdim\H<2pt
		\ifdim\H<1.5pt
			\H=1.0pt
