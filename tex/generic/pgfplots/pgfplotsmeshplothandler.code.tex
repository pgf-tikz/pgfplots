...
\def\pgfplotsplothandlermeshnormalscale{0.1}%
\pgfkeys{/pgfplots/every patch normal/.style={-stealth,red}}
\def\pgfplotsplothandlermesh@show@normals{%
	...
	\pgfplotscoordmath{default}{parsenumber}{\pgfplotsplothandlermeshnormalscale}% FIXME
