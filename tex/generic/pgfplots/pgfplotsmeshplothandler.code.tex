...
% segment.
\def\pgfplotsplothandlermesh@pathmoveto@continuouspath#1{%
	\pgf@process{#1}%
...
\def\pgfplotsplothandlermesh@setlastpoint@continuouspath#1{%
	\pgf@process{#1}%
...
%		\scope
	...
	%
	\def\pgfplotsplothandlerifcurrentpointcanbefirstlast##1##2{%
...
\def\pgfplotsplothandlermesh@init@path@without@point@meta{%
	%
	\pgfplotspatchclass{\pgfplotsplothandlermesh@patchclass@output}{get dimension}%
	\ifnum\pgfplotsretval=1 %
		...
		\def\pgfplotsplothandlermesh@VISUALIZE{\pgfplotsplothandlermesh@VISUALIZE@continuouspath@fill@andor@stroke}%
		\let\pgfplotsplothandlermesh@pathmoveto=\pgfplotsplothandlermesh@pathmoveto@continuouspath
		\let\pgfplotsplothandlermesh@setlastpoint=\pgfplotsplothandlermesh@setlastpoint@continuouspath
		% 
...
\def\pgfplotsplothandlermesh@VISUALIZE@continuouspath@fill@andor@stroke{%
	\pgfplotspatchclass{\pgfplotsplothandlermesh@patchclass}{fill path}%
}%
