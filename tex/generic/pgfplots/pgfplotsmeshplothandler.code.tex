...
\def\pgfplotsplothandlermesh{%
	...
	\if2\pgfplotsplothandlermesh@matrixinput
		\let\pgfplotsplothandlersurveypoint=\pgfplotsplothandlersurveypoint@mesh@image
	\fi
	%
...
%\message{initialised DECODE for 1d mode.^^J}%
			...
			\else
				% mesh input=image
					% FIXME 
				\let\pgfplotsplothandlermesh@PIPE@DECODE=\pgfplotsplothandlermesh@PIPE@DECODE@image@ONEDIMMODE
			\fi
		\else
			\if0\b@pgfplotsplothandlermesh@matrixoutput
