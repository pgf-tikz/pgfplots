...
%		\scope
	...
	\else
		\t@pgfplots@toka={%
			% expands this late... and hope that it works!
			%  FIXME : THIS NEEDS TO BE REWRITTEN SUCH THAT IT WORKS
			%  EVEN IF THE VIS PHASE IS NOT STARTED!
			pgfplots.pgfplotsmath.tonumber("\pgfkeysvalueof{/pgfplots/mesh/rows}"),
			pgfplots.pgfplotsmath.tonumber("\pgfkeysvalueof{/pgfplots/mesh/cols}"),
