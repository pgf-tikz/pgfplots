...
\def\pgfplotsplothandlermeshnormalscale{0.3}%
...
\message{got normal \pgfplots@normal@vector^^J}%
...
% the (x,y,z) 3d coordinates of the data point. The points should be
% untransformed.
%
...
\def\pgfplotsplothandlermesh@serialize@logical@coords@doit{%
	\pgfplotsmathvectordatascaletrafoinverse{\pgfplots@current@point@x,\pgfplots@current@point@y,\pgfplots@current@point@z}{default}%
}
