...
\pgfkeys{%
	...
	/tikz/fill between/soft clip/.code={%
		\tikzlibsoftclip@setkey{\pgffillbetweensetsoftclippath}#1\pgf@stop
	},
	/tikz/fill between/soft clip first/.code={%
		\tikzlibsoftclip@setkey{\pgffillbetweensetsoftclippathfirst}#1\pgf@stop
	},%
	/tikz/fill between/soft clip second/.code={%
		\tikzlibsoftclip@setkey{\pgffillbetweensetsoftclippathsecond}#1\pgf@stop
	},%
	%
	% #1: drawing options.
