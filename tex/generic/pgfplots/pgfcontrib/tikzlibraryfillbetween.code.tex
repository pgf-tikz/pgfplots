...
\pgfkeys{%
	/tikz/fill between/of/.code=\pgfplotslibraryfillbetween@parse#1\pgfplots@EOI,
	%
	...
	/tikz/fill between/@draw style/.style={
		...
		/pgf/fill between/result stream/next ready/.code={%
			...
			\def\pgfplots@loc@TMPa{%
				...
				#1,%
				/tikz/fill between/every segment no \c@pgflibraryfill@segment/.try,
			}%
...
\def\pgfplotsfillbetween@opt[#1]#2{%
	...
	\pgfkeysgetvalue{/tikz/fill between/on layer}\pgfplotslibraryfillbetween@path@layer@name
...
\def\pgfplotslibraryfillbetween@path@warn@layer{%
	\pgfplots@warning{'fill between': Could not activate graphics layer '\pgfplotslibraryfillbetween@path@layer@name'. Filled path will be on top of the other ones. Please ensure that '/pgfplots/activate layers=true' and '\pgfplotslibraryfillbetween@path@layer@name' is somewhere in the layer list (or set '/tikz/fill between/on layer=').}%
}%
