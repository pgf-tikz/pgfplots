...
\def\tikzlibsoftclip@setkey#1#2\pgf@stop{%
	\def\tikzlibsoftclip@setkey@trg{#1}%
	\def\pgf@temp{#2}%
	\pgfplots@command@to@string\pgf@temp\pgf@temp
	%
	\tikzifisnamedpath{\pgf@temp}{%
		\tikzgetnamedpath{\pgf@temp}%
		\tikzlibsoftclip@setkey@trg{\pgfretval}%
	}{%
		\tikzlibsoftclip@setkey@@#2\pgf@stop
	}%
}
...
%  - \tikzlibsoftclip@setkey@trg contains a macro which will
...
\def\tikzlibsoftclip@setkey@@activate{%
	...
	\endpgfinterruptpath
	%
	\tikzlibsoftclip@setkey@trg\pgfplots@glob@TMPa
}%
% ---------------------------------------------------------------------------------
