...
\pgfkeys{%
	% /pgfplots/array/iflessthan{#1}{#2}{#3}{#4}:
	...
	% At the time when it is evaluated,
	% \pgfplotsarraysortiflessthanindexa is the *index* of arg1
	% and
	% \pgfplotsarraysortiflessthanindexb is the *index* of argb.
	/pgfplots/array/iflessthan fixed/.style={%
		/pgfplots/array/iflessthan/.code args={##1##2##3##4}{\ifnum##1<##2\relax##3\else##4\fi},%
	},
	/pgfplots/array/iflessthan fixed,
	/pgfplots/array/ifgreaterthan fixed/.style={%
		/pgfplots/array/iflessthan/.code args={##1##2##3##4}{\ifnum##1>##2\relax##3\else##4\fi},%
	},
	/pgfplots/array/iflessthan float/.style={%
		/pgfplots/array/iflessthan/.code args={##1##2##3##4}{%
	...
	/pgfplots/array/ifgreaterthan float/.style={%
		/pgfplots/array/iflessthan/.code args={##1##2##3##4}{%
			\pgfmathfloatparsenumber{##1}%
			\let\pgfplotstable@arga=\pgfmathresult
			%
...
\def\pgfplotsarray@mergesort#1#2#3{%
	...
	\else
		...
		\ifpgfplots@loop@CONTINUE
			...
			\edef\pgfplotsarraysortiflessthanindexa{\the\c@pgfplotsarraysort@j}%
			\c@pgfplotsarraysort@j=\c@pgfplotsarraysort@k
			\advance\c@pgfplotsarraysort@j by#2
			\pgfplotsarrayselect{\c@pgfplotsarraysort@j}\of{#1}\to\pgfplotsarray@x@k
			\edef\pgfplotsarraysortiflessthanindexb{\the\c@pgfplotsarraysort@j}%
