...
\def\pgfplots@axis@apply@post@scale#1{%
	...
	\else
		\pgfmathparse{\csname pgfplots@target@unit@scale@#1x\endcsname*\pgfmathresult}%
		\expandafter\let\csname pgfplots@target@unit@scale@#1x\endcsname=\pgfmathresult
		%
		\pgfmathparse{\csname pgfplots@target@unit@scale@#1y\endcsname*\pgfmathresult}%
...
\def\pgfplots@scaleaxes@to@BB@#1#2{%
	...
	\else
		...
		%
\message{got scales to fit limits into BB: x=\pgfplots@target@unit@scale@inv@x, y=\pgfplots@target@unit@scale@inv@y, z=\pgfplots@target@unit@scale@inv@z^^J}%
		%
		...
		\fi
\message{adjusted scales for 'scale mode': x=\pgfplots@target@unit@scale@inv@x, y=\pgfplots@target@unit@scale@inv@y, z=\pgfplots@target@unit@scale@inv@z;  ^^J   axis limit componsation scales x=\pgfplots@target@limitrescale@x, y=\pgfplots@target@limitrescale@y, z=\pgfplots@target@limitrescale@z^^J}%
		%
...
\message{Got W/H scale for all x components: \xscale; for all y components: \xscale; ^^J   axis limit componsation scales x=\pgfplots@target@limitrescale@x, y=\pgfplots@target@limitrescale@y, z=\pgfplots@target@limitrescale@z^^J}%
		...
		\pgfplots@BB@update@cumulative@limit@compensations
		%
\message{adjusted scales for 'unit vector ratio': x=\pgfplots@target@unit@scale@inv@x, y=\pgfplots@target@unit@scale@inv@y, z=\pgfplots@target@unit@scale@inv@z;  ^^J   axis limit componsation scales x=\pgfplots@target@limitrescale@x, y=\pgfplots@target@limitrescale@y, z=\pgfplots@target@limitrescale@z^^J}%
	\fi
	%
	\pgfplots@scaling@adjust@datascaling%
\message{adjusted scales for data scale trafo: x=\pgfplots@target@unit@scale@inv@x, y=\pgfplots@target@unit@scale@inv@y, z=\pgfplots@target@unit@scale@inv@z;  ^^J   axis limit componsation scales x=\pgfplots@target@limitrescale@x, y=\pgfplots@target@limitrescale@y, z=\pgfplots@target@limitrescale@z;^^J  data scale trafo exponents x=\pgfplots@target@datascaletrafo@x@exponent@old -> \pgfplots@target@datascaletrafo@x@exponent, y=\pgfplots@target@datascaletrafo@y@exponent@old -> \pgfplots@target@datascaletrafo@y@exponent, z=\pgfplots@target@datascaletrafo@z@exponent@old -> \pgfplots@target@datascaletrafo@z@exponent^^J}%
	%
	\pgfplots@axis@apply@post@scale{x}{\pgfplots@target@unit@scale@inv@x}%
	\pgfplots@axis@apply@post@scale{y}{\pgfplots@target@unit@scale@inv@y}%
	\ifpgfplots@threedim
		\pgfplots@axis@apply@post@scale{z}{\pgfplots@target@unit@scale@inv@z}%
	\fi
	%
...
\def\pgfplots@scaling@compute@final@scales#1#2#3#4#5{%
	\def\pgfplots@loc@TMPa##1##2##3##4{%
		...
		\ifpgfplots@threedim
			...
			% axes:
			\pgfplotscoordmath{\pgfplots@compat@scaling@coordmath}{op}{multiply}{{\xscale@@}{\unitscale@@}}%
			\pgfplotscoordmath{\pgfplots@compat@scaling@coordmath}{tofixed}{\pgfmathresult}%
			\expandafter\let\csname pgfplots@target@unit@scale@##1x\endcsname=\pgfmathresult
			%
			\pgfplotscoordmath{\pgfplots@compat@scaling@coordmath}{op}{multiply}{{\yscale@@}{\unitscale@@}}%
			\pgfplotscoordmath{\pgfplots@compat@scaling@coordmath}{tofixed}{\pgfmathresult}%
			\expandafter\let\csname pgfplots@target@unit@scale@##1y\endcsname=\pgfmathresult
		\else
			% backw. compatibility: 2d axes used divide, not
			% reciprocal. Believe it or not; for
			% \pgfplots@compat@scaling@coordmath=pgfbasic, it makes a
			% difference.
			\pgfplotscoordmath{\pgfplots@compat@scaling@coordmath}{op}{divide}{{\xscale@@}{\unitscale@inv@@}}%
			\pgfplotscoordmath{\pgfplots@compat@scaling@coordmath}{tofixed}{\pgfmathresult}%
			\expandafter\let\csname pgfplots@target@unit@scale@##1x\endcsname=\pgfmathresult
			%
			\pgfplotscoordmath{\pgfplots@compat@scaling@coordmath}{op}{divide}{{\yscale@@}{\unitscale@inv@@}}%
			\pgfplotscoordmath{\pgfplots@compat@scaling@coordmath}{tofixed}{\pgfmathresult}%
			\expandafter\let\csname pgfplots@target@unit@scale@##1y\endcsname=\pgfmathresult
		\fi
		%
...
\def\pgfplots@apply@unit@ratio#1#2#3#4#5#6{%
	...
	\else
		...
		\ifpgfplots@loc@tmp
			\pgfplots@appy@unit@ratio@reciprocal{\pgfplots@target@unit@scale@inv@x}%
			\let\pgfplots@target@unit@scale@x=\pgfmathresult
			\pgfplots@appy@unit@ratio@reciprocal{\pgfplots@target@unit@scale@inv@y}%
			\let\pgfplots@target@unit@scale@y=\pgfmathresult
			\pgfplots@appy@unit@ratio@reciprocal{\pgfplots@target@unit@scale@inv@z}%
			\let\pgfplots@target@unit@scale@z=\pgfmathresult
			%
...
%\message{USING REFERENCE UNIT VECTOR FROM \pgfplots@apply@unit@ratio@reference; ratio \pgfplots@unit@ratio@x\space \pgfplots@unit@ratio@y\space \pgfplots@unit@ratio@z.^^J}%
			...
			%
			%
			\pgfplots@appy@unit@ratio@reciprocal{\pgfplots@target@unit@scale@x}%
			\let\pgfplots@target@unit@scale@inv@x=\pgfmathresult
			\pgfplots@appy@unit@ratio@reciprocal{\pgfplots@target@unit@scale@y}%
			\let\pgfplots@target@unit@scale@inv@y=\pgfmathresult
			\pgfplots@appy@unit@ratio@reciprocal{\pgfplots@target@unit@scale@z}%
...
\def\pgfplots@apply@unit@ratio@find@reference{%
	...
	\ifx\pgfplots@optimum@sofar@axis\pgfutil@empty
		...
		\ifpgfplots@threedim
			% ah, it IS 3d!
			\ifdim\pgfplots@target@unit@scale@z pt=0pt
...
\def\pgfplots@rescale@unit@vector@reltoreference#1#2{%
	...
	\else
		\def\pgfplots@loc@TMPa{1}%
	\fi
	\ifdim\csname pgfplots@target@unit@scale@#1\endcsname pt=0pt
		\def\pgfplots@loc@TMPa{0}%
	\fi
	\if1\pgfplots@loc@TMPa
		%
...
%\message{Rescaling '#1' by \pgfplots@glob@TMPa.^^J}%
		%
		\pgfmathmultiply@{\csname pgfplots@target@unit@scale@#1\endcsname}{\pgfplots@glob@TMPa}%
		\expandafter\let\csname pgfplots@target@unit@scale@#1\endcsname=\pgfmathresult
		%
...
\def\pgfplots@getscale@unit@vector@reltoreference#1#2{%
	...
	\ifdim\csname pgfplots@target@unit@scale@#1\endcsname pt=0pt
		\def\pgfplots@loc@TMPa{0}%
	\else
		\ifdim\csname pgfplots@target@unit@scale@\pgfplots@apply@unit@ratio@reference\endcsname pt=0pt
			\def\pgfplots@loc@TMPa{0}%
		\fi
	\fi
	...
	\else
		\pgfmathdivide@
			{\csname pgfplots@target@unit@scale@\pgfplots@apply@unit@ratio@reference\endcsname}
