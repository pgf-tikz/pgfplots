...
\message{Got W/H scale for all x components: \xscale; for all y components: \xscale; axis limit componsation scales x=\pgfplots@target@limitrescale@x, y=\pgfplots@target@limitrescale@y, z=\pgfplots@target@limitrescale@z^^J}%
...
\def\pgfplots@BB@update@cumulative@limit@compensations{%
	\message{  updating limit componensation scales for additional factors x=\pgfplots@target@limitrescale@x@, y=\pgfplots@target@limitrescale@y@, z=\pgfplots@target@limitrescale@z@^^J}%
