...
\def\pgfplots@scaleaxes@to@BB@#1#2{%
	...
	%
\message{got scales to fit limits into BB: scalex=\pgfplots@target@unit@scale@x, scaley=\pgfplots@target@unit@scale@y, scalez=\pgfplots@target@unit@scale@z^^J}%
	%
