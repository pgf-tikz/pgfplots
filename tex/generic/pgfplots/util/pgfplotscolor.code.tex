...
\def\pgfplotscolornormalizesequence[#1]{%
	...
	\else
		...
		\else
			...
			\else
				\pgfplots@error{Sorry, the choice colorspace=\pgfplots@loc@TMPa\space is unsupported as interpolation colorspace in pgfplots, please use one of 'auto,rgb,cmyk'}%
			\fi
		\fi
	\fi
}%
