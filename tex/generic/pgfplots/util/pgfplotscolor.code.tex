...
\def\pgfplotscolornormalizesequencenext@color@error#1{%
	\pgfplotsthrow{invalid argument}{\pgfplots@loc@TMPa}{Sorry, the input '#1' cannot be read: its color space '\pgfplots@loc@TMPa' is unsupported (near \pgfplotscolornormalizesequence@context@message)}\pgfeov%
}
