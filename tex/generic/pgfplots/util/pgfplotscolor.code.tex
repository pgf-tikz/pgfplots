...
\def\pgfplotscolornormalizesequencenextbycomponents#1#2{%
	...
	\else
		...
		\fi
	\fi
	\edef\pgfplotsretval{\pgfplots@loc@TMPb}%
...
\def\pgfplotscolornormalizesequencegetnumcomponents@single#1#2#3{%
	\pgf@xa=#1pt %
	\pgf@xb=#3pt %
...
\expandafter\def\csname pgfplotscolornormalizesequencegetnumcomponents@1\endcsname#1:#2\relax#3{%
	\pgfplotscolornormalizesequencegetnumcomponents@single{#1}{#3}{#2}%
}%
\expandafter\def\csname pgfplotscolornormalizesequencegetnumcomponents@3\endcsname#1,#2,#3:#4,#5,#6\relax#7{%
	\pgfplotscolornormalizesequencegetnumcomponents@single{#1}{#7}{#4}%
	\let\pgfplots@loc@TMPa=\pgfplotsretval
	\pgfplotscolornormalizesequencegetnumcomponents@single{#2}{#7}{#5}%
	\let\pgfplots@loc@TMPb=\pgfplotsretval
	\pgfplotscolornormalizesequencegetnumcomponents@single{#3}{#7}{#6}%
...
\expandafter\def\csname pgfplotscolornormalizesequencegetnumcomponents@4\endcsname#1,#2,#3,#4:#5,#6,#7,#8\relax#9{%
	\pgfplotscolornormalizesequencegetnumcomponents@single{#1}{#9}{#5}%
	\let\pgfplots@loc@TMPa=\pgfplotsretval
	\pgfplotscolornormalizesequencegetnumcomponents@single{#2}{#9}{#6}%
	\let\pgfplots@loc@TMPb=\pgfplotsretval
	\pgfplotscolornormalizesequencegetnumcomponents@single{#3}{#9}{#7}%
	\let\pgfplots@loc@TMPc=\pgfplotsretval
	\pgfplotscolornormalizesequencegetnumcomponents@single{#4}{#9}{#8}%
