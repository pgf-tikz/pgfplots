...
\def\pgfplotsmathvectorsubtract#1#2#3{%
	...
	\expandafter\pgfplotsmathvectorsubtract@\pgfplots@loc@TMPa\pgfplots@EOI{#3}%
	\pgfmath@smuggleone\pgfplotsretval
	\endgroup
}%
\def\pgfplotsmathvectorsubtract@#1,#2,#3:#4,#5,#6\pgfplots@EOI#7{%
	...
	\pgfplotscoordmath{#7}{op}{subtract}{{\Ax}{\Bx}}%
	\let\pgfplots@loc@TMPa=\pgfmathresult
	\pgfplotscoordmath{#7}{op}{subtract}{{\Ay}{\By}}%
	\let\pgfplots@loc@TMPb=\pgfmathresult
	\pgfplotscoordmath{#7}{op}{subtract}{{\Az}{\Bz}}%
