...
\long\def\pgfplotsforeachentryinCSV@next#1#2#3,{%
	...
	#2\relax
	\ifpgffor@continue
		\long\def\pgfplotsforeachentryinCSV@next@{\pgfplotsforeachentryinCSVisterminated@loop{#1}{#2}}%
	\else
		% ah, \breakforeach reached.
		\def\pgfplotsforeachentryinCSV@next@{\pgfplots@gobble@until@EOI}%
	\fi
...
\def\pgfplots@for@reset@break{%
	\edef\pgfplotsforeachungrouped@@@{%
		\ifpgffor@continue
			\noexpand\pgffor@continuetrue
		\else
			\noexpand\pgffor@continuefalse
		\fi
	}%
	%
	\pgffor@continuetrue
...
\def\pgfplots@for@restore@break{%
...
\long\def\pgfplotsforeachungrouped@@#1#2#3#4{%
	...
	\fi
	%
	% restore the old value of \breakforeach:
	\pgfplots@for@restore@break
}
