...
\def\pgfplotsmathcarttopol#1#2#3#4{%
	...
	\pgfplotscoordmath{default}{op}{veclen}{{\pgfplots@x}{\pgfplots@y}}%
	\let\pgfplots@r=\pgfmathresult
	\pgfplotscoordmath{default}{if is}{\pgfplots@r}{0}{%
		\pgfplotscoordmath{default}{parsenumber}{0}%
	}{%
		\pgfplotscoordmath{default}{op}{divide}{{\pgfplots@x}{\pgfplots@r}}%
		\let\pgfplots@quot=\pgfmathresult
		\pgfplotscoordmath{default}{op}{acos}{{\pgfplots@quot}}%
		%
		\pgfplotscoordmath{default}{if is}{\pgfplots@y}{-}{%
			\let\pgfplots@acos=\pgfmathresult
			\pgfplotscoordmath{default}{parsenumber}{-1}%
			\pgfplotscoordmath{default}{op}{multiply}{{\pgfmathresult}{\pgfplots@acos}}%
		}{}%
	}%
...
\def\pgfplotsmathpoltocart#1#2#3#4{%
	...
	\pgfplotscoordmath{default}{parsenumber}{#2}%
	\let\pgfplots@r=\pgfmathresult
	\pgfplotscoordmath{default}{op}{sin}{{\pgfplots@deg}}%
	\pgfplotscoordmath{default}{op}{multiply}{{\pgfplots@r}{\pgfmathresult}}%
	\let\pgfplots@y=\pgfmathresult
	\pgfplotscoordmath{default}{op}{cos}{{\pgfplots@deg}}%
	\pgfplotscoordmath{default}{op}{multiply}{{\pgfplots@r}{\pgfmathresult}}%
	\let\pgfplots@x=\pgfmathresult
