...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% Stupid linear algebra.
%
% These utilities are rarely used at the time of this writing, handle
% with care
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\def\pgfplotsmathvectorcompwiseop@binary#1,#2,#3:#4,#5,#6\pgfplots@EOI#7#8{%
	\pgfplotscoordmath{#7}{parsenumber}{#1}\let\Ax\pgfmathresult
	\pgfplotscoordmath{#7}{parsenumber}{#2}\let\Ay\pgfmathresult
	\pgfplotscoordmath{#7}{parsenumber}{#3}\let\Az\pgfmathresult
	\pgfplotscoordmath{#7}{parsenumber}{#4}\let\Bx\pgfmathresult
	\pgfplotscoordmath{#7}{parsenumber}{#5}\let\By\pgfmathresult
	\pgfplotscoordmath{#7}{parsenumber}{#6}\let\Bz\pgfmathresult
...
\def\pgfplotsmathvectorcompwiseop@unary#1,#2,#3\pgfplots@EOI#4#5{%
	\pgfplotscoordmath{#4}{parsenumber}{#1}\let\Ax\pgfmathresult
	\pgfplotscoordmath{#4}{parsenumber}{#2}\let\Ay\pgfmathresult
	\pgfplotscoordmath{#4}{parsenumber}{#3}\let\Az\pgfmathresult
...
\def\pgfplotsmathvectortocomponents@#1,#2,#3\pgfplots@EOI#4#5{%
	\pgfplotscoordmath{#4}{parsenumber}{#1}\expandafter\let\csname #5x\endcsname\pgfmathresult
	\pgfplotscoordmath{#4}{parsenumber}{#2}\expandafter\let\csname #5y\endcsname\pgfmathresult
	\pgfplotscoordmath{#4}{parsenumber}{#3}\expandafter\let\csname #5z\endcsname\pgfmathresult
}%
...
\def\pgfplotsmathvectorscale@#1,#2,#3:#4\pgfplots@EOI#5{%
	\begingroup
	\pgfplotscoordmath{#5}{parsenumber}{#1}\let\Ax\pgfmathresult
	\pgfplotscoordmath{#5}{parsenumber}{#2}\let\Ay\pgfmathresult
	\pgfplotscoordmath{#5}{parsenumber}{#3}\let\Az\pgfmathresult
