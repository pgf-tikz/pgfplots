...
\def\pgfplots@getcurrent@plothandler#1{%
	...
	%
	\pgfplots@getcurrent@plothandler@map@to@patched@versions
}

% Takes \tikz@plot@handler and checks if it is an UNPATCHED tikz plot
% handler. If so, it replaced it with the correct patched version.
\def\pgfplots@getcurrent@plothandler@map@to@patched@versions{%
