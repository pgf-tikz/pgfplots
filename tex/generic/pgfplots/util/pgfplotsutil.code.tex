...
\def\pgfplotsutil@ifdefinedui#1#2#3{%
	...
	\pgfutil@ifundefined{\pgfplotsretval}{\message{'\pgfplotsretval' is UNDEFINED}}{\message{'\pgfplotsretval' is DEFINED.}}%
...
\def\pgfplotsutil@ifdefinedui@withsuffix#1#2#3#4{%
	...
	\pgfplots@command@to@string\pgfplotsutil@@arg@ifdefined\pgfplotsutil@@arg@ifdefined
	\expandafter\pgfplotsutil@trim\expandafter{\pgfplotsutil@@arg@ifdefined}%
	\pgfutil@ifundefined{\pgfplotsretval #2}{\message{'\pgfplotsretval #2' is UNDEFINED}}{\message{'\pgfplotsretval #2' is DEFINED.}}%
	\pgfutil@ifundefined{\pgfplotsretval #2}{#4}{#2}%
}%
