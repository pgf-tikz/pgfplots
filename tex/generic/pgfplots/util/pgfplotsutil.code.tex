...
%
% Example:
% 	\pgfplotsinvokeforeachungrouped{a,b,c,d} 
...
\long\def\pgfplotsinvokeforeachungrouped#1#2{%
	\long\def\pgfplotsinvokeforeachungrouped@@##1{#2}%
	\pgfplotsforeachungrouped \pgfplotsinvokeforeachungrouped@ in {#1} {%
		\expandafter\pgfplotsinvokeforeachungrouped@@\expandafter{\pgfplotsinvokeforeachungrouped@}%
	}%
}
