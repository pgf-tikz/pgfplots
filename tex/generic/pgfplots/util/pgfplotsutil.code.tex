...
\def\pgfplotsutilstrcmp#1#2{%
	...
	\pgfplotsloop{%
		\if0\pgfplotsretval
			...
			\ifx\pgfplots@strcmp@arga\pgfutil@empty
				\let\pgfplots@strcmp@arga@=\pgfutil@empty
			\else
				\expandafter\pgfplotsutilstrcmp@popfront\pgfplots@strcmp@arga\relax
				\let\pgfplots@strcmp@arga=\pgfplots@strcmp@rest
				\let\pgfplots@strcmp@arga@=\pgfplots@strcmp@cur
			\fi
			%
			% get next token of argb:
			\ifx\pgfplots@strcmp@argb\pgfutil@empty
				\let\pgfplots@strcmp@argb@=\pgfutil@empty
			\else
				\expandafter\pgfplotsutilstrcmp@popfront\pgfplots@strcmp@argb\relax
