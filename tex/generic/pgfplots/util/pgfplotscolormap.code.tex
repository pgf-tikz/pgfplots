...
\def\pgfplotscolormapsizeof#1{\pgfplotsarraysizeof{pgfpl@cm@#1}}%
	...
	\pgfplotsarrayforeachungrouped{pgfpl@cm@#1}\as\cdata{%
		...
		\ifnum\c@pgf@counta>0
			...
			\ifnum\c@pgf@counta<\c@pgf@countb\relax
				...
				\edef\pgfplots@loc@TMPd{ \pgf@sys@tonumber\pgf@xa}%
				\expandafter\pgfplotsapplistXpushback\expandafter{\pgfplots@loc@TMPd}\to\pgfplots@bounds@accum%
			\fi
