...
\def\pgfplots@createcolormap#1#2{%
	...
	\pgfmathsubtract@{\pgfplots@createcolormap@MAX}{\pgfplots@createcolormap@MIN}%
...
%	\iftrue
		...
		\expandafter\pgfplotsutilforeachcommasep\expandafter{\pgfplots@loc@TMPc}\as\pgfplots@loc@TMPc{%
			...
			\else
				...
				\pgfmathsubtract@{\pgfplots@loc@TMPc}{\pgfplots@createcolormap@MIN}%
				\expandafter\pgfmathmultiply@\expandafter{\pgfmathresult}{\pgfplots@loc@TMPb}%
	...
	\pgfplotscolormapifisuniform{#1}{%
		...
		\ifdim\pgfmathresult pt>0pt
			...
			\else
				...
				% 
				% -> h = 1000/s - 1000.
				%  regarding the '1-#2': I did not mistake in my
