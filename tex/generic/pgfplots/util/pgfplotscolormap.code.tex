...
\expandafter\def\csname pgfplots@createcolormap@grabnextspecial@const color of colormap\endcsname#1#2{%
	\begingroup
...
% PRECONDITION: \pgfplots@createcolormap@special@split has been called
% before (access its return values)
