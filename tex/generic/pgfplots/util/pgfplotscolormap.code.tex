...
\def\pgfplots@createcolormap@special@process#1#2{%
	...
	\expandafter\pgfplots@loc@TMPa\expandafter{\pgfplots@source}{%
		...
		%\else
		%	\edef\pgfplots@temp@pos{(\the\pgf@x)}%
		%	\global\advance\pgf@x by\pgfplots@createcolormap@H\relax
		%\fi
...
\def\pgfplotscolormapfindpiecewiseconst@precomputed@[#1:#2][#3]#4#5{%
	...
	%  1/H = ( 1000 * 1/h +1  +1 )/ 1000 = 1/h + 1/500 = invh + 0.002
	%
	% compute 1/H here:
	\pgfmathadd@{\csname pgfpl@cm@#5@invh\endcsname}{0.002}%
