...
\def\pgfplots@createcolormap@special@process@single{%
	...
	\pgfkeysgetvalue{/pgfplots/of colormap/range}\pgfplotspointmetatransformed
	\ifx\pgfplotspointmetatransformed\pgfutil@empty
		\let\pgfplotspointmetatransformed=\pgfplotscolormaprange
	\fi
	%
