			...
			\expandafter\pgfplots@loc@TMPa\expandafter{\pgfplots@target}{%
				...
				\else
					...
					\else
						...
						\ifx\pgfplots@firstpos\pgfutil@empty
...
\def\pgfplots@createcolormap@special@process@list@sampled@define{%
	...
	\if c\pgfplots@ofcolorbar@sample@for@choice%
		...
		\ifx\pgfplots@target\pgfutil@empty
			\def\b@pgfplots@special@interval{0}%
		\else
			\edef\pgfplots@target{\pgfplots@target}%
			\expandafter\pgfutil@in@\expandafter,\expandafter{\pgfplots@target}%
			\ifpgfutil@in@
				% ah - we have at least 2 positions!
				% XXX : this here runs before the positions are
				% sanitized... is this correct?
