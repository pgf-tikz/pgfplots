			...
			{%
				...
				{%
					\pgfutil@ifnextchar c{\pgfplots@createcolormap@grabcolor}%
					{
						...
						{\pgfplots@error{Illformed colormap specification \ifx\pgfplots@createcolormap@context\pgfutil@empty\else. The error occured after `\pgfplots@createcolormap@context'\fi}}%
					}%
				}%
			}%
		}%
