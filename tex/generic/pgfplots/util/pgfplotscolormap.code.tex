...
%	\iftrue
		...
		\expandafter\let\csname\pgfplots@createcolormap@name @X@scale@order0\endcsname=\pgfmathresult
	\else
		\expandafter\let\csname\pgfplots@createcolormap@name @X@scale@order0\endcsname=\pgfutil@empty
	\fi
...
\def\pgfplotscolormapserializetomacro#1#2{%
	\begingroup
		...
		\xdef\pgfplots@glob@TMPa{%
			...
			\the\toks7
			\def\expandafter\noexpand\csname pgfpl@cm@#1@X@scale@order0\endcsname{\csname pgfpl@cm@#1@X@scale@order0\endcsname}%
		}%
	\endgroup
	...
	\else
		\if c\pgfplots@colormap@access
			...
			\pgfplotscolormapifisuniform{#1}{%
				...
				\global\pgf@x=\csname pgfpl@cm@#1@X@scale@order0\endcsname pt %
				% see also
...
\def\pgfplotscolormapfindpiecewiseconst@precomputed@[#1:#2][#3]#4#5{%
	...
	\pgfplotscolormapifisuniform{#5}{%
		...
		%
		% Note that k(t) = 1/ pgfpl@cm@#5@X@scale@order0
		%
