...
% POSTCONDITION:
%   \pgfplots@loc@TMPa contains the colorspace
%   \pgfplots@loc@TMPb contains the position
%   \pgfplots@loc@TMPc contains the color components
\def\pgfplots@createcolormap@grabnext@split#1=#2\pgfplots@EOI{%
	\pgfutil@in@({#1}%
	\ifpgfutil@in@
		\pgfplots@createcolormap@grabnext@split@pos#1\pgfplots@EOI
	\else
		\def\pgfplots@loc@TMPa{#1}%
		\pgfplots@createcolormap@grabnext@computenextposition
		\let\pgfplots@loc@TMPb=\pgfmathresult
...
\def\pgfplots@createcolormap@grabnext@split@pos#1(#2){%
