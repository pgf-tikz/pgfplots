...
\pgfplotsset{
	quiver/.code={%
		...
		\pgfkeyssetvalue{/pgf/data point/u}{0}%
		\pgfkeyssetvalue{/pgf/data point/v}{0}%
		\pgfkeyssetvalue{/pgf/data point/w}{0}%
	},%
}%
...
\def\pgfplotsplothandlersurveypoint@quiver{%
	% FIXME : do I *really* want to use the math parser here!?
	\pgfmathparse{\pgfkeysvalueof{/pgf/data point/u}}%
	\let\pgfplots@quiver@u=\pgfmathresult
	\pgfmathparse{\pgfkeysvalueof{/pgf/data point/v}}%
	\let\pgfplots@quiver@v=\pgfmathresult
	\pgfplotsifcurplotthreedim{%
		\pgfmathparse{\pgfkeysvalueof{/pgf/data point/w}}%
