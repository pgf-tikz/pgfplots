...
\pgfplotsset{
	...
	contour/label distance/.initial=20pt,
}%
...
\def\pgfplotsplothandlercontour@visstart{%
	...
	\let\pgfplotsplothandlercontour@labeldist=\pgfmathresult
	\pgfmath@basic@multiply@\pgfplotsplothandlercontour@labeldist\pgfplotsplothandlercontour@labeldist
...
\def\pgfplotsplothandlercontour@handlesplinesegment#1{%
	...
	\edef\pgfplotsplothandlercontour@act@len{\the\pgf@xa}%
	%
	\advance\pgf@xa by\pgfplotsplothandlercontour@len\relax
	\xdef\pgfplotsplothandlercontour@len{\the\pgf@xa}%
\message{contour: cur len=\pgfplotsplothandlercontour@len; most recently added=\pgfplotsplothandlercontour@act@len.}%
}%
