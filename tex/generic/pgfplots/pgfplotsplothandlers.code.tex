...
\pgfplotsset{
	...
	contour gnuplot/.style={
		contour external={%
			script={unset surface; set contour; set table \"\outfile\"; splot \"\infile\";},
			cmd={gnuplot \"\script\"},
			#1,%
		},
	},
...
\def\pgfplotsplothandlersurveystart@contourexternal{%
	...
	\ifx\pgfplotsplothandlercontourexternal@file\pgfutil@empty
		\edef\pgfplotsplothandlercontourexternal@file{\jobname_contourtmp\c@pgfplotsplothandlersurveystart@contourexternal@fileno}%
