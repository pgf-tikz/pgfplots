...
\pgfmathdeclarefunction{pgfplotsxbarwidth}{0}{\pgfplots@bar@mathparse@{y}}%
\pgfmathdeclarefunction{pgfplotsybarwidth}{0}{\pgfplots@bar@mathparse@{x}}%

\def\pgfplots@bar@mathparse@#1{%
	\pgfmathparse{\pgfkeysvalueof{/pgf/bar width}}%
