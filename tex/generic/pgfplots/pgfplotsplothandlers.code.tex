...
\def\pgfplotsresetplothandler{%
	...
	\let\pgfplotsplothandlerLUAname=\pgfplotsplothandlerLUAname@default
...
% This should expand to the name of the LUA class for the current plot
% handler. Use empty if there is none.
\def\pgfplotsplothandlerLUAname@default{}%
