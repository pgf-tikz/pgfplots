...
\def\pgfplots@prepare@source@parser@for#1#2#3{%
	...
	\if1\pgfkeysvalueof{/pgfplots/#1/#2 is expr}%
		\def#3{%
			\edef\pgfmathresult{\pgfkeysvalueof{/data point/#2}}
...
\def\pgfplotsplothandlersurveystart@hist{%
	...
	%
	\pgfkeysgetvalue{/pgfplots/hist/data min}\pgfplotsplothandlerhistogram@datamin
	\edef\pgfplotsplothandlerhistogram@datamin{\pgfplotsplothandlerhistogram@datamin}%
	\pgfkeysgetvalue{/pgfplots/hist/data max}\pgfplotsplothandlerhistogram@datamax
	\edef\pgfplotsplothandlerhistogram@datamax{\pgfplotsplothandlerhistogram@datamax}%
	%
...
\newif\ifpgfplotsplothandlertofile@writeemptylines
\pgfplotsplothandlertofile@writeemptylinestrue
\pgfplotsset{
	plot unprocessed to file/.code={
		\edef\tikz@plot@handler{\noexpand\pgfplotsplothandlertofile{#1}}%
	},
	plot to file/empty lines/.is if=pgfplotsplothandlertofile@writeemptylines,
}
...
\def\pgfplotsplothandlernotifyscanlinecomplete@tofile{%
	\ifpgfplotsplothandlertofile@writeemptylines
