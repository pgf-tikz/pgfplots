...
\def\pgfplotsplothandlercontour@empty@pointmeta@error{%
	\if0\pgfplotsplothandlercontour@empty@pointmeta@error@@
		...
		\pgfplotsthrow{invalid argument}{\pgfplots@current@point@meta}{Sorry, contour plots require non--empty `point meta'. Please use '\string\addplot3[contour ...] together with 'view={0}{90}' or provide a valid 'point meta=<value>' (for example `<value>=z'?)}%
	\fi
}%
