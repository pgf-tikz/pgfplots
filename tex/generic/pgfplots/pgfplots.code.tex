...
\def\pgfplots@color@of@colormap@parse@in#1 of #2\pgfplots@EOI{%
	\edef\pgfplots@color@of@colormap@value{#1}%
	\edef\pgfplots@color@of@colormap@name{#2}%
}
\def\pgfplots@color@of@colormap#1{%
	...
	\fi
	\def\pgfplots@loc@TMPb{\pgfutil@definecolor{mapped color}{\csname pgfpl@cm@\pgfplots@color@of@colormap@name @colspace\endcsname}}%
	\expandafter\pgfplots@loc@TMPb\expandafter{\pgfmathresult}%
	\tikzset{color=mapped color}%
}
