...
\pgfkeys{%
	...
	/pgfplots/trig format plots/rad/.code={%
		\pgfplots@set@trig@format@plots@check@pgf@version
		\def\pgfplots@set@trig@format@plots{\pgfkeys{/pgf/trig format=rad}}%
	},%
...
\def\pgfplots@set@trig@format@plots@check@pgf@version{%
	\pgfkeysifdefined{/pgf/trig format/rad/.@cmd}{}{%
		\pgfplotsthrow{unsupported operation}{Sorry, 'trig format plots' is unsupported with your version of PGF}\pgfeov
	}%
}%
