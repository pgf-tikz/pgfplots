...
\pgfkeys{%
	...
	/pgfplots/lua debug/false/.code={%
		\pgfplots@LUA@backend@debugmodefalse
		\def\pgfplots@LUA@loglevel@debug{5}%
	},
	/pgfplots/lua debug/true/.code={%
		\pgfplots@LUA@backend@debugmodetrue
		\def\pgfplots@LUA@loglevel@debug{4}%
	},
	/pgfplots/lua debug/.default=true,
	/pgfplots/lua debug=false,
