...
%\message{/pgfplots/error bars/draw error bar:  working with '#1' -- '#2'.}%
	...
	/pgfplots/nodes near coords*/.style={%
		...
		scatter/@post marker code/.append code={%
			...
			\ifx\pgfplots@nodes@near@coords@align\pgfplots@loc@TMPa
				\if\pgfplots@perpointmeta@choice5%
...
% will be evaluated; afterwards it is processed like 'explicit'.
	/pgfplots/point meta/.code={%
		...
		\pgfkeysifdefined{/pgfplots/point meta/\pgfplots@loc@TMPb/.@cmd}{%
			...
			\def\b@pgfplots@perpointmeta@issymbolic{0}%
		}%
	},%
	...
	/pgfplots/point meta/explicit symbolic/.code={
		...
		\def\b@pgfplots@perpointmeta@issymbolic{1}%
	},
...
\def\pgfplots@drawaxis@outerlines@separate@onorientedsurf#1#2{%
	...
	\if0\csname pgfplots@#1axislinesnum\endcsname
		% a boxed axis.
	...
	\else
		\if2\csname pgfplots@#1axislinesnum\endcsname
			% centered handled elsewhere.
		\else
			\pgfplots@ifaxisline@B@onorientedsurf@should@be@drawn{0}{%
				\pgfplotspointonorientedsurfaceabtolinespec v0%
				\edef\pgfplots@loc@TMPa{\csname pgfplots@#1ticklabelaxisspec\endcsname}%
\message{I am on \pgfplotspointonorientedsurfacespec; testing if \pgfplotsretval\space shall be drawn: `\pgfplotsretval=\pgfplots@loc@TMPa':}%
			...
			%
			\pgfplots@ifaxisline@B@onorientedsurf@should@be@drawn{1}{%
				\pgfplotspointonorientedsurfaceabtolinespec v1%
				\edef\pgfplots@loc@TMPa{\csname pgfplots@#1ticklabelaxisspec\endcsname}%
\message{I am on \pgfplotspointonorientedsurfacespec; testing if \pgfplotsretval\space shall be drawn: `\pgfplotsretval=\pgfplots@loc@TMPa':}%
				\ifx\pgfplots@loc@TMPa\pgfplotsretval
					\draw decorate {
