...
\def\pgfplotslegendfromname#1{%
	\csname protect\endcsname\pgfplotslegendfromname@{#1}%
}%
\def\pgfplotslegendfromname@#1{%
	\pgfutil@ifundefined{pgfplots@legend@to@name@#1}{%
		\pgfutil@ifundefined{ref}{%
			\pgfplots@error{There is no `legend to name=#1', sorry. I am skipping it}%
		}{%
...
\def\pgfplotscolorbarfromname#1{%
	\csname protect\endcsname\pgfplotscolorbarfromname@{#1}%
}%
\def\pgfplotscolorbarfromname@#1{%
	\pgfutil@ifundefined{pgfplots@colorbar@to@name@#1}{%
		\pgfutil@ifundefined{ref}{%
			\pgfplots@error{There is no `colorbar to name=#1', sorry. I am skipping it}%
		}{%
...
\def\pgfplots@colorbar@move@outside@scope@with@globalmacro#1{%
	...
	\else
		\pgfplotsutilforeachcommasep{%
			\pgfplots@savedstyle@colorbar@draw,%
			\pgfplots@savedstyle@colorbar,%
			\pgfplots@savedstyle@colorbarshift,%
			\pgfplots@savedstyle@tick,%
			\pgfplots@savedstyle@minortick,%
			\pgfplots@savedstyle@majortick,%
			\pgfplots@savedstyle@grid,%
			\pgfplots@savedstyle@minorgrid,%
			\pgfplots@savedstyle@majorgrid,%
			\pgfplots@savedstyle@ticklabel,%
			\pgfplots@savedstyle@ticklabel}%
			\as\macro
		{%
			\expandafter\pgfplots@command@with@args@to@string\macro\pgfplots@loc@TMPa
			\pgfplots@auxwrite{%
				\noexpand\expandafter
				\noexpand\long
				\noexpand\expandafter
	...
	\xdef#1{%
		...
		\noexpand\def\noexpand\pgfplots@colorbar@draw{%
			...
			\the\toks1 % defintions for 'colorbar to name'
			%
