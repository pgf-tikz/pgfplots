...
\def\pgfplots@set@optimal@datatrafos@allaxes{%
	\if3\pgfplots@scale@mode@choice
		...
		% same scale.
		%
		% Note that this needs to be done here; a later rescaling
		% might cause dimension-too-large.
\message{FIXME : FIXME choose the correct common datascaling factor (probably the smallest?)^^J}%
		\pgfplotscoordmath{x}{datascaletrafo set params}{\pgfplots@data@scale@trafo@EXPONENT@x}{0}%
		\pgfplotscoordmath{y}{datascaletrafo set params}{\pgfplots@data@scale@trafo@EXPONENT@x}{0}%
		\pgfplotscoordmath{z}{datascaletrafo set params}{\pgfplots@data@scale@trafo@EXPONENT@x}{0}%
	\fi
}%
