...
\def\pgfplots@apply@unit@ratio@prepareratios#1 #2 #3 #4\pgfplots@EOI{%
	...
	\fi
	%
	% Normalize such that the reference weight is 1:
	\expandafter\let\expandafter\pgfplots@unit@ratio@max\csname pgfplots@unit@ratio@\pgfplots@apply@unit@ratio@reference\endcsname
