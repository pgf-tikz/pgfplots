...
\def\pgfplots@apply@unit@ratio@prepareratios#1 #2 #3\pgfplots@EOI{%
	\begingroup
	\def\pgfplots@unit@ratio@max{#1}%
	\ifdim#2pt>\pgfplots@unit@ratio@max pt
		\def\pgfplots@unit@ratio@max{#2}%
	\fi
	\ifpgfplots@threedim
		\ifdim#3pt>\pgfplots@unit@ratio@max pt
			\def\pgfplots@unit@ratio@max{#3}%
		\fi
	\fi
	...
	\pgfmath@basic@multiply@{#1}{\pgfplots@loc@TMPa}%
	\let\pgfplots@unit@ratio@x=\pgfmathresult
	\pgfmath@basic@multiply@{#2}{\pgfplots@loc@TMPa}%
	\let\pgfplots@unit@ratio@y=\pgfmathresult
	\ifpgfplots@threedim
		\pgfmath@basic@multiply@{#3}{\pgfplots@loc@TMPa}%
