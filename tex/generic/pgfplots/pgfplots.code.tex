...
% axis options:
	...
	/pgfplots/clip has bounding box/.is if=pgfplots@clip@has@bb,
	/pgfplots/clip has bounding box=true, % the compat stuff. this is for backw. compat.
...
% FIXME: simplify this code! It is just a replication of the default error stuff together with an xshift!
	...
	/pgfplots/mesh/colorspace explicit color input/.initial=\pgfkeysvalueof{/pgfplots/mesh/colorspace explicit color output},
	%
...
% Defines the class name \pgfplotspointmetainputhandler:
	...
	/pgfplots/compat/general/pre 1.3/.style={/pgfplots/log origin=infty,/pgfplots/clip has bounding box=true},%
	...
	/pgfplots/compat/general/1.8/.style=	{/pgfplots/compat/general/1.5,/pgfplots/clip has bounding box=false},%
