...
% Defines the class name \pgfplotspointmetainputhandler:
	...
	/pgfplots/compat/general/pre 1.3/.code={%
		\pgfkeysalso{/pgfplots/log origin=infty}%
		\def\b@pgfplots@compat@BB@includes@clippath{1}%
	},
	...
	/pgfplots/compat/general/1.8/.code={%
		\pgfkeysalso{/pgfplots/compat/general/1.5}%
		\def\b@pgfplots@compat@BB@includes@clippath{0}%
	},
	/pgfplots/compat/general/newest/.code=	{/pgfplots/compat/general/1.8},
	...
	\def\pgfplots@clippath@install##1{%
		\begingroup
			...
			\ifx\pgfplots@loc@TMPa\pgfplots@clippath@install@test
				...
				\if1\b@pgfplots@compat@BB@includes@clippath
				\else
