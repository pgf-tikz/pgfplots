...
\pgfkeys{%
	...
	/pgfplots/ylabel near ticks/.style={%
		...
		/pgfplots/every y tick scale label/.style={at={(yticklabel* cs:1.03,-0.3em)},anchor=near yticklabel opposite,inner sep=0pt},
	},%
		...
		/pgfplots/axis y line/center/.code	={
			...
			\pgfkeysalso{%
				...
				/pgfplots/every y tick scale label/.code={%
					...
					\else
						\pgfkeysalso{at={(yticklabel* cs:1.03,-0.3em)},anchor=near yticklabel opposite,inner sep=0pt}%
					\fi
				},%
				/pgfplots/every non boxed y axis}%
		},
...
% Defines the class name \pgfplotspointmetainputhandler:
	...
	/pgfplots/compat/general/1.8/.style=	{/pgfplots/compat/general/newest},%
