...
\def\pgfplots@LUA@visualization@update@axis{%
	\directlua{%
		...
		pgfplots.gca.axiswidemetamin = pgfplots.pgfplotsmath.tonumber("\pgfplots@axiswide@metamin"); ^^J%
		pgfplots.gca.axiswidemetamax = pgfplots.pgfplotsmath.tonumber("\pgfplots@axiswide@metamax"); ^^J%
	}%
}%
