...
\def\pgfplots@BEGIN@cell@picture@DISABLED[#1]{%
	...
	\pgftransformshift{%
		\pgfqpointscale{-1}{%
			\pgfplotspointdescriptionbyanchor{\pgfplots@anchorname@internal}%
		}
\message{cell picture=false: installing shift for anchor=\pgfplots@anchorname@internal: (\the\pgf@x,\the\pgf@y)^^J}%
	}%
	%
	% FIXME 
	%\pgfplots@define@preliminary@current@axis@node
