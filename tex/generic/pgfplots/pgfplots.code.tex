...
\def\pgfplots@END@cell@picture@preparepoints{%
	...
	\else
	% this was part of my attempts to fix 'cell picture=false'. I
	% still doubt that it works reliably
	%	\pgfpointadd{\pgfplotspointupperrightcorner}{%
	%		\pgfqpointscale{-1}{\pgfplots@cell@picture@DISABLED@shifts}%
	%	}%
	%	\xdef\pgfplotspointupperrightcorner{\global\pgf@x=\the\pgf@x\space\global\pgf@y=\the\pgf@y\space}%
	\fi
	%
