...
% Defines the class name \pgfplotspointmetainputhandler:
	...
	/pgfplots/const color of colormap/.code={%
		% colormap access=piecewise constant
		\def\pgfplots@color@of@colormap@access{c}%
		\pgfplots@color@of@colormap{#1}%
	},%
	/tikz/color of colormap/.style={/pgfplots/color of colormap={#1}},
	% index of colormap={4}
...
\def\pgfplotscolorbardrawstandalone@opt[#1]{%
	\pgfplots@ifintikzpicture{%
		\def\b@close@pgfplotscolorbardrawstandalone{0}%
	}{%
		\begin{tikzpicture}%
		\def\b@close@pgfplotscolorbardrawstandalone{1}%
	}%
	%
	...
	%
	\if1\b@close@pgfplotscolorbardrawstandalone
		\end{tikzpicture}%
	\fi
}%
