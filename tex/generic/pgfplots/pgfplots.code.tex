...
% legend options:
	...
	/pgfplots/legend to macro/.initial=,%
...
\def\pgfplots@createlegend{%
	\pgfkeysgetvalue{/pgfplots/legend to macro}\pgfplots@createlegend@tomacro
	\ifx\pgfplots@already@computed@legend@node\pgfutil@empty
		...
		% 
		\begingroup
			\ifx\pgfplots@createlegend@tomacro\pgfutil@empty
				% ok, draw legend.
...
%\pgfplots@message{Vor legende: \meaning\pgfplots@already@computed@legend@node}%
	...
	\else
		...
		\expandafter\xdef\pgfplots@createlegend@tomacro{%
			\noexpand\begingroup
			\noexpand\pgfkeysdef{/pgfplots/every axis legend}{\the\t@pgfplots@tokb}%
			\noexpand\pgfplots@ifintikzpicture{\the\t@pgfplots@toka}{\noexpand\tikz[/pgfplots/every legend macro picture/.try]{\the\t@pgfplots@toka}}%
			\noexpand\endgroup
		}%
	\fi
}
