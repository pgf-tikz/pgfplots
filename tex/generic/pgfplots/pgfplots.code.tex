...
\newif\ifpgfplots@LUA@backend@debugmode
...
\pgfkeys{%
	...
	%
	/pgfplots/lua debug/.is if=pgfplots@LUA@backend@debugmode,
	/pgfplots/lua debug/.default=true,
...
\def\pgfplots@LUA@visualizationlog@deactivation#1{%
	\pgfplots@log3{Using 'lua backend=false' for axis: #1.}%
}%
\def\pgfplots@prepare@LUA@api{%
	\ifpgfplots@LUA@backend@supported
		...
		%
		\ifpgfplots@stackedmode
			\pgfplots@log3{stacked plots unsupported (yet)}%
			\pgfplots@LUA@backend@supportedfalse
		\fi
		%
		\ifpgfplots@xislinear\else \pgfplots@LUA@backend@supportedfalse\pgfplots@log3{xmode=log unsupported (yet)}\fi
		\ifpgfplots@yislinear\else \pgfplots@LUA@backend@supportedfalse\pgfplots@log3{ymode=log unsupported (yet)}\fi
		\ifpgfplots@zislinear\else \pgfplots@LUA@backend@supportedfalse\pgfplots@log3{zmode=log unsupported (yet)}\fi
		%
		\pgfkeysgetvalue{/pgfplots/x coord trafo/.@cmd}\pgfplots@loc@TMPc\ifx\pgfplots@loc@TMPc\pgfplots@empty@command@key\else \pgfplots@LUA@backend@supportedfalse\pgfplots@log3{x coord trafo unsupported}\fi
		\pgfkeysgetvalue{/pgfplots/y coord trafo/.@cmd}\pgfplots@loc@TMPc\ifx\pgfplots@loc@TMPc\pgfplots@empty@command@key\else \pgfplots@LUA@backend@supportedfalse\pgfplots@log3{x coord trafo unsupported}\fi
		\pgfkeysgetvalue{/pgfplots/z coord trafo/.@cmd}\pgfplots@loc@TMPc\ifx\pgfplots@loc@TMPc\pgfplots@empty@command@key\else \pgfplots@LUA@backend@supportedfalse\pgfplots@log3{x coord trafo unsupported}\fi
		%
		% FIXME: collect all remaining	items
		%
		\ifpgfplots@LUA@backend@supported
			\pgfplots@log3{lua backend=true: Activating LUA backend for axis.}%
			\directlua{%
...
\def\pgfplots@LUA@visualization@update@axis{%
	\let\pgfplots@loc@TMPa{}%
	\pgfplotscoordmath{x}{datascaletrafo get params}%
	\edef\pgfplots@loc@TMPa{%
		\pgfplots@loc@TMPa
		local datascaleTrafoX = DatascaleTrafo.new(\pgfplotsretval,\pgfplotsretvalb);^^J
	}%
	\pgfplotscoordmath{y}{datascaletrafo get params}%
	\edef\pgfplots@loc@TMPa{%
		\pgfplots@loc@TMPa
		local datascaleTrafoY = DatascaleTrafo.new(\pgfplotsretval,\pgfplotsretvalb);^^J
	}%
	\pgfplotscoordmath{z}{datascaletrafo get params}%
	\edef\pgfplots@loc@TMPa{%
		\pgfplots@loc@TMPa
		local datascaleTrafoZ = DatascaleTrafo.new(\pgfplotsretval,\pgfplotsretvalb);^^J
	}%
	%
	\directlua{%
		\pgfplots@loc@TMPa
		...
		axis.axiswidemetamin = pgfplots.pgfplotsmath.tonumber("\pgfplots@axiswide@metamin"); ^^J%
		axis.axiswidemetamax = pgfplots.pgfplotsmath.tonumber("\pgfplots@axiswide@metamax"); ^^J%
