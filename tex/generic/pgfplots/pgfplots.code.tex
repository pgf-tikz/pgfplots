...
\newif\ifpgfplots@compat@scale@mode@compatible@mode@warning
...
% axis options:
	...
	/pgfplots/scale uniformly warning=true,
...
% Defines the class name \pgfplotspointmetainputhandler:
	...
	/pgfplots/compat/scaling/pre 1.3/.code={%
		...
		\def\pgfplots@compat@scaling@coordmath@threedim{pgfbasic}%
	},
	...
	/pgfplots/compat/scaling/1.6/.code={%
		\def\pgfplots@compat@scaling@zunitfix@enable{1}%
		\def\pgfplots@compat@scaling@coordmath{float}%
		\def\pgfplots@compat@scaling@coordmath@threedim{float}%
	},
	/pgfplots/compat/scaling/newest/.style={/pgfplots/compat/scaling/1.6},
	/pgfplots/compat/scaling/default/.style={/pgfplots/compat/scaling/1.6},
	%
	...
	%
	/pgfplots/compat/scale mode warning/.is if=pgfplots@compat@scale@mode@compatible@mode@warning,
	/pgfplots/compat/scale mode warning=true,
	%
