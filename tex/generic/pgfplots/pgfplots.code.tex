...
%\message{/pgfplots/error bars/draw error bar:  working with '#1' -- '#2'.}%
	...
	/pgfplots/nodes near coords xbar stacked configuration/.style={
		...
		/pgfplots/nodes near coords*/.default={%
...
% Defines the class name \pgfplotspointmetainputhandler:
	...
	/pgfplots/compat/bar nodes/pre 1.3/.style={%
		...
		/pgfplots/activate nodes near coords xbar stacked/.code=,
...
\long\def\pgfplots@evalute@tikz@coord@system@interface@[#1]#2,#3\pgfplots@coord@end{%
	\begingroup
	\pgfplots@evalute@tikz@coord@system@interface@tocoords[#1]#2,#3\pgfplots@coord@end
...
\def\pgfplots@evalute@tikz@coord@system@interface@tocoords[#1]#2,#3\pgfplots@coord@end{%
...
\def\pgfplots@evalute@tikz@coord@system@interface@normalized{%
	\pgfutil@ifnextchar[%
		{\pgfplots@evalute@tikz@coord@system@interface@normalized@}%
		{\pgfplots@evalute@tikz@coord@system@interface@normalized@[]}%
}
\long\def\pgfplots@evalute@tikz@coord@system@interface@normalized@[#1]#2,#3\pgfplots@coord@end{%
	\begingroup
