...
%	/pgfplots/hide axis/.belongs to family=/pgfplots,
	...
	%
	/pgfplots/axis x line limits/.is choice,
	/pgfplots/axis x line limits/axis/.code={\def\pgfplots@x@line@limit{0}},
	/pgfplots/axis x line limits/data/.code={\def\pgfplots@x@line@limit{1}},
	/pgfplots/axis y line limits/.is choice,
	/pgfplots/axis y line limits/axis/.code={\def\pgfplots@y@line@limit{0}},
	/pgfplots/axis y line limits/data/.code={\def\pgfplots@y@line@limit{1}},
	/pgfplots/axis z line limits/.is choice,
	/pgfplots/axis z line limits/axis/.code={\def\pgfplots@z@line@limit{0}},
	/pgfplots/axis z line limits/data/.code={\def\pgfplots@z@line@limit{1}},
	/pgfplots/axis line limits/.style={%
		/pgfplots/axis x line limits={#1},%
		/pgfplots/axis y line limits={#1},%
		/pgfplots/axis z line limits={#1},%
	},%
	%
...
% Defines the class name \pgfplotspointmetainputhandler:
	...
	/pgfplots/compat/general/1.13/.style=	{/pgfplots/compat/general/1.12},%
...
%\message{Converting #1tick='\csname pgfplots@#1tick\endcsname'}%
	...
	%
	\pgfplotscoordmath{#1}{datascaletrafo}{\csname pgfplots@data@#1min\endcsname}%
	\expandafter\global\expandafter\let\csname pgfplots@data@#1min@transformed\endcsname=\pgfmathresult
	%
	\pgfplotscoordmath{#1}{datascaletrafo}{\csname pgfplots@data@#1max\endcsname}%
	\expandafter\global\expandafter\let\csname pgfplots@data@#1max@transformed\endcsname=\pgfmathresult
}
