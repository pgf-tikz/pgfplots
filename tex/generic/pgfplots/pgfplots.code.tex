...
% will be evaluated; afterwards it is processed like 'explicit'.
	...
	/pgfplots/scatter/classes/.code={%
		...
		%
		\pgfkeyslet{/pgfplots/scatter/@pre marker code/.@cmd}\pgfplots@scatter@classes@pre@marker@code
		...
		\pgfkeys{/pgfplots/execute at begin plot/.add={}{%
				\ifpgfplots@scatterplotenabled
					...
					\ifx\pgfplots@loc@TMPa\pgfplots@scatter@classes@pre@marker@code
						...
						\def\pgfplots@rememberplotspec##1{%
							...
							\pgfplotsforeachentryinCSV{\pgfplots@scatter@loc@TMPb}{#1}{%
								\edef\pgfplots@scatter@loc@TMPb{\pgfplots@scatter@loc@TMPb}%
