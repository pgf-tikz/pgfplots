...
\def\pgfplots@colorbar@define@hook{%
	\def\pgfplots@colorbar@position@hook{%
		...
		\def\pgfplots@colorbar@position@prepare@CS{%
			...
			\edef\pgfplots@loc@TMPa{\the\pgf@x}
			\edef\pgfplots@loc@TMPb{\the\pgf@y}%
			\pgfpointanchor{parent axis}{north east}%
			\pgf@xa=\pgf@x
			\pgf@ya=\pgf@y
			\advance\pgf@xa by-\pgfplots@loc@TMPa\relax
			\advance\pgf@ya by-\pgfplots@loc@TMPb\relax
			\edef\pgfplotspoint@bb@@@{{\pgfplots@loc@TMPa}{\pgfplots@loc@TMPb}{\the\pgf@xa}{\the\pgf@ya}}%
		}%
		%
