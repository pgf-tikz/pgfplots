...
\pgfqkeys{/pgfplots/@cycle}{%
	...
	const colors of colormap/.code={%
		\pgfplotscreateplotcyclelist@check@specials@process@colormap@conversion{#1}{const color of colormap}%
	},
}
...
% Defines the class name \pgfplotspointmetainputhandler:
	...
	/pgfplots/colormap access/piecewice constant/extra interval width/.code={%
