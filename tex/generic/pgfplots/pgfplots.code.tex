	...
	/pgfplots/colorbar as legend/.style={
		...
		/pgfplots/colorbar/draw/.add code={%
			...
			\pgfplotsforeachungrouped \x in {0,...,\pgfplots@colorcount} {%
				% \x is a float here (the enclosing group activates /pgf/fpu)
				% turn it back into an integer index for \pgfplotsarrayselect.
...
\long\def\pgfplots@show@label#1#2{%
	...
	\pgfplotsonlayer{\pgfplotsretval}{axis #1 label}%
		\node
...
\long\def\pgfplots@show@title#1{%
	...
	\pgfplotsonlayer{\pgfplotsretval}{axis title}%
		\node%
