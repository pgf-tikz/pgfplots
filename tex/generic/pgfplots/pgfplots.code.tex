...
% axis options:
	...
	%
	% This is a "hidden" feature (it has no entry in the pdf manual).
	% The purpose is to control the case 'stacked ignores zero=true'
	...
	% 2. stacked ignores zero/phases/<phasename>=true
	% Valid <phasename>s are 'default', 'markers', 'errorbars'.
	/pgfplots/stacked ignores zero/phases/\pgfplotsaxis@visphase@name@default/.initial=true,
	/pgfplots/stacked ignores zero/phases/\pgfplotsaxis@visphase@name@markers/.initial=false,
	/pgfplots/stacked ignores zero/phases/\pgfplotsaxis@visphase@name@errorbars/.initial=false,
		...
		\pgfkeysdef{/pgfplots/#1 coord trafo}{%
			\expandafter\pgfplotsutilifstartswith\expandafter{\pgfplots@symb@magic@prefix}{##1}{%
				...
				\pgfutil@ifundefined{pgfp@symb@coords@#1@\pgfplots@loc@TMPa}{%
					\t@pgfplots@toka={##1}%
					\t@pgfplots@tokb={#2}%
					\pgfplots@error{Sorry, the input coordinate `\the\t@pgfplots@toka' has not been defined with 'symbolic #1 coords={\the\t@pgfplots@tokb}... Maybe it has been misspelled?}%
					\def\pgfmathresult{0}%
				}{%
...
%\message{#1 coord inv trafo{##1} -->\the\count0 --> \meaning\pgfmathresult^^J}%
		...
		\pgfkeysifdefined{/pgfplots/#1ticklabel/.@cmd}{%
			\pgfkeysalso{%
				/pgfplots/#1ticklabel={\pgfplots@ticklabel@prefix\tick},%
...
% Defines the class name \pgfplotspointmetainputhandler:
	...
	/pgfplots/compat/general/1.11/.style=	{/pgfplots/compat/general/1.5},%
	...
	%
	/pgfplots/compat/ticklabel struts/.is choice,
	/pgfplots/compat/ticklabel struts/pre 1.3/.code={\let\pgfplots@ticklabel@prefix=\relax},%
	/pgfplots/compat/ticklabel struts/1.3/.style=	{/pgfplots/compat/ticklabel struts/pre 1.3},
	/pgfplots/compat/ticklabel struts/1.4/.style=	{/pgfplots/compat/ticklabel struts/pre 1.3},%
	/pgfplots/compat/ticklabel struts/1.5/.style=	{/pgfplots/compat/ticklabel struts/pre 1.3},%
	/pgfplots/compat/ticklabel struts/1.5.1/.style=	{/pgfplots/compat/ticklabel struts/pre 1.3},%
	/pgfplots/compat/ticklabel struts/1.6/.style=	{/pgfplots/compat/ticklabel struts/pre 1.3},%
	/pgfplots/compat/ticklabel struts/1.7/.style=	{/pgfplots/compat/ticklabel struts/pre 1.3},%
	/pgfplots/compat/ticklabel struts/1.8/.style=	{/pgfplots/compat/ticklabel struts/pre 1.3},%
	/pgfplots/compat/ticklabel struts/1.9/.style=	{/pgfplots/compat/ticklabel struts/pre 1.3},%
	/pgfplots/compat/ticklabel struts/1.10/.style=	{/pgfplots/compat/ticklabel struts/pre 1.3},%
	/pgfplots/compat/ticklabel struts/1.11/.code=	{\def\pgfplots@ticklabel@prefix{\strut}},
	/pgfplots/compat/ticklabel struts/newest/.style={/pgfplots/compat/ticklabel struts/1.11},
	/pgfplots/compat/ticklabel struts/default/.style={/pgfplots/compat/ticklabel struts/pre 1.3},
	%
	%
	...
	/pgfplots/compat/.style={%
		...
		/pgfplots/compat/ticklabel struts=#1,%
	},%
...
\long\def\pgfplots@evalute@tikz@coord@system@interface@for[#1]#2#3{%
	...
	\def\pgfmathresult{#3}% do not expand it - might contain unexpandable input for coord trafo.
	\ifx\pgfplots@loc@TMPc\pgfplots@empty@command@key
	\else
		\expandafter\pgfplots@loc@TMPc\expandafter{\pgfmathresult}\pgfeov
	\fi
	\edef\pgfmathresult{\pgfmathresult}% ensure it is expanded.
...
\def\pgfplots@install@abbrev@commands{
	...
	\def\axisdefaultticklabel{\pgfplots@ticklabel@prefix\pgfmathprintnumber{\tick}}%
	\def\axisdefaultticklabellog{%
		\pgfplots@ticklabel@prefix
