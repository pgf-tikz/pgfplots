...
\def\pgfplots@END@cell@picture{%
		\endtikzpicture%
		\begingroup
			\pgfplots@END@cell@picture@preparepoints0%
		\endgroup
...
% #1: 1 if the points need to be transformed, 0 if not.
\def\pgfplots@END@cell@picture@preparepoints#1{%
	...
	\pgf@xa=\pgf@x
	\pgf@ya=\pgf@y
	\if1#1\relax \pgf@pos@transform\pgf@xa\pgf@ya \fi
	...
	%
	\pgfplotspointaxisorigin
	\if1#1\relax \pgf@pos@transform\pgf@x\pgf@y \fi
	\global\advance\pgf@x by-\pgf@picminx
	\global\advance\pgf@y by-\pgf@picminy
...
\def\pgfplots@END@cell@picture@DISABLED{%
		\endscope%
		\begingroup
			\pgfplots@END@cell@picture@preparepoints1%
		\endgroup
