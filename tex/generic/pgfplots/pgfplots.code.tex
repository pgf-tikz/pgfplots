...
% Defines the class name \pgfplotspointmetainputhandler:
	...
	/pgfplots/scatter/classes*/.code={%
		...
		%
		\pgfkeysalso{%
			/pgfplots/scatter/@pre marker code/.append code={\pgfplots@markers@scatter@classes@pre@marker@code},%
			/pgfplots/scatter/@post marker code/.prefix code={\endscope}%
		}%
		...
		\pgfkeys{/pgfplots/execute at begin plot@@/.add={}{%
				\ifpgfplots@scatterplotenabled
					...
					\def\pgfplots@loc@TMPb{\pgfutil@in@{\pgfplots@markers@scatter@classes@pre@marker@code}}%
...
%\message{DATA: '\meaning\pgfplots@stored@current@data';^^J}%
			...
			\else
				...
				% command!
				\pgfplots@stored@plotlist@visualize
			\fi
			\pgfplots@stored@current@postcmd
		}%
		%
...
\def\pgfplots@stored@plotlist@visualize{%
	\begingroup
	...
	\fi
	\ifpgfplots@loc@tmp
		\pgfplots@stored@plotlist@visualize@clippedpart
	\fi
	%
...
\def\pgfplots@stored@plotlist@visualize@clippedpart{%
	...
	\expandafter\pgfplotsutilforeachcommasep\expandafter{\pgfplots@visphase@names}\as\pgfplots@visphase@name{%
		% FIXME : improve the concept of "visualization phases" here.
		% Perhaps I can implement error bars on top of it - would be
		% cool if they could also rely on 'visualization depends on'
		% and the rest.
