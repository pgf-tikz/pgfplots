...
\def\pgfplots@set@default@size@options@threedim@#1#2{%
	\pgfplots@error{Sorry, a 3D axis needs either NONE or ALL of "x,y,z,viewdir". I found partial information, but (at least) '#1' is lacking... please add '#1'}%
...
\def\pgfplots@initsizes{%
	...
	\ifx\pgfplots@view@az\pgfutil@empty
		...
		\else
\message{ICh habe nu W=\pgfplots@width, H =\pgfplots@height^^J}%
	...
	\else
		...
		% this invokes \pgfplots@scaleaxes@to@widthheight automatically.
