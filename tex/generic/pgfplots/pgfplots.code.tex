...
\pgfplots@deprecated@dontlogscalevariancetrue
...
% Defines the class name \pgfplotspointmetainputhandler:
	...
	/pgfplots/compat/dontlogscalevariance/1.18/.style=	{/pgfplots/compat/dontlogscalevariance/pre 1.3},
	/pgfplots/compat/dontlogscalevariance/1.18X/.code=	{\pgfplots@deprecated@dontlogscalevariancefalse},% FIXME:  might need a revision! compare exampels in manual
	/pgfplots/compat/dontlogscalevariance/default/.style=	{/pgfplots/compat/dontlogscalevariance/pre 1.3},%
	%
