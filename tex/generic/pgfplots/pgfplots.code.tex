...
% Defines the class name \pgfplotspointmetainputhandler:
	...
	/pgfplots/compat/scaling/pre 1.3/.code={\def\pgfplots@compat@scaling@coordmath{pgfbasic}},
	/pgfplots/compat/scaling/1.3/.style={/pgfplots/compat/scaling/pre 1.3},
	/pgfplots/compat/scaling/1.4/.code={\def\pgfplots@compat@scaling@coordmath{float}},
