...
\pgfkeys{%
	...
	% path /pgfplots/array. See pgfplotsarray.code.tex for available
	% styles.
	/pgfplots/table/sort cmp/.initial=iflessthan float,
...
\def\pgfplotstablesort@[#1]#2#3{%
	...
	\def\pgfplotstable@loc@TMPa{\pgfqkeys{/pgfplots/array}}%
	\expandafter\pgfplotstable@loc@TMPa\expandafter{\pgfplotstable@sort@cmp}%
	\pgfkeysgetvalue{/pgfplots/array/iflessthan/.@cmd}\pgfplotstable@sort@cmp@routine
