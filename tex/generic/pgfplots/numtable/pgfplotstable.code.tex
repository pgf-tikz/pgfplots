...
\long\def\pgfplotstabletypeset@opt@[#1]#2{%
	...
	\ifpgfplotstable@sort
		...
		\def\pgfplots@loc@TMPa{%
			\pgfplotstablesort\pgfplotstable@sortedtbl{#2}%
			\pgfplotstabletypeset@opt@@{\pgfplotstable@sortedtbl}%
		}%
	\else
		\def\pgfplots@loc@TMPa{%
			\pgfplotstabletypeset@opt@@{#2}%
		}%
	\fi
	\pgfplots@loc@TMPa
}
\def\pgfplotstabletypeset@opt@@#1{%
	...
	\pgfplotslistforeach\pgfplotstable@colnames\as\pgfplotstable@colname{%
		...
		\fi
		\pgfplotstablegetcolumnbyname\pgfplotstable@colname\of#1\to\pgfplotstable@col
		%
	...
	\fi
	\fi% end for \ifpgfplotstabletypeset@includeoutfiles
	\endgroup
