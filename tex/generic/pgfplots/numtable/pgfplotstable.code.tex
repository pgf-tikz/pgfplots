...
\pgfkeys{%
	...
	/pgfplots/table/create col/linear regression/xmode/.initial=,%
	/pgfplots/table/create col/linear regression/ymode/.initial=,%
...
\long\def\pgfplotstablecollectoneargwithpreparecatcodes#1{%
	\pgfutil@ifnextchar\bgroup{%
		\pgfplotstablereadpreparecatcodes
		\pgfplotstablecollectoneargwithpreparecatcodes@end{#1}%
	}{%
		\pgfplotstablereadpreparecatcodes
		\pgfplotstablecollectoneargwithpreparecatcodes@end{#1}%
	}%
...
\def\pgfplotstablecollectoneargwithpreparecatcodes@end#1#2{%
	\pgfplotstablereadrestorecatcodes
	#1{#2}%
}%
...
\def\pgfplotstable@linear@regression{%
	\pgfutil@ifnextchar[{%
		\pgfplotstable@linear@regression@
	}{%
		\pgfplotstable@linear@regression@[]%
	}%
}%
...
\def\pgfplotstable@linear@regression@[#1]#2#3#4\pgfplotstable@EOI{%
	...
	\pgfplotstablegetcolumn{#3}\of{#2}\to\pgfplotstable@X
	\pgfplotstablegetcolumn{#4}\of{#2}\to\pgfplotstable@Y
	...
	\else
		\ifx\pgfplotstable@variance@table\pgfutil@empty
			\expandafter\pgfplotstablegetcolumn\expandafter{\pgfplotstable@variance@colname}\of{#2}\to\pgfplotstable@VARIANCE
		\else
	...
	\ifpgfplots@loop@CONTINUE
		...
		%
		\pgfmathfloatparsenumber{\pgfplotstable@x}%
		\let\pgfplotstable@x=\pgfmathresult
		\pgfmathfloatparsenumber{\pgfplotstable@y}%
