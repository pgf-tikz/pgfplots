...
\pgfkeys{%
	...
	/pgfplots/table/create col/linear regression/a/.initial=,%
	/pgfplots/table/create col/linear regression/b/.initial=,%
...
% 	y_i = exp(Y_i)
% for loglog:
% 	take x_i from input source (which is not log)
% 	take y_i = exp( a* log(x_i) + b)
%
% OPEN: which log!?
% -> is to be determined.
%   
