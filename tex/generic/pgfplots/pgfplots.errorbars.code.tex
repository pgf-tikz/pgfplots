...
%   \pgfplots@current@point@x@error
%   \pgfplots@current@point@y@error
%   \pgfplots@current@point@z@error
%
...
% bar configuration and generates the results
%   
...
%
%   FIXME : why are the input values named in a different way!? And if
%   so, why is the name unmotivated and misleading?
%
