...
\def\pgfplots@plot@handler@graphics@process@pointmap{%
	...
	\pgfmath@basic@reciprocal@{\pgfplots@DDx}%
	\let\pgfplots@DDx@inv=\pgfmathresult
	%
	\pgfmath@basic@reciprocal@{\pgfplots@DDy}%
	\let\pgfplots@DDy@inv=\pgfmathresult
	%
	\pgfmath@basic@reciprocal@{\pgfplots@ddy}%
	\let\pgfplots@ddy@inv=\pgfmathresult
	%
	...
	\let\pgfplots@ddy@inv=\pgfmathresult
	%
	\pgfmath@basic@multiply@{\pgfplots@Ax}{\pgfplots@DDx@inv}%
	\pgfmath@basic@multiply@{\pgfmathresult}{\pgfplots@ddx}%
	\let\pgfplots@vx=\pgfmathresult
	%
	\pgfmath@basic@multiply@{\pgfplots@Ay}{\pgfplots@DDy@inv}%
	...
	%  
	\pgfmath@basic@multiply@{\pgfplots@ddx}{\pgfplots@DDx@inv}%
	\pgfmath@basic@multiply@{\pgfmathresult}{\pgfplots@W}%
	\let\pgfplots@w=\pgfmathresult
	%
	\pgfmath@basic@multiply@{\pgfplots@ddy}{\pgfplots@DDy@inv}%
