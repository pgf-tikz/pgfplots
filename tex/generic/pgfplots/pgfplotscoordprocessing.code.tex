...
\long\def\pgfplots@addplotimpl@table@fromstructure@#1#2#3#4{%
	...
	\fi
	%
	\expandafter\pgfplotstablegetcolumnbyname\expandafter{\pgfplots@plot@tbl@x}\of\pgfplots@table\to\addplot@tbl@x
	\expandafter\pgfplotstablegetcolumnbyname\expandafter{\pgfplots@plot@tbl@y}\of\pgfplots@table\to\addplot@tbl@y
	\ifpgfplots@curplot@threedim
		\expandafter\pgfplotstablegetcolumnbyname\expandafter{\pgfplots@plot@tbl@z}\of\pgfplots@table\to\addplot@tbl@z
	\fi
	%
	\let\addplot@tbl@meta=\pgfutil@empty
	\ifx\pgfplots@plot@tbl@meta\pgfutil@empty
	\else
		\expandafter\pgfplotstablegetcolumnbyname\expandafter{\pgfplots@plot@tbl@meta}\of\pgfplots@table\to\addplot@tbl@meta
	\fi
	%
	%
	...
	\ifpgfplots@errorbars@enabled
		...
		\ifx\pgfplots@plot@tbl@error@x\pgfutil@empty
		\else
			\expandafter\pgfplotstablegetcolumnbyname\expandafter{\pgfplots@plot@tbl@error@x}\of\pgfplots@table\to\addplot@tbl@error@x
		\fi
		\ifx\pgfplots@plot@tbl@error@y\pgfutil@empty
		\else
			\expandafter\pgfplotstablegetcolumnbyname\expandafter{\pgfplots@plot@tbl@error@y}\of\pgfplots@table\to\addplot@tbl@error@y
		\fi
		\ifx\pgfplots@plot@tbl@error@z\pgfutil@empty
		\else
			\expandafter\pgfplotstablegetcolumnbyname\expandafter{\pgfplots@plot@tbl@error@z}\of\pgfplots@table\to\addplot@tbl@error@z
		\fi
		%
	\else
		\let\pgfplots@current@point@x@error=\pgfutil@empty
