...
\def\pgfplotsdeclarecoordmath#1#2{%
	...
	\pgfqkeys{/pgfplots/@declare coord math}{%
		...
		log=		\csname pgfmath\csname pgfpmth@#1@suffix\endcsname ln\endcsname{##1},%
		max=		\csname pgfmath\csname pgfpmth@#1@suffix\endcsname max\endcsname{##1}{##2},%
		min=		\csname pgfmath\csname pgfpmth@#1@suffix\endcsname min\endcsname{##1}{##2},%
