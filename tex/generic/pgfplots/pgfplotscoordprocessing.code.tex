...
\pgfqkeys{/pgfplots/@declare patch}{%
	...
	num vertices/.code=
		{\expandafter\def\csname pgfpptch\pgfplotsdeclarepatchclass@ num vertices\endcsname{\def\pgfplotsretval{#1}}},%
}
\pgfplotsdeclarepatchclass{triangle}{%
	...
	fill path={%
		\pgfpathmoveto{\expandafter\pgfplotspointpatchvertex\pgfplotsplothandlermesh@triangle@A\endvertex}%
		\pgfpathlineto{\expandafter\pgfplotspointpatchvertex\pgfplotsplothandlermesh@triangle@B\endvertex}%
		\pgfpathlineto{\expandafter\pgfplotspointpatchvertex\pgfplotsplothandlermesh@triangle@C\endvertex}%
		\pgfpathclose
	},
	num vertices=3,
}%
	...
	\if1\pgfplotsplothandlermesh@needs@flat@color
		...
		\else
			...
			\def\pgfplotsplothandlermesh@get@flat@color{%
				...
				\pgfplotspatchclass{\pgfplotsplothandlermesh@patchclass}{num vertices}%
