...
\def\pgfplots@LUA@survey@start{%
	\ifpgfplots@LUA@backend@supported
		...
		\ifpgfplots@collect@firstplot@astick
			\pgfplots@LUA@backend@supportedfalse
		\fi
		\pgfkeysgetvalue{/pgfplots/pre filter/.@cmd}\pgfplots@loc@TMPc\ifx\pgfplots@loc@TMPc\pgfplots@empty@command@key\else \pgfplots@LUA@backend@supportedfalse\fi
		\pgfkeysgetvalue{/pgfplots/x filter/.@cmd}\pgfplots@loc@TMPc\ifx\pgfplots@loc@TMPc\pgfplots@empty@command@key\else \pgfplots@LUA@backend@supportedfalse\fi
		\pgfkeysgetvalue{/pgfplots/y filter/.@cmd}\pgfplots@loc@TMPc\ifx\pgfplots@loc@TMPc\pgfplots@empty@command@key\else \pgfplots@LUA@backend@supportedfalse\fi
		\pgfkeysgetvalue{/pgfplots/z filter/.@cmd}\pgfplots@loc@TMPc\ifx\pgfplots@loc@TMPc\pgfplots@empty@command@key\else \pgfplots@LUA@backend@supportedfalse\fi
		\pgfkeysgetvalue{/pgfplots/filter point/.@cmd}\pgfplots@loc@TMPc\ifx\pgfplots@loc@TMPc\pgfplots@empty@command@key\else \pgfplots@LUA@backend@supportedfalse\fi
		%
		...
		%
		\pgfkeysgetvalue{/pgfplots/visualization depends on/list}\pgfplots@loc@TMPc	\ifx\pgfplots@loc@TMPc\pgfutil@empty\else \pgfplots@LUA@backend@supportedfalse \fi
		%
		\ifpgfplots@LUA@backend@supported
			\begingroup
			...
			\edef\pgfplots@loc@TMPa{%
				...
				local plothandler = plothandlerFactory(gca, \pgfplots@loc@TMPa);^^J%
