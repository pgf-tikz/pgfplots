...
% configuration of the /pgfplots/newline choice key (queried in
...
\def\pgfplotsscanlinelengthinitzero{%
	...
	\pgfkeysgetvalue{/pgfplots/newline}\pgfplots@loc@TMPa%
	...
	\pgfutil@ifundefined{pgfplotsscanlinelength@\pgfplots@loc@TMPa @initzero}{%
		\pgfplots@error{Sorry, the choice `newline=\pgfkeysvalueof{/pgfplots/newline}' is unknown. Maybe you misspelled it}%
	}{}%
	...
	\expandafter\let\expandafter\pgfplotsscanlineendofinput			\csname pgfplotsscanlinelength@\pgfplots@loc@TMPa @endofinput\endcsname
...
\let\pgfplotsscanlinelength@scanline@endofinput=\pgfplotsscanlinelength@scanline@complete%
...
\let\pgfplotsscanlinelength@none@endofinput=\relax
\let\pgfplotsscanlinelength@none@cleanup=\relax
% -------------------------------------------------------------------------------
%
% newline=nan   class:
\def\pgfplotsscanlinelength@nan@initzero{%
	% FIXME : this is INCOMPATIBLE with unbounded coords=discard !
	% Howe,ver the discard thing is the initial configuration...
	\pgfplotsplothandlersurveyaddoptions{/pgfplots/unbounded coords=jump}%
...
\def\pgfplotsscanlinelength@nan@complete{%
	...
	\else
		\def\pgfplots@current@point@x{nan}%
