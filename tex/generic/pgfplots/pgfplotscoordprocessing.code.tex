...
\message{PGFPLOTS: the current unit vectors result in a UNIT BB of (\the\pgf@xa,\the\pgf@xb). Scaling it to (\the\pgf@ya,\the\pgf@yb)...^^J}%
	...
	\fi
	\endgroup
\message{Got scale for all x components: \pgfplots@glob@TMPa; for all y components: \pgfplots@glob@TMPb^^J}%
...
\message{got scalex=\pgfplots@loc@TMPa, scaley=\pgfplots@loc@TMPb, scalez=\pgfplots@loc@TMPc, vertical limit componensation in direction \pgfplots@glob@TMPd=\pgfplots@glob@TMPc.^^J}%
	%
	...
	\fi
\message{got scalex=\pgfplots@loc@TMPa, scaley=\pgfplots@loc@TMPb, scalez=\pgfplots@loc@TMPc;  axis limit componsation scales x=\pgfplotsretval, y=\pgfplotsretvalb, z=\pgfplotsretvalc^^J}%
