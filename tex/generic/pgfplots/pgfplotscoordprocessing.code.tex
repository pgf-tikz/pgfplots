...
\def\pgfplots@plot@handler@graphics@parsepointmap@error{%
	\pgfplots@error{plot graphics/points={\pgfplots@loc@TMPa} cannot be processed: I need at least *four* inner anchor points to work, i.e. 4 points of the form (x,y,z) => (imgx,imgy)}%
}%
...
%
% @POSTCONDITION: \pgfplotsretval contain any required keys.
