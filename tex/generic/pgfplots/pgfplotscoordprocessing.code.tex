...
\def\pgfplots@plot@handler@graphics@parsepointmap{%
	\let\pgfplots@plot@handler@pointmap@A@canvas\pgfutil@empty
	\let\pgfplots@plot@handler@pointmap@A@img\pgfutil@empty
	\let\pgfplots@plot@handler@pointmap@B@canvas\pgfutil@empty
	\let\pgfplots@plot@handler@pointmap@B@img\pgfutil@empty
...
\def\pgfplots@plot@handler@graphics@parsepointmap@loop@@@(#1,#2)(#3,#4){%
	...
	\fi
	\ifx\pgfplots@plot@handler@pointmap@A@canvas\pgfutil@empty
		\edef\pgfplots@plot@handler@pointmap@A@canvas{\pgf@x=\the\pgf@x\space\pgf@y=\the\pgf@y\space}%
	\else
	\fi

}

\def\pgfplots@plot@handler@graphics@process@pointmap\pgfplots@EOI{%
}%
