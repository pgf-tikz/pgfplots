...
\def\pgfplotscoordmath@initialise@logs{%
	...
	\message{initialise@logs: ich habe \expandafter\meaning\csname pgfpmth\pgfplotsdeclarecoordmath@ log unsigned int\endcsname sowie \expandafter\meaning\csname pgfpmth\pgfplotsdeclarecoordmath@ @\pgfplotscoordmathid @log unsigned int\endcsname.}%
}%
