...
\def\pgfplots@LUA@survey@start{%
	\ifpgfplots@LUA@backend@supported
		...
		%
		\pgfkeysgetvalue{/pgfplots/execute for finished point/.@cmd}\pgfplots@loc@TMPc\ifx\pgfplots@loc@TMPc\pgfutil@empty\else \pgfplots@LUA@backend@supportedfalse\fi
		%
		\pgfkeysgetvalue{/pgfplots/visualization depends on/list}\pgfplots@loc@TMPa	\ifx\pgfplots@loc@TMPa\pgfutil@empty\else \pgfplots@LUA@backend@supportedfalse \fi
		%
		% FIXME : deactivate LUA backend if some option is unsupported!
		%
		\ifpgfplots@LUA@backend@supported
			\directlua{%
				pgfplots.gca.min = {^^J%
				...
				pgfplots.gca.plothandlers[\the\pgfplots@numplots] = \pgfplotsplothandlerLUAname(pgfplots.gca, \pgfplots@loc@TMPa)^^J%
				pgfplots.currentPlotHandler = pgfplots.gca.plothandlers[\the\pgfplots@numplots]^^J%
			}%
		\fi
	\fi
}%
...
\def\pgfplots@LUA@survey@point{%
	\directlua{%
		do^^J
			...
			^^J
			pgfplots.currentPlotHandler:surveypoint(pt)^^J
		end
	}%
}%
...
\def\pgfplots@LUA@survey@end{%
	\edef\pgfplots@loc@TMPa{%
		\directlua{
			tex.print(pgfplots.gca:surveyToPgfplots(pgfplots.currentPlotHandler, true))				pgfplots.currentPlotHandler=nil
		}%
	}%
