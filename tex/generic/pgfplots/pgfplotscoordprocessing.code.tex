...
\def\pgfplotsplothandlermesh@init@mesh@process@element{%
	\if3\pgfplotsplothandlermesh@shader
		...
		\expandafter\def\expandafter\pgfplotsplothandlermesh@process@element\expandafter{%
			\pgfplotsplothandlermesh@process@element
			\pgfplotslibrarysurfstreamstart
			\pgfplotsplothandlermesh@shader@faceted@interp@stream
			\pgfplotslibrarysurfstreamend
			\pgfplotslibrarysurfdrawinpicture
		}%
		\if5\pgfplotsplothandlermesh@type
			% mesh/type=lattice
			\def\pgfplotsplothandlermesh@shader@faceted@interp@stream{%
				\expandafter\pgfplotsplothandlermesh@unpack@simple\pgfplotsplothandlermesh@im@jm
				\pgfplotsplothandlermesh@shader@interp{}%
				\expandafter\pgfplotsplothandlermesh@unpack@simple\pgfplotsplothandlermesh@im@j
				\pgfplotsplothandlermesh@shader@interp{}%
				\expandafter\pgfplotsplothandlermesh@unpack@simple\pgfplotsplothandlermesh@i@j
				\pgfplotsplothandlermesh@shader@interp{}%
				\expandafter\pgfplotsplothandlermesh@unpack@simple\pgfplotsplothandlermesh@i@jm
				\pgfplotsplothandlermesh@shader@interp{}%
			}%
		\else
			% mesh/type=triangle
			\def\pgfplotsplothandlermesh@shader@faceted@interp@stream{%
				\expandafter\pgfplotsplothandlermesh@unpack@simple\pgfplotsplothandlermesh@triangle@A
				\pgfplotsplothandlermesh@shader@interp{}%
				\expandafter\pgfplotsplothandlermesh@unpack@simple\pgfplotsplothandlermesh@triangle@B
				\pgfplotsplothandlermesh@shader@interp{}%
				\expandafter\pgfplotsplothandlermesh@unpack@simple\pgfplotsplothandlermesh@triangle@C
				\pgfplotsplothandlermesh@shader@interp{}%
			}%
		\fi
	\fi
