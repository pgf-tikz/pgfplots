...
%	\fi
	...
	\pgfplots@plot@data{%
		...
		%
		% Hm. It would be relatively cool if user interface like 'x
		% filter' could rely on standard floating point number
		% formats like 1e4 instead of 1Y1.0e4 ... but I fear
		% introducing it now will break old code... and might even
		% make disable the use of, say, \pgfmathfloatadd{#1}{...}.
		% Should I do it !?
		%
