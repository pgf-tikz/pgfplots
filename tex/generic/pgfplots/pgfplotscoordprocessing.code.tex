...
\def\pgfplotsplothandlermesh@draw@element@triangle@interp#1#2#3{%
	\expandafter\pgfplotsplothandlermesh@unpack@simple#1%
	\pgfplotsplothandlermesh@shader@interp{}%
	\expandafter\pgfplotsplothandlermesh@unpack@simple#2%
	\pgfplotsplothandlermesh@shader@interp{}%
	\expandafter\pgfplotsplothandlermesh@unpack@simple#3%
	\pgfplotsplothandlermesh@shader@interp{}%
}%
\def\pgfplotsplothandlermesh@draw@element@rectangle@interp#1#2#3#4{%
	...
	\expandafter\pgfplotsplothandlermesh@unpack@simple#3%
	\pgfplotsplothandlermesh@shader@interp{}%
	\expandafter\pgfplotsplothandlermesh@unpack@simple#4%
	\pgfplotsplothandlermesh@shader@interp{}%
}%
...
\def\pgfplotsplothandlermesh@unpack@zbuffer@pointdepth#1{%
	\expandafter\pgfplotsplothandlermesh@unpack@zbuffer@pointdepth@#1{#1}%
}%
\def\pgfplotsplothandlermesh@unpack@zbuffer@pointdepth@#1#2#3#4#5{%
	\def\pgfplotsretval{#4}%
	\def#5{{#1}{#2}{#3}}% eliminate the point depth from the macro. It will only confuse the other @unpack routines.
}%
...
\def\pgfplotsplothandlermesh@unpack@simple#1#2#3{%
	\global\pgf@x=#1\relax
	\global\pgf@y=#2\relax
	\def\pgfplots@current@point@meta{#3}%
}%
