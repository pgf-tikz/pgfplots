...
\long\def\pgfplots@addplotimpl@fillbetween@opt@#1#2#3#4{%
	\pgfkeysifdefined{/pgfplots/fill between/.@cmd}{%
		\pgfplotslibraryfillbetween@addplot{#1,#2}{#3}{#4}%
	}{%	
		\pgfplotsthrow{invalid argument}
		{\pgfplots@loc@TMPa}%
		{Please load \string\usepgfplotslibrary{fillbetween} in order to use `\string\addplot fill between'.}%
		\pgfeov
	}%
	%
	% this groups starts in \pgfplots@addplotimpl@plot@withoptions:
	\endgroup
}%
