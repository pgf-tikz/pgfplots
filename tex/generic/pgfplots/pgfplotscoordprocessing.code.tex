...
%\message{vertex (\pgfplotspatchvertexx,\pgfplotspatchvertexy[\pgfplotspatchvertexmeta]. ^^J}%
		...
		foreach cdata vertex=\pgfplotspatchclass{\pgfplotspatchclassname}{foreach vertex}{##1},
...
\pgfplotsdeclarepatchclass{triangle quadr}{%
	...
	fill path={%
		...
		\let\PB=\pgfplotspatchclass@qtri@B
		\let\PC=\pgfplotspatchclass@qtri@C
		\pgfplots@edge
		%
		\let\PA=\pgfplotspatchclass@qtri@C
		\let\PB=\pgfplotspatchclass@qtri@D
		\let\PC=\pgfplotspatchclass@qtri@E
		\pgfplots@edge
		%
		\let\PA=\pgfplotspatchclass@qtri@E
	...
	stream to shader={%
		...
		\def\pgfplots@coonsedge{%
			\ifx\PA\pgfplotspatchclass@qtri@A
			...
			\ifx\PC\pgfplotspatchclass@qtri@A
			\else
		...
		\if0\b@pgfplotsplothandlermesh@matrixoutput
			...
			\else
				\pgfplots@error{Sorry, (patch type=rectangle) and (rectangular patch shadings with more than one rectangle) is not supported (got \pgfkeysvalueof{/pgfplots/surf shading/cols} x * input points).
					It is supported if z buffer!=sort. Consider using 'patch to triangles' to combine it with z buffer=sort}%
			\fi
		\fi
	},
	triangulate={%
...
\pgfplotsdeclarepatchclass{bilinear}{%
	...
	stream to shader={%
		...
		\expandafter\pgfplotspatchvertex\pgfplotspatchclass@rect@A\endvertex
			\let\pgfplots@current@point@meta=\pgfplotspatchvertexmeta
			\pgfplotsaxisvisphasetransformpointmeta
		% POINT A
		\pgfplotslibrarysurfstreamcoord{%
		...
		\let\pgfplotspatchvertexxlast=\pgfplotspatchvertexx
		\let\pgfplotspatchvertexylast=\pgfplotspatchvertexy
		%
		% 
		\expandafter\pgfplotspatchvertex\pgfplotspatchclass@rect@B\endvertex
			\let\pgfplots@current@point@meta=\pgfplotspatchvertexmeta
			\pgfplotsaxisvisphasetransformpointmeta
		%
		% CONTROL POINT last+1/3(cur-last)
		\pgfplotslibrarysurfstreamcoord{%
			\pgfpointadd
				{\pgfqpointscale{0.6666666}{\pgfqpoint\pgfplotspatchvertexxlast\pgfplotspatchvertexylast}}%
				{\pgfqpointscale{0.3333333}{\pgfqpoint\pgfplotspatchvertexx\pgfplotspatchvertexy}}%
		}{}%
		% CONTROL POINT last+2/3(cur-last)
		\pgfplotslibrarysurfstreamcoord{%
			\pgfpointadd
				{\pgfqpointscale{0.3333333}{\pgfqpoint\pgfplotspatchvertexxlast\pgfplotspatchvertexylast}}%
				{\pgfqpointscale{0.6666666}{\pgfqpoint\pgfplotspatchvertexx\pgfplotspatchvertexy}}%
		}{}%
		%
		% POINT B
		\pgfplotslibrarysurfstreamcoord{%
		...
		%
		% 
		\expandafter\pgfplotspatchvertex\pgfplotspatchclass@rect@C\endvertex
			\let\pgfplots@current@point@meta=\pgfplotspatchvertexmeta
			\pgfplotsaxisvisphasetransformpointmeta
		%
		% CONTROL POINT last+1/3(cur-last)
		...
		%
		% 
		\expandafter\pgfplotspatchvertex\pgfplotspatchclass@rect@D\endvertex
			\let\pgfplots@current@point@meta=\pgfplotspatchvertexmeta
			\pgfplotsaxisvisphasetransformpointmeta
		%
		% CONTROL POINT last+1/3(cur-last)
...
\pgfplotsdeclarepatchclass{biquadratic}{%
	...
	stream to shader={%
		...
		% create a coons patch:
		\def\pgfplots@coonsedge{%
			\ifx\PA\pgfplotspatchclass@biquad@A
				\expandafter\pgfplotspatchvertex\PA\endvertex
					\let\pgfplots@current@point@meta=\pgfplotspatchvertexmeta
					\pgfplotsaxisvisphasetransformpointmeta
				\pgfplotslibrarysurfstreamcoord{\pgfqpoint\pgfplotspatchvertexx\pgfplotspatchvertexy}{\pgfplotspointmetatransformed}%
			...
			\ifx\PC\pgfplotspatchclass@biquad@A
			\else
				\expandafter\pgfplotspatchvertex\PC\endvertex
					\let\pgfplots@current@point@meta=\pgfplotspatchvertexmeta
					\pgfplotsaxisvisphasetransformpointmeta
...
\def\pgfplotspatchready{\pgfplotsplothandlermesh@PIPE@CHECKJUMP}%
