...
\def\pgfplotspatchclass#1#2{%
	\pgfutil@ifundefined{pgfpptch@#1@#2}{%
		\pgfutil@ifundefined{pgfpptch@#1@}{%
			\pgfplots@error{INTERNAL LOGIC ERROR: the patch class '#1' is not defined}%
		}{%
			\pgfplots@error{INTERNAL LOGIC ERROR: the patch class '#1' has no method '#2'}%
		}%
	}{%
...
\pgfqkeys{/pgfplots/@declare patch}{%
	...
	%
	init shader/.code=
		{\expandafter\def\csname pgfpptch\pgfplotsdeclarepatchclass@ init shader\endcsname{#1}},%
...
\pgfplotsdeclarepatchclass{line}{%
	allow matrix=0,
	new=\def\pgfplotsplothandlermesh@vertex@no{0},
	set next vertex={%
		\if0\pgfplotsplothandlermesh@vertex@no\relax
			\edef\pgfplotsplothandlermesh@vertex@A{#1}%
			\def\pgfplotsplothandlermesh@vertex@no{1}%
		\else
			\edef\pgfplotsplothandlermesh@vertex@B{#1}%
			\def\pgfplotsplothandlermesh@vertex@no{0}%
			\pgfplotspatchready%
		\fi
	},
	first vertex=\expandafter\pgfplotspatchvertex\pgfplotsplothandlermesh@vertex@A\endvertex,
	foreach vertex={%
		\expandafter\pgfplotspatchvertex\pgfplotsplothandlermesh@vertex@A\endvertex #1%
		\expandafter\pgfplotspatchvertex\pgfplotsplothandlermesh@vertex@B\endvertex #1%
	},
	fill path={%
		\pgfpathmoveto{\expandafter\pgfplotspointpatchvertex\pgfplotsplothandlermesh@vertex@A\endvertex}%
		\pgfpathlineto{\expandafter\pgfplotspointpatchvertex\pgfplotsplothandlermesh@vertex@B\endvertex}%
	},
	get num vertices=2,
...
\pgfplotsdeclarepatchclass{triangle}{%
	...
	new=\def\pgfplotsplothandlermesh@vertex@no{0},
	set next vertex={%
		\ifcase\pgfplotsplothandlermesh@vertex@no\relax
			\edef\pgfplotsplothandlermesh@vertex@A{#1}%
			\def\pgfplotsplothandlermesh@vertex@no{1}%
		\or
			\edef\pgfplotsplothandlermesh@vertex@B{#1}%
			\def\pgfplotsplothandlermesh@vertex@no{2}%
		\or
			\edef\pgfplotsplothandlermesh@vertex@C{#1}%
			\def\pgfplotsplothandlermesh@vertex@no{0}%
			\pgfplotspatchready%
		\fi
	},
	...
	foreach vertex={%
		\expandafter\pgfplotspatchvertex\pgfplotsplothandlermesh@vertex@A\endvertex #1%
		\expandafter\pgfplotspatchvertex\pgfplotsplothandlermesh@vertex@B\endvertex #1%
		\expandafter\pgfplotspatchvertex\pgfplotsplothandlermesh@vertex@C\endvertex #1%
	},
	fill path={%
		\pgfpathmoveto{\expandafter\pgfplotspointpatchvertex\pgfplotsplothandlermesh@vertex@A\endvertex}%
		\pgfpathlineto{\expandafter\pgfplotspointpatchvertex\pgfplotsplothandlermesh@vertex@B\endvertex}%
		\pgfpathlineto{\expandafter\pgfplotspointpatchvertex\pgfplotsplothandlermesh@vertex@C\endvertex}%
		\pgfpathclose
	},
...
\pgfplotsdeclarepatchclass{rectangle}{%
	...
	set next vertex={%
		...
		\or
			\edef\pgfplotsplothandlermesh@vertex@C{#1}%
			\def\pgfplotsplothandlermesh@vertex@no{3}%
		\or
			\edef\pgfplotsplothandlermesh@vertex@D{#1}%
			\def\pgfplotsplothandlermesh@vertex@no{0}%
			\pgfplotspatchready%
		\fi
	},
	...
	foreach vertex={%
		...
		\expandafter\pgfplotspatchvertex\pgfplotsplothandlermesh@vertex@B\endvertex #1%
		\expandafter\pgfplotspatchvertex\pgfplotsplothandlermesh@vertex@C\endvertex #1%
		\expandafter\pgfplotspatchvertex\pgfplotsplothandlermesh@vertex@D\endvertex #1%
	},
	stream to shader={%
		...
		\expandafter\pgfplotspatchvertex\pgfplotsplothandlermesh@vertex@A\endvertex\pgfplots@foreachvertex@@%
		\expandafter\pgfplotspatchvertex\pgfplotsplothandlermesh@vertex@B\endvertex\pgfplots@foreachvertex@@%
		\expandafter\pgfplotspatchvertex\pgfplotsplothandlermesh@vertex@D\endvertex\pgfplots@foreachvertex@@% EXCHANGED SEQUENCE
		\expandafter\pgfplotspatchvertex\pgfplotsplothandlermesh@vertex@C\endvertex\pgfplots@foreachvertex@@%
	},%
	fill path={%
		\pgfpathmoveto{\expandafter\pgfplotspointpatchvertex\pgfplotsplothandlermesh@vertex@A\endvertex}%
		\pgfpathlineto{\expandafter\pgfplotspointpatchvertex\pgfplotsplothandlermesh@vertex@B\endvertex}%
		\pgfpathlineto{\expandafter\pgfplotspointpatchvertex\pgfplotsplothandlermesh@vertex@C\endvertex}%
		\pgfpathlineto{\expandafter\pgfplotspointpatchvertex\pgfplotsplothandlermesh@vertex@D\endvertex}%
		\pgfpathclose
	},
	init shader={%
		\if0\b@pgfplotsplothandlermesh@matrixoutput
			\pgfplots@error{Sorry, (patch type=rectangle) and (direct matrix format for shading) is not supported.
				Consider using 'refine()' before doing so.}%
		\fi
	},
...
%		\scope
		...
		\else
			...
			\def\b@pgfplotsplothandlermesh@matrixoutput{0}%
		\fi
		\pgfplotspatchclass{\pgfplotsplothandlermesh@patchclass}{get pdf shading type}%
		\if4\pgfplotsretval
		\else
			\if5\pgfplotsretval
			\else
...
\let\pgfplotsplothandlermesh@VISUALIZE@std=\pgfplotsplothandlermesh@VISUALIZE
...
\def\pgfplotsplothandlermesh@patchtable@init{%
	...
	\let\pgfplotsplothandlermesh@patchtable@numverts
	\c@pgf@countb=0
	\pgfutil@loop
	...
	\ifnum\pgfplotsplothandlermesh@shader>1
		...
		\if2\pgfplotsplothandlermesh@shader
			...
			\iffalse% FIXME : is this special handling necessary!?
				...
				\fi
			\fi
			\pgfplotspatchclass{\pgfplotsplothandlermesh@patchclass}{init shader}%
			\pgfplotslibrarysurfstreamstart
		\else
...
\def\pgfplotsplothandlermesh@check@unbounded@text{-16000.0}%
...
\def\pgfplotsplothandlermesh@PIPE@DECODE@matrix@ONEDIMMODE#1{%
	...
	\ifnum\c@pgfplots@scanlineindex>0
		\expandafter\pgfplotsplothandlermesh@PIPE@DECODE@matrix@\expandafter{\pgfplotsplothandlermesh@im}%
		\expandafter\pgfplotsplothandlermesh@PIPE@DECODE@matrix@\expandafter{\pgfplotsplothandlermesh@i}%
	\else
		\advance\c@pgfplots@scanlineindex by1
	\fi
...
%\message{##\the\c@pgfplots@scanlineindex: prepare rectangle with corner \meaning\pgfplotsplothandlermesh@i@j.}%
	...
	\ifnum\c@pgfplots@scanlineindex>0
		\expandafter\pgfplotsplothandlermesh@PIPE@DECODE@matrix@\expandafter{\pgfplotsplothandlermesh@im@jm}%
		\expandafter\pgfplotsplothandlermesh@PIPE@DECODE@matrix@\expandafter{\pgfplotsplothandlermesh@im@j}%
		\expandafter\pgfplotsplothandlermesh@PIPE@DECODE@matrix@\expandafter{\pgfplotsplothandlermesh@i@j}%
		\expandafter\pgfplotsplothandlermesh@PIPE@DECODE@matrix@\expandafter{\pgfplotsplothandlermesh@i@jm}%
	\fi
