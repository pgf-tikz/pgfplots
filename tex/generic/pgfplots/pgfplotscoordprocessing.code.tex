...
\def\pgfplotspointviewdir{%
	\pgfplotspointfromcsvvector\pgfplots@view@dir@threedim{default}%
}%
...
\def\pgfplots@rescale@view@dir{%
	\expandafter\ifx\csname pgfplots@view@dir@threedim\endcsname\relax
	\else
		\pgfplotsmathvectorscaleindividually{\pgfplots@view@dir@threedim}{\pgfplots@x@inverseveclength,\pgfplots@y@inverseveclength,\pgfplots@z@inverseveclength}{default}%
		\let\pgfplots@view@dir@threedim=\pgfplotsretval
	\fi
}%
...
%\message{plot at time (#1, segment \pgfplots@pos@segment): total length=\pgfplots@len@total; target len \pgfplots@len@thresh\space (#1)^^J}%
	...
	\pgfplotsplothandlerpointtokeys{/data point/pos \tikz@time}%
...
\def\pgfplotsmathfloatviewdepthxyz@infigure#1#2#3{%
	\pgfplotsmathvectorscalarproduct{#1,#2,#3}{\pgfplots@view@dir@threedim}{float}% FIXME : \pgfplots@view@dir@threedim might have a different math format!
...
\def\pgfplotsmathviewdepthxyz@infigure#1#2#3{%
	\pgfplotsmathvectorscalarproduct{#1,#2,#3}{\pgfplots@view@dir@threedim}{pgfbasic}% FIXME : \pgfplots@view@dir@threedim might have a different math format!
	\let\pgfmathresult=\pgfplotsretval
}%
