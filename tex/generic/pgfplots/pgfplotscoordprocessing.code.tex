...
% \message{LUA backend: got \pgfplots@loc@TMPa^^J}%
	...
	%
	%
	\pgfkeysgetvalue{/pgfplots/@xmin}\pgfplots@loc@TMPb\global\let\pgfplots@xmin=\pgfplots@loc@TMPb
	\pgfkeysgetvalue{/pgfplots/@xmax}\pgfplots@loc@TMPb\global\let\pgfplots@xmax=\pgfplots@loc@TMPb
	\pgfkeysgetvalue{/pgfplots/@ymin}\pgfplots@loc@TMPb\global\let\pgfplots@ymin=\pgfplots@loc@TMPb
	\pgfkeysgetvalue{/pgfplots/@ymax}\pgfplots@loc@TMPb\global\let\pgfplots@ymax=\pgfplots@loc@TMPb
	\ifpgfplots@threedim
		\pgfkeysgetvalue{/pgfplots/@zmin}\pgfplots@loc@TMPb\global\let\pgfplots@zmin=\pgfplots@loc@TMPb
		\pgfkeysgetvalue{/pgfplots/@zmax}\pgfplots@loc@TMPb\global\let\pgfplots@zmax=\pgfplots@loc@TMPb
	\fi
	\pgfkeysgetvalue{/pgfplots/point meta min}\pgfplots@loc@TMPb\global\let\pgfplots@metamin=\pgfplots@loc@TMPb
	\pgfkeysgetvalue{/pgfplots/point meta max}\pgfplots@loc@TMPb\global\let\pgfplots@metamax=\pgfplots@loc@TMPb
	%
