...
%\message{NO cache hit for \string\pgfplotspointplotattime{#1}^^J}%
		...
		%
		\let\pgfplotspointattime@do=\pgfplotspointattime@do@set@current@value
...
\def\pgfplotspointattime@do@find@target@value{%
	...
	%FIXME : what is/was this line supposed to do!?
	%\pgfplotsplothandlerserializepointto{\pgfplots@cur}%
}%
...
%\message{HIT between \pgfplots@len@last\space and \pgfplotspointattime@value@current\space (\pgfplots@time@between@two)^^J}%
	\ifx\pgfplots@last@processed\pgfutil@empty
		\pgfplotsplothandlerserializepointto{\pgfplots@cur}%
	\else
