	...
	\ifpgfplots@loop@CONTINUE
		...
		\ifpgfplots@errorbars@enabled
			\ifx\addplot@tbl@error@x\pgfutil@empty
				\let\pgfplots@current@point@error@x@plus=\pgfutil@empty
			\else
				\pgfplotslistpopfront\addplot@tbl@error@x\to\pgfplots@current@point@error@x@plus
			\fi
			\ifx\addplot@tbl@error@y\pgfutil@empty
				\let\pgfplots@current@point@error@y@plus=\pgfutil@empty
			\else
				\pgfplotslistpopfront\addplot@tbl@error@y\to\pgfplots@current@point@error@y@plus
			\fi
			\ifx\addplot@tbl@error@z\pgfutil@empty
				\let\pgfplots@current@point@error@z@plus=\pgfutil@empty
			\else
				\pgfplotslistpopfront\addplot@tbl@error@z\to\pgfplots@current@point@error@z@plus
			\fi
			\let\pgfplots@current@point@error@x@minus=\pgfplots@current@point@error@x@plus
			\let\pgfplots@current@point@error@y@minus=\pgfplots@current@point@error@y@plus
			\let\pgfplots@current@point@error@z@minus=\pgfplots@current@point@error@z@plus
