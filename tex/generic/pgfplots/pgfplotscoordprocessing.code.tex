...
\pgfplotsdeclarepointmetasource{explicit}{%
	...
	explicitinput=1,%
	LUA class=pgfplots.ExplicitPointMetaHandler(),
}%
...
\def\pgfplots@LUA@survey@start{%
	\ifpgfplots@LUA@backend@supported
		\ifx\pgfplotsplothandlerLUAname\pgfutil@empty
		...
		\ifpgfplots@LUA@backend@supported
			...
			\pgfplots@log3{Activating LUA backend for plot \the\pgfplots@numplots\space (type '\pgfplotsplothandlername').}%
			\directlua{%
			do^^J%
				...
				local plothandler = \pgfplotsplothandlerLUAname(gca, \pgfplots@loc@TMPa);^^J%
				...
				gca.plothandlers[\the\pgfplots@numplots] = plothandler;^^J%
...
\def\pgfplots@LUA@survey@end{%
	\edef\pgfplots@loc@TMPa{%
		\directlua{
			tex.print(pgfplots.gca:surveyToPgfplots(pgfplots.gca.currentPlotHandler, true));
			pgfplots.gca.currentPlotHandler=nil
		}%
	}%
	...
	\ifpgfplots@LUA@backend@supported
		...
		\ifpgfplots@LUA@backend@supported
			...
			\if1\pgfplots@loc@TMPa
				\pgfplots@log3{Activating partial LUA backend for visualization of plot \plotnum.}%
			\else
				\pgfplots@LUA@backend@supportedfalse
			\fi
		\fi
