...
\pgfkeysdef{/pgfplots/plot graphics/@prepare legend}{%
	...
	\edef\pgfplots@loc@TMPa{%
		\noexpand\pgfkeys{/pgfplots/every legend image post/.append code={%
				\noexpand\pgfplotsplothandlergraphics@prepare@legend@style
				\ifx\tikz@plot@mark\pgfutil@empty
				\else
...
\def\pgfplotsplothandlergraphics@prepare@legend@style{%
	\pgfplots@getcurrent@plothandler\pgfplots@basiclevel@plothandler
	\ifx\pgfplots@basiclevel@plothandler\pgfplotsplothandlergraphics
		\tikzset{sharp plot}%
	\fi
}
