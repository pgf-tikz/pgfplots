...
\def\pgfplots@addplotimpl@table@fromfile@listener@witherrors@COLLECTHIGHLEVEL@prepare{%
	...
	\def\pgfplots@dereferencepointer@and@ASSIGN@error@x{%
		\pgfplotstablereadevalptr\pgfplots@table@ERRPTR@x\pgfplots@current@point@error@x@plus
		\let\pgfplots@current@point@error@x@minus=\pgfplots@current@point@error@x@plus
	}%
	\def\pgfplots@dereferencepointer@and@ASSIGN@error@y{%
		\pgfplotstablereadevalptr\pgfplots@table@ERRPTR@y\pgfplots@current@point@error@y@plus
		\let\pgfplots@current@point@error@y@minus=\pgfplots@current@point@error@y@plus
	}%
	\def\pgfplots@dereferencepointer@and@ASSIGN@error@z{%
		\pgfplotstablereadevalptr\pgfplots@table@ERRPTR@z\pgfplots@current@point@error@z@plus
		\let\pgfplots@current@point@error@z@minus=\pgfplots@current@point@error@z@plus
	}%
	%
	...
	\ifpgfplots@curplot@threedim
		...
		\else
			\def\pgfplots@dereferencepointer@and@ASSIGN@error@z{%
				...
				\let\pgfplots@current@point@error@z@plus=\pgfmathresult
				\let\pgfplots@current@point@error@z@minus=\pgfplots@current@point@error@z@plus
			}%
		\fi
		%
...
\def\pgfplots@addplotimpl@table@fromfile@listener@witherrors@COLLECTHIGHLEVEL{%
	...
	\ifpgfplots@curplot@threedim
		...
		%\edef\pgfplots@current@point{(\pgfplots@current@point@x,\pgfplots@current@point@y,\pgfplots@current@point@z)+-(\pgfplots@current@point@error@x,\pgfplots@current@point@error@y,\pgfplots@current@point@error@z) [\pgfplots@current@point@meta]}%
	%\else
		%\edef\pgfplots@current@point{(\pgfplots@current@point@x,\pgfplots@current@point@y)+-(\pgfplots@current@point@error@x,\pgfplots@current@point@error@y) [\pgfplots@current@point@meta]}%
	\fi
	\pgfplots@coord@stream@coord
