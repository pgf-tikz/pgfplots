...
\def\pgfplotsplothandlermesh@collecttriangle#1{%
	...
	\ifcase\c@pgfplots@scanlineindex
		\edef\pgfplotsplothandlermesh@triangle@A{{\the\pgf@x}{\the\pgf@y}{\pgfplots@current@point@meta}}%
		\c@pgfplots@scanlineindex=1
	\or
		\edef\pgfplotsplothandlermesh@triangle@B{{\the\pgf@x}{\the\pgf@y}{\pgfplots@current@point@meta}}%
		\c@pgfplots@scanlineindex=2
	\or
		\edef\pgfplotsplothandlermesh@triangle@C{{\the\pgf@x}{\the\pgf@y}{\pgfplots@current@point@meta}}%
		\c@pgfplots@scanlineindex=0
		\pgfplotsplothandlermesh@process@element
	\fi
}%
