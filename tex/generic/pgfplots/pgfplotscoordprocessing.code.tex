...
\pgfusepath{fill}%
		...
		\if0\pgfplots@is@the@same@point
			\pgfplots@warning{Plot graphics: sorry, I failed to provide the correct scale for the axis. The points '(\pgfplots@plot@handler@graphics@pointmap@A@logical)' and '(\pgfplots@plot@handler@graphics@pointmap@B@logical)' are correct, but the point '(\pgfplots@plot@handler@graphics@pointmap@C@logical)' is wrong (its position vector has an error of (\the\pgf@x,\the\pgf@y)).}%
		\fi
\pgfpathcircle{\pgfplots@plot@handler@graphics@pointmap@C@canvas}{5pt}%
\pgfusepath{fill}%
	\fi
	\endgroup
}%
