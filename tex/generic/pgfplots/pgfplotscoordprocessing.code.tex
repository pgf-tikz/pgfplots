...
\def\pgfplots@PREPARE@COORD@STREAM@start@{%
	...
	\if\pgfplots@perpointmeta@choice0%
		\pgfplots@loc@tmpfalse
	\else
		\if\b@pgfplots@perpointmeta@issymbolic1%
			\pgfplots@loc@tmpfalse
		\fi
	\fi
	...
	\else
		...
		\xdef\pgfplots@glob@TMPa{%
			...
			{% precommand(s):
				...
				\noexpand\def\noexpand\b@pgfplots@perpointmeta@issymbolic{\b@pgfplots@perpointmeta@issymbolic}%
			}%
			{% draw command:
				\noexpand\draw%
			}%
...
\long\def\pgfplots@addplotimpl@expression@#1#2#3#4#5{%
	\pgfplots@start@plot@with@behavioroptions{#1,#2,/pgfplots/mesh/ordering/x varies}%
...
\def\pgfplots@addplotimpl@function@opt@#1#2#3#4#5{%
	\pgfplots@start@plot@with@behavioroptions{#1,#2,#3,/pgfplots/mesh/ordering/x varies}%
	%
