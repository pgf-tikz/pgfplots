...
\pgfplotsdeclarecoordmath{float}{%
	...
	datascaletrafo={%
		...
		\pgfmathfloattofixed\pgfmathresult
		\expandafter\pgfmathsubtract@\expandafter{\pgfmathresult}{\csname pgfplots@data@scale@trafo@SHIFT@\pgfplotscoordmathid\endcsname}%
	},%
	...
	datascaletrafo undo shift=
		\pgfmathsubtract@{#1}{\csname pgfplots@data@scale@trafo@SHIFT@\pgfplotscoordmathid\endcsname},%
	datascaletrafo redo shift=\pgfmathadd@{#1}{\csname pgfplots@data@scale@trafo@SHIFT@\pgfplotscoordmathid\endcsname},%
...
\def\pgfplotscoordmath@float@datascaletrafo@inverse#1{%
	\pgfmathadd@{#1}{\csname pgfplots@data@scale@trafo@SHIFT@\pgfplotscoordmathid\endcsname}%
...
\def\pgfplotssetcoordmathfor#1#2{%
	\pgfutil@ifundefined{pgfpmth@#2@parsenumber}{%
...
\def\pgfplotsaxisdatapointsurveyed@remember@firstlast{%
	...
	\xdef\pgfplotsaxisdatapointsurveyed{%
		\E\ifpgfplotsaxisparsecoordinateok
			...
			\ifpgfplots@collect@firstplot@astick
				...
				\fi
			\fi
			\E\pgfplotsaxisdatapointsurveyed@remember@firstlast
