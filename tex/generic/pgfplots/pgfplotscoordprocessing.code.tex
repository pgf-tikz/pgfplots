...
\def\pgfplotsplothandlergraphicspointmapcomputerequiredview{%
	...
	\else
		...
		\else
			...
			\else
				\immediate\write-1{PGFPlots plot graphics[auto adjust axis=true]\csname on@line\endcsname: using '\pgfplotsretval'.^^J}% 
			\fi
			%
			\pgfkeysgetvalue{/pgfplots/plot graphics/debug}\pgfplots@loc@TMPa
			\def\pgfplots@loc@TMPb{true}%
			\ifx\pgfplots@loc@TMPa\pgfplots@loc@TMPb
				\pgfplotsplothandlergraphicspointmapcomputerequiredview@output
			\fi
			%
		\fi
	\fi
...
\def\pgfplotsplothandlergraphicspointmapcomputerequiredview@output{%
