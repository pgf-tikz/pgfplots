...
\def\pgfplots@plot@handler@graphics@finish{%
	\pgfkeysgetvalue{/pgfplots/plot graphics/pointmap}\pgfplots@plot@handler@graphics@pointmap
...
\def\pgfplots@plot@handler@graphics@process@pointmap{%
	...
	\pgfmath@basic@divide@{\pgfplots@Ax}{\pgfplots@DDx}%
	\pgfmath@basic@multiply@{\pgfmathresult}{\pgfplots@ddx}%
	\let\pgfplots@vx=\pgfmathresult
	%
	\pgfmath@basic@divide@{\pgfplots@Ay}{\pgfplots@DDy}%
	\pgfmath@basic@multiply@{\pgfmathresult}{\pgfplots@ddy}%
	...
	\pgfmath@basic@multiply@{\pgfmathresult}{\pgfplots@W}%
	\let\pgfplots@w=\pgfmathresult
	%
	\pgfmath@basic@divide@{\pgfplots@ddy}{\pgfplots@DDy}%
	\pgfmath@basic@multiply@{\pgfmathresult}{\pgfplots@H}%
	...
	\pgf@x=\pgfplots@ax pt \advance\pgf@x by -\pgfplots@vx pt
	\pgf@y=\pgfplots@ay pt \advance\pgf@y by -\pgfplots@vy pt
	\pgftransformshift{}%
