...
\def\pgfplotsdeclarecoordmath#1#2{%
	...
	\pgfqkeys{/pgfplots/@declare coord math}{%
		...
		log e=		\pgfmathlog@{##1},%
		log to display log=\pgfmathmultiply@{##1}{2.3025851},% * log(10)
		log from display log=\pgfmathmultiply@{##1}{0.434294},% / log(10)
		log unsigned int={%
			\edef\pgfmathresult{%
				\ifcase##1
				\or0
		...
		log set basis=\pgfplotscoordmath@log@set@basis{##1},
...
\pgfqkeys{/pgfplots/@declare coord math}{%
	...
	%
	% applies the natural logarithm. If the result is empty, it is not defined.
	%
	...
	%
	% The log basis can be set with 'log set basis'
	log/.code=
	...
	log set basis/.code=
		{\expandafter\def\csname pgfpmth\pgfplotsdeclarecoordmath@ log set basis\endcsname##1{#1}},%
	%
...
% shared implementation for 'log set basis' It works for every
% subclass.
\def\pgfplotscoordmath@log@set@basis#1{%
	...
	%
	\expandafter\edef\csname pgfpmth@\pgfplotscoordmath @log\endcsname##1{%
...
\def\pgfplotscoordmath@def@log@to@log@ten#1#2{%
	...
	\ifx\pgfplots@loc@TMPa\pgfutil@empty
		\expandafter\edef\csname pgfpmth@#1@log to log 10\endcsname##1{%
			\noexpand\pgfplotscoordmath{#1}{op}{multiply}{{##1}{\pgfmathresult}}%
		}%
	\else
