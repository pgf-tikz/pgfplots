	...
	\else
		...
		\else
			...
			\ifpgfplots@loop@CONTINUE
				...
				\fi
				\ifpgfplots@loop@CONTINUE
		\pgfplotscoordmath{default}{parsenumber}{1}\let\pgfplots@scale=\pgfmathresult
			...
			\else
				...
				\immediate\write
					...
					{PGFPlots plot graphics[auto adjust axis=true] {\the\t@pgfplots@tokc} \csname on@line\endcsname: using '\pgfplotsretval'. 
					\if1\pgfplotsplothandlergraphicspointmapcomputerequiredview@debug
...
%
\message{plot graphics: ^^J
	anchor pt = \pgfplots@plot@handler@graphics@pointmap@A@logical\space (img \pgfplots@plot@handler@graphics@pointmap@A@img; canvas \pgfplots@plot@handler@graphics@pointmap@A@canvas)^^J
	lower left canvas = \pgfplots@plot@handler@graphics@pointmap@lowerleft@canvas^^J
	__________________  (v = \pgfplots@vx,\pgfplots@vy)^^J
	W=\pgfplots@w; H = \pgfplots@h^^J%
}%
	%
	%
	\begingroup
