...
\message{getv(#1#2#3) = \meaning\pgfplotsretval}%
}%
		...
		\if\pgfplotsplothandlermesh@zbuffer@choice4%
			...
			\if5\pgfplotsplothandlermesh@type
				...
				\def\pgfplotsplothandlermesh@process@element{%
					...
					\expandafter\pgfplotsplothandlermesh@unpack@zbuffer@pointdepth\pgfplotsplothandlermesh@im@jm
					\let\pgfmathresult\pgfplotsretval
					\expandafter\pgfplotsplothandlermesh@unpack@zbuffer@pointdepth\pgfplotsplothandlermesh@im@j
					\pgfplotsmathmin\pgfplotsretval\pgfmathresult
					\expandafter\pgfplotsplothandlermesh@unpack@zbuffer@pointdepth\pgfplotsplothandlermesh@i@j
					\pgfplotsmathmin\pgfplotsretval\pgfmathresult
					\expandafter\pgfplotsplothandlermesh@unpack@zbuffer@pointdepth\pgfplotsplothandlermesh@i@jm
					\pgfplotsmathmin\pgfplotsretval\pgfmathresult
					%
					% assemble array element:
					\edef\pgfplots@loc@TMPa{%
			...
			\else
\message{------------------------------> PREPAREING Z BUFFER FOR TRINAGLE PATCH PLOT}%
				% mesh/type=triangle
				\def\pgfplotsplothandlermesh@process@element{%
					% compute DEPTH(triangle element):= min{DEPTH(A),DEPTH(B),DEPTH(C)}
					\expandafter\pgfplotsplothandlermesh@unpack@zbuffer@pointdepth\pgfplotsplothandlermesh@triangle@A
					\let\pgfmathresult\pgfplotsretval
					\expandafter\pgfplotsplothandlermesh@unpack@zbuffer@pointdepth\pgfplotsplothandlermesh@triangle@B
					\pgfplotsmathmin\pgfplotsretval\pgfmathresult
					\expandafter\pgfplotsplothandlermesh@unpack@zbuffer@pointdepth\pgfplotsplothandlermesh@triangle@C
					\pgfplotsmathmin\pgfplotsretval\pgfmathresult
					%
					% assemble array element:
					\edef\pgfplots@loc@TMPa{%
...
\def\pgfplotsplothandlermesh@init@mesh@stream{%
	...
	\if5\pgfplotsplothandlermesh@type
		...
		\if2\pgfplotsplothandlermesh@shader
			% shader=interp :
			% \pgf@plotstreampoint has already been initialised.
		\else
