...
\def\pgfplotsplothandlergraphicspointmapcomputerequiredview{%
	...
	\else
		...
		\else
			...
			%
			\ifpgfplots@loop@CONTINUE
				\pgfplotscoordmath{default}{op}{divide}{{\pgfplotsxlen}{\pgfplotszlen}}%
				\pgfplotscoordmath{default}{tofixed}{\pgfmathresult}%
				\let\pgfplotsxlenratio=\pgfmathresult
				\pgfplotscoordmath{default}{op}{divide}{{\pgfplotsylen}{\pgfplotszlen}}%
				\pgfplotscoordmath{default}{tofixed}{\pgfmathresult}%
				...
				\fi
				\ifpgfplots@loop@CONTINUE
					\edef\pgfplotsretval{unit vector ratio={\pgfplotsxlenratio\space\pgfplotsylenratio\space1}}%
				\fi
			\fi
			%
			\ifx\pgfplotsretval\pgfutil@empty
