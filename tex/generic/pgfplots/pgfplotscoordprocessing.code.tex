...
\def\pgfplotscoordmath@def@log@to@log@ten#1#2{%
	...
	\fi
	\expandafter\edef\csname pgfpmth@#1@tmpl@log to log 10\endcsname##1{%
...
%		\scope
		...
		\pgfplotspatchclass{\pgfplotsplothandlermesh@type}{allow matrix}%
		\if0\pgfplotsretval
			\def\b@pgfplotsplothandlermesh@matrixoutput{0}%
		\fi
		\ifnum\pgfkeysvalueof{/pgfplots/mesh/refines}>0
			\def\b@pgfplotsplothandlermesh@matrixoutput{0}%
		\fi
...
\def\pgfplotsplothandlermesh@stream#1{%
	\let\pgfplotsplothandlermesh@type=\pgfplotsplothandlermesh@type@input
	\pgfplotsplothandlermesh@DECODE{#1}\then\pgfplotsplothandlermesh@CHECKJUMP%
}%
\def\pgfplotsplothandlermesh@CHECKJUMP{%
	\pgfplots@loc@tmptrue
	\pgfplotspatchclass{\pgfplotsplothandlermesh@type}{foreach vertex}{%
		\pgfplotsplothandlermesh@check@unbounded{##1}%
	}%
	\ifpgfplots@loc@tmp
		\pgfplotsplothandlermesh@REFINE\then\pgfplotsplothandlermesh@FINISH
	\fi
}%
\def\pgfplotsplothandlermesh@REFINE\then#1{%
	#1%
}%
...
\def\pgfplotspatchclass#1#2{%
	\def\pgfplotsretval{1}% placeholder
}%
