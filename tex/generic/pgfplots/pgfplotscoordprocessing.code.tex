...
\def\pgfplots@LUA@survey@start{%
	\ifpgfplots@LUA@backend@supported
		...
		\ifpgfplots@LUA@backend@supported
			...
			\pgfplots@log3{luabackend=true: Activating LUA backend for plot \the\pgfplots@numplots\space (type '\pgfplotsplothandlername').}%
...
\long\def\pgfplots@addplotimpl@expression@@#1#2#3{%
	...
	%
	\ifpgfplots@LUA@backend@supported
		\pgfplots@log3{luabackend=true: Activating LUA version of plot expression for plot \the\pgfplots@numplots\space (type '\pgfplotsplothandlername').}%
		...
		\if0\pgfplotsretval
			\pgfplots@log3{luabackend=true: LUA version of plot expression failed. Using TeX version. (plot \the\pgfplots@numplots).}%
	...
	\ifpgfplots@LUA@backend@supported
		...
		\ifpgfplots@LUA@backend@supported
			...
			\if1\pgfplots@loc@TMPa
				\pgfplots@log3{luabackend=true: Activating partial LUA backend for visualization of plot \plotnum.}%
			\else
				\pgfplots@LUA@backend@supportedfalse
			\fi
		\fi
