...
\pgfkeys{%
    ...
    % 
    /pgfplots/unit code/.initial={\mathrm},%
...
%
\def\pgfplots@label@units@@#1{%
    \pgfkeysgetvalue{/pgfplots/unit code}{\pgfplots@loc@TMPa}%
    ...
    \else%
      \ifx\pgfplots@loc@TMPb\pgfutil@empty%
        \pgfkeyssetvalue{/pgfplots/unit marking code}{\pgfkeysvalueof{/pgfplots/#1\space unit}}%
        \edef\pgfplots@loc@TMPa{\pgfplots@units@marking@pre%
            \expandafter\noexpand\pgfplots@loc@TMPa{\pgfplots@loc@TMPc}%
            \pgfplots@units@marking@post}%
      \else%
        \pgfkeyssetvalue{/pgfplots/unit marking code}{\pgfkeysvalueof{/pgfplots/#1\space unit prefix}\pgfkeysvalueof{/pgfplots/#1\space unit}}%
        \edef\pgfplots@loc@TMPa{\pgfplots@units@marking@pre%
            \expandafter\noexpand\pgfplots@loc@TMPa{\pgfplots@loc@TMPb\pgfplots@loc@TMPc}%
            \pgfplots@units@marking@post}%
      \fi%
      $\pgfplots@loc@TMPa$%
    \fi%
