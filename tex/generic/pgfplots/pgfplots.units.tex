...
% unit prefix to "k".
% FIXME Adding other basis systems than SI. Perhaps addition of CGS units.
...
\pgfkeys{%
    ...
    /pgfplots/use units/.initial=false,%
    %
    ...
    % 
    /pgfplots/unit marking pre/.default={[},%
    /pgfplots/unit marking post/.default={]},%
    /pgfplots/unit markings/.is choice,%
    /pgfplots/unit markings/parenthesis/.style={/pgfplots/unit marking pre={(},/pgfplots/unit marking post={)}},%
    /pgfplots/unit markings/square braces/.style={/pgfplots/unit marking pre={[},/pgfplots/unit marking post={]}},%
    /pgfplots/unit markings/curly braces/.style={/pgfplots/unit marking pre={\{},/pgfplots/unit marking post={\}}},%
    /pgfplots/unit marking code/.code={\mathrm{##1##2}},%
%    /pgfplots/unit markings/bracket/.style={/pgfplots/unit marking pre={$\lbrace$},/pgfplots/unit marking post={$\rbrace$}},%
...
% The code to make the label with units
...
\def\pgfplots@label@units@@#1{%
    ...
    \else%
      \ifx\pgfplots@loc@TMPb\pgfutil@empty%
        \edef\pgfplots@loc@TMPa{\pgfkeysvalueof{/pgfplots/unit marking pre}%
            \pgfkeys{/pgfplots/unit marking code={\pgfkeysvalueof{/pgfplots/#1\space unit}}}\pgfkeysvalueof{/pgfplots/unit marking post}}%
      \else%
        \edef\pgfplots@loc@TMPa{\pgfkeysvalueof{/pgfplots/unit marking pre}%
              \pgfkeys{/pgfplots/unit marking code={\pgfkeysvalueof{/pgfplots/#1\space unit prefix}\pgfkeysvalueof{/pgfplots/#1\space unit}}}\pgfkeysvalueof{/pgfplots/unit marking post}}%
      \fi%
      $\pgfplots@loc@TMPa$%
    \fi%
}
