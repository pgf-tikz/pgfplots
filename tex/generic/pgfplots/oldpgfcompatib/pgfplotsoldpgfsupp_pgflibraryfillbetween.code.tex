...
%%%  
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% Date of this copy: Mi 25. Dez 18:24:28 CET 2013 %%%
...
%
%  "softclip" means to get rid of parts at the beginning and/or end of a
...
\def\pgfpathcomputesoftclippath#1#2{%
	...
	\else
		...
		\pgfprocessround{#2}{#2}%
		%
%\message{computing soft clip path for ^^J\meaning#1 and ^^J\meaning#2...}%
		%
		\pgf@intersect@sortfalse
		\pgfintersectionofpaths%
			{%
