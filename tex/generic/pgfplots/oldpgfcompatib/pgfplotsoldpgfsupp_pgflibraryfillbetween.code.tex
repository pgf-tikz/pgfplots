...
%%%  
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% Date of this copy: So 22. Dez 21:52:18 CET 2013 %%%
...
\def\pgfpathfillbetween@compute@splitted#1#2{%
	...
	%       FIXME : there are implicit assumptions on the INTERNAL ORDER of the two paths! Which one!?
	%		FIXME : I certainly need to configure some of the sorting keys of \pgfintersectionofpaths...?
	%		FIXME : a *real* solution would work for any kind of paths. This here does not, it works for the "common use-cases"
	\if0\pgfpathfillbetween@reverse@mode
		% reverse=false
\message{REVERSING!^^J}%
		%
		% This case is actually more involved here!
		%
	...
	%
	%
\message{INSERTING INTERSECTIONS INTO PATH 1^^J}%
...
%
\message{INSERTING INTERSECTIONS INTO PATH 2^^J}%
