...
%%%  
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% Date of this copy: Mi 12. Feb 10:28:32 CET 2014 %%%
...
\pgfkeys{%
	...
	/pgf/fill between/inner moves/.is choice,
	/pgf/fill between/inner moves/connect/.code=\def\pgfpathfillbetween@inner@moveto{1},
	/pgf/fill between/inner moves/keep/.code=\def\pgfpathfillbetween@inner@moveto{2},
	/pgf/fill between/inner moves/connect,
	%
