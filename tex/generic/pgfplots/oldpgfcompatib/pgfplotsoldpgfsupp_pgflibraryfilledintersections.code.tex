...
%%%  
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% Date of this copy: Sa 16. Nov 21:05:48 CET 2013 %%%
...
\def\pgfpathfilledintersections@opt[#1]#2#3{%
	...
	\pgfprocessround{#3}{#3}%
	%
\message{Combination of \meaning#2\space and \meaning#3...^^J}%
...
\message{reverse=auto: comparing \pgfpath@filled@dir@first\space with \pgfpath@filled@dir@second^^J}%
	...
	\fi
	%
	\expandafter\pgfpathfilledintersections@replace@first@moveto#3\pgf@stop
	\let#3=\pgfretval
	% 
	% simply concatenate them:
	% ... and prepend any previous path elements:
	\pgfgetpath\pgf@temp
	\t@pgf@tokc=\expandafter{\pgf@temp}%
	%
	\t@pgf@toka=\expandafter{#2}%
	\t@pgf@tokb=\expandafter{#3}%
	\edef\pgfretval{\the\t@pgf@tokc\the\t@pgf@toka\the\t@pgf@tokb}%
	%
...
\def\pgf@insert@intersections@in@path#1{%
	\ifcase#1\relax
		% 0
		\pgf@error{illegal argument supplied.}
	\or
