...
%%%  
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% Date of this copy: Sa 16. Jun 17:39:22 CEST 2012 %%%
...
\long\def\tikzexternal@list@and@makefile@mode@picture@#1{%
	...
	\if0\tikzexternal@uptodate@mode
		% up to date check=simple
	\else
		% respect it in the makefile: changes to the hash key should
		% result in a remake.
		\tikzexternalwritetomakefile{\tikzexternal@curfilename\tikzexternalimgextension: \tikzexternal@curfilename\tikzexternal@check@uptodate@ext^^J}%
	\fi
	%
	\gdef\pgf@filename{}%
	\xdef\pgf@tempa{\noexpand\pgf@findfile\pgfsys@imagesuffixlist:+{\tikzexternal@curfilename}}%
...
\pgfutil@ifundefined{pdfmdfivesum}{%
	\let\tikzexternal@computemdfivesum=\tikzexternal@computemdfivesum@diff@fallback
}{%
}%
		...
		\else
			...
			\immediate\write\w@pgf@writea{%
				\noexpand\begingroup
					...
					\noexpand\toks0={\tikzexternal@lastkey@new}%
