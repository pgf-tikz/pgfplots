...
%%%  
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% Date of this copy: Mon Jan 18 12:18:56 CET 2010 %%%
...
\def\tikzexternalize@opt[#1]#2{%
	...
	\tikzifexternalizing{\csname nofiles\endcsname}{}%
}
		...
		\iftikzexternal@genfigurelist
			...
			\else
				...
				\if\tikzexternal@opmode5% mode='list and make'
					...
					\fi
					\immediate\write\tikzexternal@outmakefile{#1\tikzexternalimgextension:}%
...
\def\tikzexternalmakefiledefaultdeprule{%
	...
	\immediate\write\tikzexternal@outmakefile{\tikzexternal@TABchar touch $@ \tikzexternal@ROUTEchar\space will be filled later.}%
}%
