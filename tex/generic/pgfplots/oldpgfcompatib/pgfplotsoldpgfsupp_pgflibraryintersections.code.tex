...
\def\pgf@intersectionoflines#1#2#3#4{%
	...
	{%
		...
		\pgf@ifsolution@duplicate@lines{\pgf@intersect@solution@candidate}{%
...
% #1 - the solution.
%
% For line-to paths, we can have a duplicate if and only if the
% intersections was "exactly" on one of the end points (exactly up to
% machine precision)
\def\pgf@ifsolution@duplicate@lines#1{%
	#1%
	\pgf@xa=\pgf@x%
	\pgf@ya=\pgf@y%
	\let\pgf@intersect@next=\pgfutil@secondoftwo%
	\ifnum\pgf@intersect@solutions>0 %
		\pgf@ifsolution@duplicate@{\the\pgf@intersect@solutions}%
	\fi
	\pgf@intersect@next%
}
