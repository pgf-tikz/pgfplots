...
\def\pgfplots@stacked@rememberzerolevelpoint@for@next@plot#1{%
	\if+\pgfplots@stacked@sign
		\expandafter\pgfplotslistpushbackglobal\expandafter{#1}\to\pgfplots@stacked@nextzerolevellist@pos
		\expandafter\pgfplotslistpushbackglobal\expandafter{\pgfplots@stacked@zerolevel@current@neg}\to\pgfplots@stacked@nextzerolevellist@neg
	\else
		\expandafter\pgfplotslistpushbackglobal\expandafter{\pgfplots@stacked@zerolevel@current@pos}\to\pgfplots@stacked@nextzerolevellist@pos
		\expandafter\pgfplotslistpushbackglobal\expandafter{#1}\to\pgfplots@stacked@nextzerolevellist@neg
	\fi
}
...
%\message{Current value is '\pgfplots@stacked@sign'. Serializing: \meaning\pgfplotsretval^^J}%
	\if+\pgfplots@stacked@sign
		...
		%
		\ifx\pgfplots@stacked@zerolevel@current@neg\pgfutil@empty
			\pgfplots@stacked@zerolevel@fallback@{\pgfplots@stacked@dir}%
			\expandafter\let\csname pgfplots@current@point@\pgfplots@stacked@dir\endcsname=\pgfmathresult
		\else
			\expandafter\pgfplotsaxisdeserializedatapointfrom\pgfplots@stacked@zerolevel@current@neg% no braces
		\fi
		\pgfplotsaxisserializedatapointtostring
%\message{UNUSED value serialized as \meaning\pgfplotsretval^^J}%
	...
	\else
		\expandafter\pgfplotslistpushbackglobal\expandafter{\pgfplotsretval}\to\pgfplots@stacked@nextzerolevellist@neg
		%
		\ifx\pgfplots@stacked@zerolevel@current@pos\pgfutil@empty
			\pgfplots@stacked@zerolevel@fallback@{\pgfplots@stacked@dir}%
			\expandafter\let\csname pgfplots@current@point@\pgfplots@stacked@dir\endcsname=\pgfmathresult
		\else
			\expandafter\pgfplotsaxisdeserializedatapointfrom\pgfplots@stacked@zerolevel@current@pos% no braces
		\fi
		\pgfplotsaxisserializedatapointtostring
%\message{UNUSED value serialized as \meaning\pgfplotsretval^^J}%
		\expandafter\pgfplotslistpushbackglobal\expandafter{\pgfplotsretval}\to\pgfplots@stacked@nextzerolevellist@pos
