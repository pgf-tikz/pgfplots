...
\def\pgfplots@stacked@prepare@value@serialization{%
	...
	%
%	\pgfplotsset{%
%		visualization depends on=value \pgfplotsstackedzerolevelcurrent\as\pgfplotsstackedzerolevel
%	}%
	%
	%
	...
	\expandafter\def\expandafter\pgfplotsaxisserializedatapoint@private\expandafter{%
		...
		\t@pgfplots@toka=\expandafter{\pgfplotsstackedzerolevelcurrent}%
...
\def\pgfplotsaxisdeserializedatapointfrom@private@stacked@ Z#1#2{%
	\def\pgfplotsstackedzerolevel{#1}%
...
\def\pgfplots@stacked@finishpoint{%
	...
	\else
		...
		\expandafter\pgfplotsaxisdeserializedatapointfrom\pgfplotsstackedzerolevel%
