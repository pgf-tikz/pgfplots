...
\def\pgfplotsgetzerolevelcoordinates{%
	\ifx\pgfplots@stacked@zerolevel\pgfutil@empty
		\pgfplotsutilforeachcommasep{x,y,z}\as\pgfplots@loc@TMPa{%
			\pgfkeysgetvalue{/data point/x untransformed}\pgfplots@loc@TMPb
			\pgfkeyslet{/data point/zero/\pgfplots@loc@TMPa}\pgfplots@loc@TMPb
		}%
	...
	\ifpgfplots@stackedmode
		...
		%
		\def\pgfplots@stacked@diff@x{0}%
		\def\pgfplots@stacked@diff@y{0}%
		\def\pgfplots@stacked@diff@z{0}%
		\pgfutil@namelet{pgfplots@stacked@diff@\pgfplots@stacked@dir}{pgfplots@stacked@diff}%
		\pgfkeyslet{/data point/diff/x}\pgfplots@stacked@diff@x
		\pgfkeyslet{/data point/diff/y}\pgfplots@stacked@diff@y
		\pgfkeyslet{/data point/diff/z}\pgfplots@stacked@diff@z
		\pgfkeyslet{/data point/diff}\pgfplots@stacked@diff
	\fi
%
