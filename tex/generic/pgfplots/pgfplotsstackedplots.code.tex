...
\def\pgfplotsgetzerolevelcoordinates{%
	\ifx\pgfplots@stacked@zerolevel\pgfutil@empty
		%\pgfkeysgetvalue{/pgfplots/axis/zero/x}\pgfmathresult
		\def\pgfmathresult{0}%
		\pgfkeyslet{/data point/zero/x}\pgfmathresult
		%\pgfkeysgetvalue{/pgfplots/axis/zero/y}\pgfmathresult
		\pgfkeyslet{/data point/zero/y}\pgfmathresult
		%\pgfkeysgetvalue{/pgfplots/axis/zero/z}\pgfmathresult
		\pgfkeyslet{/data point/zero/z}\pgfmathresult
