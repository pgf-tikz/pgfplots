...
echo -n '\gdef\pgfplotsrevision{' >> tex/generic/pgfplots/pgfplots.revision.tex
# the 'echo' strips the trailing newline.
echo -n "`git describe --tags HEAD`" >> tex/generic/pgfplots/pgfplots.revision.tex
