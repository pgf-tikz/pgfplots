...
\title{Test cases for pgfnumtable}
...
\pgfplotslistforeach\cols\as\col{\textbf{Column ``\col''}\par
	\pgfnumtablegetcolumnbyname\col\of\table\to\colcontent
	\pgfplotslistforeach\colcontent\as\colc{Row data: ``\colc''\par}%
}%
...
\tracingmacros=2\tracingcommands=2
\pgfnumtableread{numtabletestdata2.gnuplot} to \table
\tracingmacros=0\tracingcommands=0
...
\pgfnumtabletypeset\table

\testsubsection{Basis, L2, no options}
\tracingmacros=2\tracingcommands=2
\pgfnumtabletypeset[columns={Basis,L2}]\table
\tracingmacros=0\tracingcommands=0
