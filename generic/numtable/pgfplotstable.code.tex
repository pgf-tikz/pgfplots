...
\def\pgfplotstabletypeset@opt[#1]#2{%
	...
	\pgfplotslistforeach\pgfplotstable@colnames\as\pgfplotstable@colname{%
		...
		\pgfplotstabletypeset@setkeys{columns/\pgfplotstable@colname/.try}%
		\pgfkeysgetvalue{/pgfplots/numeric table/column name}{\pgfplotstable@colname@out}%
		\ifx\pgfplotstable@colname@out\pgfutil@empty
		...
		\pgfplotslistforeachungrouped\pgfplotstable@col\as\pgfplotstable@entry{%
			\pgfkeysvalueof{/pgfplots/numeric table/assign cell contents/.@cmd}\pgfplotstable@entry\pgfmathresult\pgfeov
			\expandafter\pgfplotslistpushback\pgfmathresult\to\pgfplotstable@col@processed
		}%
		{\globaldefs=1
...
%\message{I have now \meaning\pgfplotstabletypeset@final@colnames, and \meaning\pgfplotstabletypeset@final@cols.}%
	...
	\pgfplotslistsize\pgfplotstabletypeset@final@colnames\to\c@pgfplotstable@numcols
