...
\def\pgfplotstabletypesetfile@opt[#1]#2{%
	...
	\pgfplotstabletypeset[#1]\pgfplotstabletypesetfile@opt@@
	\endgroup
}%
...
\def\pgfplotstableread@impl@#1#2#3{%
	...
	\else
		\pgfqkeys{/pgfplots/table}{#1}%
	\fi
%\pgfplots@message{ATTEMPTING TO READ #2}%
	\openin\pgfplotstable@file=#2\relax
...
%\pgfplots@message{EOF}%
	\else
		\read\pgfplotstable@file to\pgfplotstable@LINE
		\ifeof\pgfplotstable@file
		\else
