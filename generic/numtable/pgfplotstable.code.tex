...
% /pgfplots/table/columns/[index]<col index>/.style={}
\pgfkeys{%
	...
	/pgfplots/table/select equal part entry of/.style 2 args={%
		/pgfplots/table/row predicate/.code={%
			...
			% 	\c@pgfplotstable@rowindex=\c@pgfplotstable@colindex
			% 	\multiply\c@pgfplotstable@rowindex by#2\relax
			% 	\xdef\pgfplotstablerows{\the\c@pgfplotstable@rowindex}% communicate total number of modified rows here!
			% \fi
			%-------------------------------------------------- 
...
\def\pgfplotstabletypeset@opt[#1]#2{%
	...
	\pgfplotslistforeach\pgfplotstable@colnames\as\pgfplotstable@colname{%
		...
		\fi
		\edef\pgfplotstable@TMP{\the\pgfplotslist@TOK@a,columns/{[index]\the\c@pgfplotstable@colindex}/.try,column indices/\the\c@pgfplotstable@colindex/.try}%
