...
\def\pgfnumtabletypeset@opt[#1]#2{%
	\begingroup
	\pgfqkeys{/pgfplots/numeric table}{#1}%
	\expandafter\pgfplotslistnew\expandafter\pgfnumtable@cols\expandafter{\pgfkeysvalueof{/pgfplots/numeric table/columns}}%
	\pgfplotslistforeach\pgfnumtable@cols\as\pgfnumtable@colname{%
		\pgfnumtablegetcolumnbyname\pgfnumtable@colname\of#2\to\pgfnumtable@col
		\pgfqkeys{/pgfplots/numeric table}{column \pgfnumtable@col\ style/.try}%
