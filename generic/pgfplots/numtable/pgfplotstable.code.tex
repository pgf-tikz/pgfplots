...
% \pgfplotstablereadgetvalueofcolindex{<index>}{<\macro>}
% \pgfplotstablereadgetvalueofcolname{<name>}{<\macro>}
...
% these values are only usable for a read-listener.
\def\pgfplotstablereadvalueofcolindex#1{\csname pgfplotstblread@colcontent@no#1\endcsname}%
\def\pgfplotstablereadvalueofcolname#1{\csname pgfplotstblread@colcontent@no\csname pgfplotstblread@colindex@for@name#1\endcsname\endcsname}%
\def\pgfplotstablereadgetvalueofcolindex#1#2{%
	\expandafter\let\expandafter#2\csname pgfplotstblread@colcontent@no#1\endcsname}%
\def\pgfplotstablereadgetvalueofcolname#1#2{%
	\expandafter\let\expandafter#2\csname pgfplotstblread@colcontent@no\csname pgfplotstblread@colindex@for@name#1\endcsname\endcsname}%
