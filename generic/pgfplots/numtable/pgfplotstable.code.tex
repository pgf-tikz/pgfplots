...
% #3: the table.
%
% The cell value will be written into the macro \pgfplotslocretval.
%
% REMARK:
...
%
% Example:
% \pgfplotstablegetelem{0}{2}\of\table
% The elem is `\pgfplotslocretval'.
\def\pgfplotstablegetelem#1#2\of#3{%
	\pgfplotstablegetcolumn{#2}\of{#3}\to\pgfplotstable@loc@TMPa
	\pgfplotslistselect#1\of\pgfplotstable@loc@TMPa\to\pgfplotslocretval
}%
