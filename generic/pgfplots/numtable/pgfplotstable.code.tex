...
%\pgfplots@message{ATTEMPTING TO READ #2}%
	...
	%\pgfplots@message{ASSIGNING COLUMN NO \the\pgfplotstableread@curcol / \the\pgfplotstableread@numcols}%
			% TMPa := column list content
			\expandafter\let\expandafter\pgfplotstable@loc@TMPa\csname pgfp@numtable@col@\the\pgfplotstableread@curcol\endcsname
			% global := TMPa
			\expandafter\global\expandafter\let\csname pgfp@numtable@glob@col@\the\pgfplotstableread@curcol\endcsname=\pgfplotstable@loc@TMPa
...
%\message{Column '\pgfplotstable@loc@TMPa' has entries: \expandafter\meaning\csname pgfp@numtable@col@\the\c@pgfplotstable@counta\endcsname}%
...
%\pgfplots@message{Got column name no \the\pgfplotstableread@curcol\ as '#1'}%
	...
	\expandafter\pgfplotslistpushback\expandafter{\pgfplotstable@loc@TMPa}\to\pgfplotstable@colnames
	\advance\pgfplotstableread@curcol by1\relax
}
