...
%\pgfplots@message{ATTEMPTING TO READ #2}%
	...
	\else
		...
		\pgfplotstable@copy@globalbuffers@to#3
	\fi
	\let\pgfplotsscanlinelength=\pgfp@numtable@glob@scanlinelength
}
...
\def\pgfplotstableread@impl@prepare#1#2#3{%
	...
	\global\pgfplotslistnewempty\pgfplotstable@colnames@glob
	\ifpgfplots@tableread@to@listener
		\def\pgfplotstablerow{\the\pgfplotstableread@usablelineno}%
		\def\pgfplotstablelineno{\the\pgfplotstableread@lineno}%
...
\def\pgfplotstableread@finish{%
	...
	\global\let\pgfp@numtable@glob@scanlinelength=\pgfplotsscanlinelength
}
...
\pgfkeysdef{/pgfplots/table/@undefined column text}{undefined column #1.}%
\def\pgfplotstable@undefinedtext#1{\pgfkeysvalueof{/pgfplots/table/@undefined text/.@cmd}#1\pgfeov}%
...
\def\pgfplotstablereadvalueofcolindex@#1{%
	\pgfutil@ifundefined{pgfplotstblread@colcontent@no#1}{%
		\pgfplotstable@undefinedtext{no #1}%
	}{%
