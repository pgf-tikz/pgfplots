...
\def\pgfplots@stacked@preparepoint@inmacro{%
	...
	\ifpgfplots@stacked@x
		...
		\ifpgfplots@xislinear
			...
			\fi
		\fi
		\pgfplots@stacked@op{\pgfplots@stacked@zerolevelpoint@x}{\pgfplots@current@point@x}%
	...
	\else
		...
		\ifpgfplots@yislinear
			...
			\fi
		\fi
		\pgfplots@stacked@op{\pgfplots@stacked@zerolevelpoint@y}{\pgfplots@current@point@y}%
