...
\pgfkeys{%
	...
	/pgfplots/xlabel near ticks/.style={%
		/pgfplots/every axis x label/.style={at={(ticklabel cs:0.5)},anchor=ticklabel}%
	},%
	...
	/pgfplots/ylabel near ticks/.style={%
		/pgfplots/every axis y label/.style={at={(ticklabel cs:0.5)},rotate=90,anchor=south}%
	},%
	...
	/pgfplots/every axis z label/.style={at={(ticklabel cs:0.5)},rotate=90},
...
\def\pgfplots@show@label#1#2{%
	...
	%
	% 2. Declare a local ANCHOR to align labels, the 'ticklabel'
	% anchor.
	%
	...
	\tikzdeclarecoordinatesystem{ticklabel}{%
		...
		\else
			\edef\pgfplots@loc@TMPa{##1,\pgfkeysvalueof{/pgfplots/#1label shift}}%
		\fi
	...
	\pgfkeysdef{/tikz/sloped}{%
		\tikz@addtransform{\pgfplotstransformtoaxisdirection{#1}}%
	}%
	%
	\node 
