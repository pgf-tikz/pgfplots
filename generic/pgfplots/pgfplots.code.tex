...
\def\pgfplots@show@ticklabel#1#2(#3,#4)#5{{%
	\csname ifpgfplots@#1ticklabel@interval\endcsname
		...
		\xdef\pgfplots@show@ticklabel@LASTTICK{%
			...
			\noexpand\def\noexpand\pgfplots@show@ticklabel@num{\the#5}%
		}%
	\else
		\let\ticknum=#5\relax%
		\pgfplots@show@ticklabel@{#1}{#2}%
...
\def\pgfplots@drawyaxis@placecomputedtick{%
	...
	\fi
	%--------------------------------------------------
	% \ifcase\pgfplots@ytickposnum\relax
	% \draw
	% 	(\pgfplots@xcoordminTEX-\pgfplots@tick@offset, \pgfplots@tmpa) -- ++( #1, 0pt)
	% 	(\pgfplots@xcoordmaxTEX+\pgfplots@tick@offset, \pgfplots@tmpa)	-- ++(-#1, 0pt)
	% 	;
	% \or
	% 	\draw (\pgfplots@xcoordminTEX-\pgfplots@tick@offset, \pgfplots@tmpa) -- ++( #1, 0pt);
	% \or
	% 	\draw (\pgfplots@ZERO@x      -\pgfplots@tick@offset, \pgfplots@tmpa) -- ++( #1, 0pt);
	% \or
	% 	\draw (\pgfplots@xcoordmaxTEX+\pgfplots@tick@offset, \pgfplots@tmpa)	-- ++(-#1, 0pt);
	% \fi
	%-------------------------------------------------- 
}%
\def\pgfplots@drawyaxis@placecomputedgridline{%
	...
	%--------------------------------------------------
	% \draw
	% 	(\pgfplots@xcoordminTEX,	\pgfplots@tmpa)
	% --	(\pgfplots@xcoordmaxTEX,	\pgfplots@tmpa)
	% ;
	%-------------------------------------------------- 
}%
...
\def\pgfplots@drawxaxis@placecomputedtick{%
	...
	% 	\draw 
	% 	(\pgfplots@tmpa, \pgfplots@ycoordminTEX-\pgfplots@tick@offset) -- ++(0pt, #1)
	% 	
	% 	(\pgfplots@tmpa, \pgfplots@ycoordmaxTEX+\pgfplots@tick@offset) -- ++(0pt,-#1)
	% 	;
	% \or
	% 	\draw
	% 	(\pgfplots@tmpa, \pgfplots@ycoordminTEX-\pgfplots@tick@offset) -- ++(0pt, #1);
	% \or
	% 	\draw
	% 	(\pgfplots@tmpa, \pgfplots@ZERO@y      -\pgfplots@tick@offset) -- ++(0pt, #1);
	% \or
	% 	\draw
	% 	(\pgfplots@tmpa, \pgfplots@ycoordmaxTEX+\pgfplots@tick@offset) -- ++(0pt,-#1);
	% \fi
...
\def\pgfplots@drawxaxis@placecomputedgridline{%
	...
	%--------------------------------------------------
	% \draw
	% 	(\pgfplots@tmpa,	\pgfplots@ycoordminTEX)
...
\def\pgfplots@drawaxis@outerlines{%
	...
	(\pgfplots@xcoordminTEX,	\pgfplots@ycoordminTEX)
 	\ifcase\pgfplots@yaxislinesnum
	    decorate [/pgfplots/every outer y axis line,ydiscont,decoration={pre length=\ydisstart, post length=\ydisend}] { -- (\pgfplots@xcoordminTEX,	\pgfplots@ycoordmaxTEX) }
	\or decorate [/pgfplots/every outer y axis line,ydiscont,decoration={pre length=\ydisstart, post length=\ydisend}] { -- (\pgfplots@xcoordminTEX,	\pgfplots@ycoordmaxTEX) }
	\or { (\pgfplots@xcoordminTEX,	\pgfplots@ycoordmaxTEX) }
	\or { (\pgfplots@xcoordminTEX,	\pgfplots@ycoordmaxTEX) }
	\fi
	\ifcase\pgfplots@xaxislinesnum
	    decorate [/pgfplots/every outer x axis line,xdiscont,decoration={pre length=\xdisstart, post length=\xdisend}] { -- (\pgfplots@xcoordmaxTEX,	\pgfplots@ycoordmaxTEX) }
	\or { (\pgfplots@xcoordmaxTEX,	\pgfplots@ycoordmaxTEX) }
	\or { (\pgfplots@xcoordmaxTEX,	\pgfplots@ycoordmaxTEX) }
	\or decorate [/pgfplots/every outer x axis line,xdiscont,decoration={pre length=\xdisstart, post length=\xdisend}] { -- (\pgfplots@xcoordmaxTEX,	\pgfplots@ycoordmaxTEX) }
	\fi
	\ifcase\pgfplots@yaxislinesnum
	    decorate [/pgfplots/every outer y axis line,ydiscont,decoration={pre length=\ydisend, post length=\ydisstart}] { -- (\pgfplots@xcoordmaxTEX,	\pgfplots@ycoordminTEX) }
	\or { (\pgfplots@xcoordmaxTEX,	\pgfplots@ycoordminTEX) }
	\or { (\pgfplots@xcoordmaxTEX,	\pgfplots@ycoordminTEX) }
	\or decorate [/pgfplots/every outer y axis line,ydiscont,decoration={pre length=\ydisend, post length=\ydisstart}] { -- (\pgfplots@xcoordmaxTEX,	\pgfplots@ycoordminTEX) }
	\fi
	\ifcase\pgfplots@xaxislinesnum
	    decorate [/pgfplots/every outer x axis line,xdiscont,decoration={pre length=\xdisend, post length=\xdisstart}] { -- (\pgfplots@xcoordminTEX,	\pgfplots@ycoordminTEX) }
	\or decorate [/pgfplots/every outer x axis line,xdiscont,decoration={pre length=\xdisend, post length=\xdisstart}] { -- (\pgfplots@xcoordminTEX,	\pgfplots@ycoordminTEX) }
	...
	\else
		...
		\ifpgfplots@needsminorloop
			\ifpgfplots@islinear
				...
				\pgfplots@tmpb=\csname pgfplots@tick@distance@#2\endcsname pt
...
\long\def\pgfplots@PREPARE@COORD@STREAM#1#2{%
	...
	\def\pgfplots@coord@stream@end@@{%
		...
		\ifpgfplots@coord@stream@isfirst
			\pgfplots@warning{Warning: empty plot silently dropped.}%
		\else
			% Idea: use
...
\pgfdeclareshape{pgfplots@low@level@shape}{%
	...
	%
	%
	\inheritanchor[from=pgfplots@low@level@shape@INNER]{center}
	\inheritanchor[from=pgfplots@low@level@shape@INNER]{north}
	\inheritanchor[from=pgfplots@low@level@shape@INNER]{north east}
	\inheritanchor[from=pgfplots@low@level@shape@INNER]{east}
	\inheritanchor[from=pgfplots@low@level@shape@INNER]{south east}
	\inheritanchor[from=pgfplots@low@level@shape@INNER]{south}
	\inheritanchor[from=pgfplots@low@level@shape@INNER]{south west}
	\inheritanchor[from=pgfplots@low@level@shape@INNER]{west}
	\inheritanchor[from=pgfplots@low@level@shape@INNER]{north west}
	%%
	%%
	\anchor{above north}{%
		\upperrightcorner
	...
	%%
	\inheritsavedanchors[from=pgfplots@low@level@shape@INNER]
	\inheritanchor[from=pgfplots@low@level@shape@INNER]{origin}
	\inheritanchor[from=pgfplots@low@level@shape@INNER]{above origin}
	\inheritanchor[from=pgfplots@low@level@shape@INNER]{left of origin}
	\inheritanchor[from=pgfplots@low@level@shape@INNER]{right or origin}
	\inheritanchor[from=pgfplots@low@level@shape@INNER]{below origin}
	%%
	%%
	\anchorborder{%
