...
\def\pgfplots@BEGIN@init@and@draw@axis{%
	...
	\setbox\pgfnodepartimagebox=\hbox\bgroup\bgroup
		...
		\ifpgfplots@clip
			...
			\xdef\pgfplotspoint@bb@@@{{\the\pgf@picminx}{\the\pgf@picminy}{\the\pgf@picmaxx}{\the\pgf@picmaxy}}%
		\else
			% FIXME : THAT'S WRONG ELIMINATE
			...
			\pgfplotsifaxissurfaceisforeground{v0v}{%
				...
				\pgfplotsifaxissurfaceisforeground{vv0}{%
					...
					\def\pgfplots@clippath@install{%
						...
						\pgfpathclose
						\pgfplots@clippath@use%
						% FIXME ELIMINATE THE WRONG PROCESSING of @BB
						% above!
					}%
				}{%
...
\def\pgfplotspointbb@assertvaluesexist{%
	\ifx\pgfplotspoint@bb@@@\relax
		...
		\def\pgfplots@clippath@use{%
			\xdef\pgfplots@glob@TMPa{{\the\pgf@pathminx}{\the\pgf@pathminy}{\the\pgf@pathmaxx}{\the\pgf@pathmaxy}}%
			\pgfusepath{discard}%
		}%
		\pgfplots@clippath@install
...
\def\pgfplotspointbbupperright@#1#2#3#4{\pgf@x=#3 \pgf@y=#4 }%
