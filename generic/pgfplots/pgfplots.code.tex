...
\pgfdeclareshape{pgfplots@low@level@shape}{%
	...
	\savedanchor\lowerleftinnercorner{%
		\pgfqpoint{\pgfplots@savedanchor@inner@lowerleft@x}{\pgfplots@savedanchor@inner@lowerleft@y}%
	}%
	\savedanchor\upperrightinnercorner{%
		\pgfqpoint{\pgfplots@savedanchor@inner@upperright@x}{\pgfplots@savedanchor@inner@upperright@y}%
	}%
	\savedanchor\origin{%
		\pgfqpoint{\pgfplots@ZERO@x}{\pgfplots@ZERO@y}%
	}%
