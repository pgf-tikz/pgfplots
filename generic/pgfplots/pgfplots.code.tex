...
\def\pgfplots@initsizes@setunitvector#1#2#3{%
...
\def\pgfplots@initsizes{%
	...
	%
	\pgfqpointxy{\pgfplots@tmpXscale}{\pgfplots@tmpYscale}%
	\edef\pgfplots@tmpXscale{\the\pgf@x}%
	\edef\pgfplots@tmpYscale{\the\pgf@y}%
	\def\pgfplots@tmpZscale{1pt}%
	\pgfplots@initsizes@setunitvector{x}{0}{\pgfplots@tmpXscale}%
	\pgfplots@initsizes@setunitvector{y}{1}{\pgfplots@tmpYscale}%
	\pgfplots@initsizes@setunitvector{z}{2}{\pgfplots@tmpZscale}%
	%
	...
	\pgfpointdiff
		...
		{\pgfqpointxy{\pgfplots@xmax}{\pgfplots@ymin}}%
	\xdef\pgfplotspointxaxis{\noexpand\pgf@x=\the\pgf@x\noexpand\pgf@y=\the\pgf@y}%
	%
	\pgfpointdiff
		{\pgfqpoint{\pgfplots@xcoordminTEX}{\pgfplots@ycoordminTEX}}
		{\pgfqpointxy{\pgfplots@xmin}{\pgfplots@ymax}}%
...
\def\pgfplots@BEGIN@init@and@draw@axis{%
	...
	\setbox\pgfnodepartimagebox=\hbox\bgroup\bgroup
		...
		\else
			...
			\pgfpathlineto{\pgfqpointxy{\pgfplots@xmax}{\pgfplots@ymin}}%
			\pgfpathlineto{\pgfqpointxy{\pgfplots@xmax}{\pgfplots@ymax}}%
			\pgfpathlineto{\pgfqpointxy{\pgfplots@xmin}{\pgfplots@ymax}}%
			\pgfusepath{clip}%
		\fi
}
...
\long\def\pgfplots@evalute@tikz@coord@system@interface#1,#2\pgfplots@coord@end{%
	...
	\else
		\pgfqpointxyz{\pgfplots@glob@TMPa}{\pgfplots@glob@TMPb}{\pgfplots@glob@TMPc}% FIXME: read 3D!
	\fi
}
