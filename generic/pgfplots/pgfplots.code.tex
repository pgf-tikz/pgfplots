...
% 5:  mi = given explicitly somehow AS SYMBOLIC CONSTANTS.
	...
	/pgfplots/scatter/true/.code={%
		...
		% FIXME : make sure there is at least one mark set!
		%\pgfkeysalso{/tikz}{mark=*,mark options={draw=blue,fill=blue!80!black}}%
	},
