...
% FIXME: simplify this code! It is just a replication of the default error stuff together with an xshift!
	...
	/pgfplots/z buffer/sort coordinates/.code={\def\pgfplotsplothandlermesh@zbuffer@choice{4}},%
...
\def\pgfplots@define@threedim@marks{%
	\ifpgfplots@threedim
		...
		\pgfdeclareplotmark{cube*}
		{%
			% enabled==0 => foreground!
			%
			% FIXME : rename these surfenabled flags!
			\if\csname pgfplots@surfenabled@0vv\endcsname0%
				\pgfpathmoveto{\pgfplotsqpointxyzabsolutesize{-0.5\pgfplotmarksize}{-0.5\pgfplotmarksize}{-0.5\pgfplotmarksize}}%
				\pgfpathlineto{\pgfplotsqpointxyzabsolutesize{-0.5\pgfplotmarksize}{-0.5\pgfplotmarksize}{ 0.5\pgfplotmarksize}}%
				\pgfpathlineto{\pgfplotsqpointxyzabsolutesize{-0.5\pgfplotmarksize}{ 0.5\pgfplotmarksize}{ 0.5\pgfplotmarksize}}%
				\pgfpathlineto{\pgfplotsqpointxyzabsolutesize{-0.5\pgfplotmarksize}{ 0.5\pgfplotmarksize}{-0.5\pgfplotmarksize}}%
			...
			\else
				...
				\pgfusepathqfillstroke
			\fi
			\if\csname pgfplots@surfenabled@v0v\endcsname0%
				\pgfpathmoveto{\pgfplotsqpointxyzabsolutesize{-0.5\pgfplotmarksize}{-0.5\pgfplotmarksize}{-0.5\pgfplotmarksize}}%
				\pgfpathlineto{\pgfplotsqpointxyzabsolutesize{-0.5\pgfplotmarksize}{-0.5\pgfplotmarksize}{ 0.5\pgfplotmarksize}}%
				\pgfpathlineto{\pgfplotsqpointxyzabsolutesize{ 0.5\pgfplotmarksize}{-0.5\pgfplotmarksize}{ 0.5\pgfplotmarksize}}%
				\pgfpathlineto{\pgfplotsqpointxyzabsolutesize{ 0.5\pgfplotmarksize}{-0.5\pgfplotmarksize}{-0.5\pgfplotmarksize}}%
			...
			\else
				...
				\pgfusepathqfillstroke
			\fi
			\if\csname pgfplots@surfenabled@vv0\endcsname0%
				\pgfpathmoveto{\pgfplotsqpointxyzabsolutesize{-0.5\pgfplotmarksize}{-0.5\pgfplotmarksize}{-0.5\pgfplotmarksize}}%
				\pgfpathlineto{\pgfplotsqpointxyzabsolutesize{-0.5\pgfplotmarksize}{ 0.5\pgfplotmarksize}{-0.5\pgfplotmarksize}}%
				\pgfpathlineto{\pgfplotsqpointxyzabsolutesize{ 0.5\pgfplotmarksize}{ 0.5\pgfplotmarksize}{-0.5\pgfplotmarksize}}%
				\pgfpathlineto{\pgfplotsqpointxyzabsolutesize{ 0.5\pgfplotmarksize}{-0.5\pgfplotmarksize}{-0.5\pgfplotmarksize}}%
...
\def\pgfplots@decide@which@figure@surfaces@are@drawn{%
	\ifpgfplots@threedim
		\ifdim\pgfplots@view@dir@threedim@x>0pt
			\expandafter\def\csname pgfplots@surfenabled@0vv\endcsname{0}% foreground
			\expandafter\def\csname pgfplots@surfenabled@1vv\endcsname{1}% background
		\else
		...
		\ifdim\pgfplots@view@dir@threedim@y>0pt
			\expandafter\def\csname pgfplots@surfenabled@v0v\endcsname{0}% foreground
			\expandafter\def\csname pgfplots@surfenabled@v1v\endcsname{1}% background
		\else
		...
		\ifdim\pgfplots@view@dir@threedim@z>0pt
			\expandafter\def\csname pgfplots@surfenabled@vv0\endcsname{0}% foreground
			\expandafter\def\csname pgfplots@surfenabled@vv1\endcsname{1}% background
		\else
			\expandafter\def\csname pgfplots@surfenabled@vv0\endcsname{1}% 
			\expandafter\def\csname pgfplots@surfenabled@vv1\endcsname{0}% 
		\fi
		\edef\pgfplots@xticklabelaxisspec{%
			v%
			\if1\csname pgfplots@surfenabled@v0v\endcsname1\else0\fi
			\if0\csname pgfplots@surfenabled@vv0\endcsname1\else0\fi
		}%
		\edef\pgfplots@yticklabelaxisspec{%
			\if1\csname pgfplots@surfenabled@0vv\endcsname1\else0\fi
			v%
			\if0\csname pgfplots@surfenabled@vv0\endcsname1\else0\fi
		}%
		\edef\pgfplots@zticklabelaxisspec{%
			\if1\csname pgfplots@surfenabled@0vv\endcsname1\else0\fi
			\if0\csname pgfplots@surfenabled@v0v\endcsname1\else0\fi
			v%
		}%
	\else
		\expandafter\def\csname pgfplots@surfenabled@vv0\endcsname{1}%
