...
% upper (alias right alias top)      : u
	...
	/pgfplots/xticklabel dist/.initial=0.13cm,
	/pgfplots/yticklabel dist/.initial=0.13cm,
	/pgfplots/zticklabel dist/.initial=0.13cm,
...
\def\pgfplots@initsizes{%
	...
	\else
		\let\pgfplotspointzaxis=\pgfpointorigin
		\def\pgfplotspointzaxislength{0pt}%
		\pgfpointscale
			{0.5}%
			{\pgfpointadd
				\pgfplotspointxaxis%
...
\pgfdeclareshape{pgfplots@low@level@shape}{%
	...
	\anchor{left of origin}{%
		\pgfpointintersectionoflines
			...
			{\lowerleftinnercorner}
			{\pgfpointadd{\lowerleftinnercorner}{\pgf@x=0sp }}%
	}%
	\anchor{right of origin}{%
		\pgfpointintersectionoflines
			{\origin}
...
\def\pgfplots@draw@axis{%
	...
	\fi
	%
	\pgfplots@prepare@ticklabel@anchors@for x
	\pgfplots@prepare@ticklabel@anchors@for y
	\pgfplots@prepare@ticklabel@anchors@for z
	%
	%
