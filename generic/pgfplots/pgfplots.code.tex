	...
	\ifpgfplots@hide@y\else
		\ifnum\pgfplots@yaxislinesnum=2
			\draw[/pgfplots/every inner y axis line,%
				...
				(\pgfplots@logical@ZERO@x,	\pgfplots@ymin) -- (\pgfplots@logical@ZERO@x,	\pgfplots@ymax);
		\fi
	\fi
	\ifpgfplots@hide@x\else
		\ifnum\pgfplots@xaxislinesnum=2
			\draw[/pgfplots/every inner x axis line,%
				...
				(\pgfplots@xmin, \pgfplots@logical@ZERO@y) -- (\pgfplots@xmax, \pgfplots@logical@ZERO@y);
		\fi
	\fi
}%
...
%\message{x = [\pgfplots@xmin:\pgfplots@xmax]  y = [\pgfplots@ymin:\pgfplots@ymax]}%
	...
	\else
		\def\pgfplots@data@scale@trafo@SHIFT@x{0}%
		\def\pgfplots@loc@TMPb{data}%
	...
	\else
		\def\pgfplots@data@scale@trafo@SHIFT@y{0}%
		\def\pgfplots@loc@TMPb{data}%
...
%\message{Setting unitvector(#1) to non-standard \csname pgfplots@#1\endcsname ...}%
			\def\pgfplots@loc@TMPa(##1,##2){%
				...
				\fi
				\csname pgfset#1vec\endcsname{\pgfpoint{\pgfplots@loc@TMPb pt}{\pgfplots@loc@TMPc pt}}%
			}%
