...
\def\pgfplots@set@options#1{%
	...
	\pgfplots@set@keys@from@tikz@style{\pgfplots@rmopts}{every axis}{/pgfplots,/pgfplots/naming commands,/pgfplots/tick,/pgfplots/legend,/pgfplots/descriptions,/pgfplots/scale}%
	\ifcase\pgfplots@xmode
		\ifcase\pgfplots@ymode
			\pgfplots@set@keys@from@tikz@style@append@to{\pgfplots@rmopts}{every linear axis}{/pgfplots,/pgfplots/naming commands,/pgfplots/tick,/pgfplots/legend,/pgfplots/descriptions}{every axis}%
		\or
			\pgfplots@set@keys@from@tikz@style@append@to{\pgfplots@rmopts}{every semilogy axis}{/pgfplots,/pgfplots/naming commands,/pgfplots/tick,/pgfplots/legend,/pgfplots/descriptions}{every axis}%
		\fi
	\or
		\ifcase\pgfplots@ymode
			\pgfplots@set@keys@from@tikz@style@append@to{\pgfplots@rmopts}{every semilogx axis}{/pgfplots,/pgfplots/naming commands,/pgfplots/tick,/pgfplots/legend,/pgfplots/descriptions}{every axis}%
		\or
			\pgfplots@set@keys@from@tikz@style@append@to{\pgfplots@rmopts}{every loglog axis}{/pgfplots,/pgfplots/naming commands,/pgfplots/tick,/pgfplots/legend,/pgfplots/descriptions}{every axis}%
		\fi
	\fi
	% Acquire style commands and nameing commands from direct input
	% options '#1' BEFORE the 'every' styles are processed:
	\pgfplots@setkeys@from@macro\pgfplots@remaining@input\pgfplots@rmopts{/pgfplots/naming commands}%
