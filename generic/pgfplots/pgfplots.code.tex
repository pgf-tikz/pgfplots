...
\def\pgfplots@prepare@coord@filtering@for#1{%
	...
	\else
		...
		\expandafter\let\csname pgfplotsmathlog#1@logten\endcsname=\logten
		\expandafter\let\csname pgfplotsmathlog#1@logten@inv\endcsname=\reciproclogten
		...
		\pgfplots@if{pgfplots@disablelogfilter@#1}{\relax}{%
			...
			\else
				...
				\else
					...
					\expandafter\let\csname pgfplotsmathlog#1@logten\endcsname=\pgfmathresult
					\pgfmath@basic@multiply@{\reciproclogten}{\pgfplots@loc@TMPa}%
					\expandafter\let\csname pgfplotsmathlog#1@logten@inv\endcsname=\pgfmathresult
					\expandafter\edef\csname pgfplotsmathlogtologten@#1@\endcsname##1{%
						\noexpand\pgfmath@basic@multiply@{##1}{\csname pgfplotsmathlog#1@logten@inv\endcsname}%
					}%
					%
					\begingroup
