...
% top=3
	...
	/pgfplots/axis x line/.is choice,
	/pgfplots/axis x line/box/.style	={axis x line*/box},
	/pgfplots/axis x line/bottom/.style	={axis x line*/bottom,xtick align=center,enlarge x limits=false,every outer x axis line/.append style={/pgfplots/default non boxed lines}},
	/pgfplots/axis x line/middle/.code	={%
		\pgfkeysalso{axis x line*/middle,xtick align=center,enlarge x limits=false,every inner x axis line/.append style={/pgfplots/default non boxed lines}}%
	...
	/pgfplots/axis x line/center/.style	={/pgfplots/axis x line/middle},
	/pgfplots/axis x line/top/.style	={axis x line*/top,xtick align=center,enlarge x limits=false,every axis x label/.style={at={(0.5,1)},anchor=south,yshift=15pt},every outer x axis line/.append style={/pgfplots/default non boxed lines}},
...
% right=3
	...
	/pgfplots/axis y line/.is choice,
	/pgfplots/axis y line/box/.style	={axis y line*/box},
	/pgfplots/axis y line/left/.style	={axis y line*/left,ytick align=center,enlarge y limits=false,every outer y axis line/.append style={/pgfplots/default non boxed lines}},
	/pgfplots/axis y line/center/.style	={axis y line*/center,ytick align=center,enlarge y limits=false,every axis y label/.style={at={(current axis.above origin)},anchor=north west},every inner y axis line/.append style={/pgfplots/default non boxed lines}},
	/pgfplots/axis y line/middle/.style	={/pgfplots/axis y line/center},
	/pgfplots/axis y line/right/.code	={%
		\pgfkeysalso{axis y line*/right,ytick align=center,enlarge y limits=false,every axis y label/.style={at={(1,1)},anchor=north west,xshift=15pt},every outer y axis line/.append style={/pgfplots/default non boxed lines}}%
...
%\message{final H=\pgf@sys@tonumber{\H} * log(10)}%
		...
		\ifdim\MAX<\pgfplots@tmpa
			...
			\pgfmathfloatparsenumber{\Hmacrobaseten}%
			\expandafter\pgfmathfloat@decompose\pgfmathresult\relax\pgfmathfloat@a@S\H\pgfmathfloat@a@E
