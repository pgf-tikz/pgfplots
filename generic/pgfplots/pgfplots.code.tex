...
\def\pgfplots@define@currentplotstyle@as#1{%
	\pgfkeysdef{/tikz/current plot style}{%
		\pgfplots@define@currentplotstyle@as@preparesearchpaths
		\pgfqkeys{/pgfplots}{#1}%
	}%
%\pgfkeysgetvalue{/tikz/current plot style/.@cmd}\temp\message{/tikz/current plot style is now \meaning\temp'}%
}%
\def\pgfplots@define@currentplotstyle@as@preparesearchpaths{%
	\pgfkeysalso{/handler config=full or existing,/pgfplots/.search also=/tikz}
}%
