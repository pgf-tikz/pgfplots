...
\def\pgfplots@addplotimpl@table@fromfile@listener@{%
	\ifx\pgfplots@plot@tbl@x\pgfutil@empty
		\pgfplotstablereadgetvalueofcolindex{\pgfplots@plot@tbl@xindex}{\pgfplots@current@point@x}%
	\else
		\pgfplotstablereadgetvalueofcolname{\pgfplots@plot@tbl@x}{\pgfplots@current@point@x}%
	\fi
	\ifx\pgfplots@plot@tbl@y\pgfutil@empty
		\pgfplotstablereadgetvalueofcolindex{\pgfplots@plot@tbl@yindex}{\pgfplots@current@point@y}%
	\else
		\pgfplotstablereadgetvalueofcolname{\pgfplots@plot@tbl@y}{\pgfplots@current@point@y}%
	\fi
}%
\def\pgfplots@addplotimpl@table@fromfile@listener@witherrors{%
	...
	\ifx\pgfplots@plot@tbl@error@x\pgfutil@empty
		\ifx\pgfplots@plot@tbl@error@xindex\pgfutil@empty
			\let\addplot@tbl@error@cur@x=\pgfutil@empty
		\else
			\pgfplotstablereadgetvalueofcolindex{\pgfplots@plot@tbl@error@xindex}{\addplot@tbl@error@cur@x}%
		\fi
	\else
		\pgfplotstablereadgetvalueofcolname{\pgfplots@plot@tbl@error@x}{\addplot@tbl@error@cur@x}%
	\fi
	\ifx\pgfplots@plot@tbl@error@y\pgfutil@empty
		\ifx\pgfplots@plot@tbl@error@yindex\pgfutil@empty
			\let\addplot@tbl@error@cur@y=\pgfutil@empty
		\else
			\pgfplotstablereadgetvalueofcolindex{\pgfplots@plot@tbl@error@yindex}{\addplot@tbl@error@cur@y}%
		\fi
	\else
		\pgfplotstablereadgetvalueofcolname{\pgfplots@plot@tbl@error@y}{\addplot@tbl@error@cur@y}%
	\fi
		...
		\else
			...
			\xdef\pgfplots@glob@TMPa{%
				...
				{% precommand:
					...
					\noexpand\pgfkeys{/tikz/current plot style/.style={\the\t@pgfplots@toka}}%
...
\def\pgfplots@checkisuniformLINEARtick#1{%
	...
	\endgroup
	\expandafter\let\csname pgfplots@tick@distance@#1\endcsname=\pgfplots@glob@TMPa
}
...
\long\def\pgfplots@evalute@tikz@coord@system@interface#1,#2\pgfplots@coord@end{%
	...
	\xdef\pgfplots@glob@TMPa{\pgfplots@evaluate@tikz@coord@x pt}%
	\xdef\pgfplots@glob@TMPb{\pgfmathresult pt}%
	\endgroup
	\pgfpointxy{\pgfplots@glob@TMPa}{\pgfplots@glob@TMPb}%
}
