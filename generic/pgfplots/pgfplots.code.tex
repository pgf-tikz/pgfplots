...
\def\pgfplots@addplotimpl@f#1file{%
...
%\pgfplots@message{I have computed H=\Hmacro}%
		...
		\or
			...
			\pgfmathmultiply@{\Hmacro}{\reciproc@logten}%
...
%\pgfplots@message{final H=\pgf@sys@tonumber{\H} * log(10)}%
			...
			\expandafter\MIN\reciproc@logten\MIN\relax
...
\def\pgfplots@preset@keys{%
	...
	% 	ymajorgrids=false,
	% 	scaled ticks=true,
	% 	tick scale labels=\axisdefaulttickscalelabel,
