...
\newdimen\pgfplots@xtickmin@reg
\newdimen\pgfplots@xtickmax@reg
\newdimen\pgfplots@ytickmin@reg
\newdimen\pgfplots@ytickmax@reg
\newdimen\pgfplots@ztickmin@reg
\newdimen\pgfplots@ztickmax@reg
...
% axis options:
	...
	/pgfplots/domain/.code={\def\pgfplots@prefer@domain@over@samplesat{1}\pgfkeysalso{/tikz/domain={#1}}},
	/pgfplots/samples at/.code={\def\pgfplots@prefer@domain@over@samplesat{0}\pgfkeysalso{/tikz/samples at={#1}}},
	...
	/pgfplots/samples/.belongs to family=/pgfplots,
	/pgfplots/samples/.code={\pgfkeysalso{/tikz/samples={#1}}},
...
\def\pgfplots@prefer@domain@over@samplesat{1}
...
\def\pgfplots@handle@invalid@range{%
	...
	\fi
	\gdef\pgfplots@xtickmin{\pgfplots@xmin}%
...
%\message{x = [\pgfplots@xmin:\pgfplots@xmax]  y = [\pgfplots@ymin:\pgfplots@ymax]}%
	...
	\fi
	%
	% Set default values for tick min/max if not specified
	% At this point we know the min and max of the axis (manual or auto)
	\ifx\pgfplots@xtickmin\pgfutil@empty
		\global\let\pgfplots@xtickmin=\pgfplots@xmin
	\fi
	\ifx\pgfplots@xtickmax\pgfutil@empty
		\global\let\pgfplots@xtickmax=\pgfplots@xmax
	\fi
	\ifx\pgfplots@ytickmin\pgfutil@empty
		\global\let\pgfplots@ytickmin=\pgfplots@ymin
	\fi
	\ifx\pgfplots@ytickmax\pgfutil@empty
		\global\let\pgfplots@ytickmax=\pgfplots@ymax
	\fi
	\ifx\pgfplots@ztickmin\pgfutil@empty
		\global\let\pgfplots@ztickmin=\pgfplots@zmin
	\fi
	\ifx\pgfplots@ztickmax\pgfutil@empty
		\global\let\pgfplots@ztickmax=\pgfplots@zmax
	\fi
	%
	\pgfplots@initsizes
	%
...
\def\pgfplots@initsizes{%
	...
	\fi
	\pgfplots@xtickmin@reg=\pgfplots@xtickmin pt %
	\pgfplots@xtickmax@reg=\pgfplots@xtickmax pt %
	\pgfplots@ytickmin@reg=\pgfplots@ytickmin pt %
	\pgfplots@ytickmax@reg=\pgfplots@ytickmax pt %
	\ifpgfplots@threedim
		\pgfplots@ztickmin@reg=\pgfplots@ztickmin pt %
		\pgfplots@ztickmax@reg=\pgfplots@ztickmax pt %
	\fi
	%
	\pgfpointdiff
...
\def\pgfplots@set@options#1{%
	...
	\pgfkeys{%
		...
		/tikz/samples/.belongs to family=/pgfplots,
		%
		%
...
%\message{every axis is now '\meaning\pgfplots@loc@TMPa'}%
	...
	\global\pgfkeysgetvalue{/pgfplots/xtickmin}{\pgfplots@xtickmin}%
	\global\pgfkeysgetvalue{/pgfplots/xtickmax}{\pgfplots@xtickmax}%
	\global\pgfkeysgetvalue{/pgfplots/ytickmin}{\pgfplots@ytickmin}%
	\global\pgfkeysgetvalue{/pgfplots/ytickmax}{\pgfplots@ytickmax}%
	\global\pgfkeysgetvalue{/pgfplots/ztickmin}{\pgfplots@ztickmin}%
	\global\pgfkeysgetvalue{/pgfplots/ztickmax}{\pgfplots@ztickmax}%
	%
