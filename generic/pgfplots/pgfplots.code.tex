...
\def\pgfplots@set@options#1{%
	...
	%
	% FIXME : the 'descriptions' family can be eliminated. It is only
	% useful to provide 'title' inside of 'every axis title' -- which
	% is not intuitive anyway.
