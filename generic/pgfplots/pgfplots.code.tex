...
% FIXME: simplify this code! It is just a replication of the default error stuff together with an xshift!
	...
	/pgfplots/mesh/surf mode/.is choice,
	/pgfplots/mesh/surf mode/flat corner/.code={\def\pgfplotsplothandlermesh@surfmode{0}},
	/pgfplots/mesh/surf mode/flat mean/.code={\def\pgfplotsplothandlermesh@surfmode{1}},
	/pgfplots/mesh/surf mode/surf/.code={\def\pgfplotsplothandlermesh@surfmode{2}},
	/pgfplots/mesh/surf mode/flat mean,
	/pgfplots/mesh/z buffer/.is choice,%
	/pgfplots/mesh/z buffer/none/.code={\def\pgfplotsplothandlermesh@zbuffer@choice{0}},%
	/pgfplots/mesh/z buffer/reverse x seq/.code={\def\pgfplotsplothandlermesh@zbuffer@choice{1}},%
	/pgfplots/mesh/z buffer/reverse y seq/.code={\def\pgfplotsplothandlermesh@zbuffer@choice{2}},%
	/pgfplots/mesh/z buffer/reverse xy seq/.code={\def\pgfplotsplothandlermesh@zbuffer@choice{3}},%
	/pgfplots/mesh/z buffer/reverse xy seq,%
	/pgfplots/surf/.code={%
		\pgfkeysalso{/pgfplots/mesh=#1,/tikz/draw=mapped color,/tikz/fill=mapped color}%
	},%
