...
% axis options:
	...
	/pgfplots/samples 2/.initial=,% empty -> use the same as 'samples'. For use in mesh plots.
...
% FIXME: simplify this code! It is just a replication of the default error stuff together with an xshift!
	...
	/pgfplots/mesh/flat mode/.is choice,
	/pgfplots/mesh/flat mode/corner/.code={\def\pgfplotsplothandlermesh@flatmode{0}},
	/pgfplots/mesh/flat mode/mean/.code={\def\pgfplotsplothandlermesh@flatmode{1}},
	/pgfplots/mesh/flat mode/mean,
	/pgfplots/surf/.code={%
