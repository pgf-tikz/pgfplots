...
\def\pgfplots@clippath@prepare{%
	\def\pgfplots@clippath@use{clip}%
	\ifpgfplots@threedim
		...
		\def\pgfplots@clippath@install{%
			...
			\pgfpathclose
			\expandafter\pgfusepath\expandafter{\pgfplots@clippath@use}%
		}%
	\else
		\pgfplotsqpointxy{\pgfplots@xmin}{\pgfplots@ymin}%
...
\def\pgfplotspointbb@assertvaluesexist{%
	\ifx\pgfplotspoint@bb@@@\relax
		...
		\scope
		\def\pgfplots@clippath@use{discard}%
		\pgfplots@clippath@install
		\xdef\pgfplots@glob@TMPa{{\the\pgf@picminx}{\the\pgf@picmaxx}{\the\pgf@picminy}{\the\pgf@picmaxy}}%
		\endscope
...
% Point commands which expand to the bounding box of the 
\def\pgfplotspointbblowerleft{%
	\pgfplotspointbb@assertvaluesexist
	\expandafter\pgfplotspoint@bb@lowerleft@\pgfplotspoint@bb@@@
}%
\def\pgfplotspointbbupperright{%
	\pgfplotspointbb@assertvaluesexist
	\expandafter\pgfplotspoint@bb@upperright@\pgfplotspoint@bb@@@
}%
