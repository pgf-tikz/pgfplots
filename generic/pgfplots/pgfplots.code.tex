		...
		\foreach \y in {#1} {	
			...
			\ifpgfplots@needsminorloop
				\foreach \i in {1,...,9} {
					...
					\ifpgfplots@yminorgrids
						\pgfplots@drawyaxis@placecomputedgridline[every axis grid,every minor grid]%
					\fi
					\ifpgfplots@yminorticks
						\pgfplots@drawyaxis@placecomputedtick\pgfplots@subtickwidth[every tick,every minor tick]%
					\fi
				}%
			\fi
			\ifpgfplots@ymajorgrids
				\pgfplots@drawyaxis@placecomputedgridline[every axis grid,every major grid]%
			\fi
			\ifpgfplots@ymajorticks
				\pgfplots@drawyaxis@placecomputedtick\pgfplots@tickwidth[every tick,every major tick]%
			\fi
			\endscope
		}%
	\fi
		...
		\foreach \x in {#1} {	
			...
			\ifpgfplots@needsminorloop
				\foreach \i in {1,...,9} {
					...
					\fi
					\ifpgfplots@xminorticks
						\pgfplots@drawxaxis@placecomputedtick\pgfplots@subtickwidth[every tick,every minor tick]%
					\fi
				}%
			\fi
			\ifpgfplots@xmajorgrids
				\pgfplots@drawxaxis@placecomputedgridline[every axis grid,every major grid]%
			\fi
			\ifpgfplots@xmajorticks
				\pgfplots@drawxaxis@placecomputedtick\pgfplots@tickwidth[every tick,every major tick]%
			\fi
			\endscope
		}%
	\fi
