...
\def\pgfplots@axis@equal@apply@for#1{%
	...
	\else
		...
		\fi
	\fi
	\pgfplots@letcsname pgfplots@#1@veclength={pgfplots@\pgfplots@axis@equal@apply@reference @veclength}%
	\pgfplots@letcsname pgfplots@#1@inverseveclength={pgfplots@\pgfplots@axis@equal@apply@reference @inverseveclength}%
	%
	%
	...
	\else
		...
		% 
% \message{REsizing data range for #1: from \csname pgfplots@#1min\endcsname:\csname pgfplots@#1max\endcsname\ to}%
		\pgfmathsubtract@{\csname pgfplots@#1max\endcsname}{\csname pgfplots@#1min\endcsname}%
		\begingroup
			\pgf@xa=\pgfmathresult pt
			\pgf@xa=\pgfplots@glob@TMPb \pgf@xa
			\divide\pgf@xa by2
