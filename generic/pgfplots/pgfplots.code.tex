...
% legend options:
	...
	/pgfplots/legend pos/outer north east/.style={/pgfplots/every axis legend/.style={at={(1.03,1)},anchor=north east}},
	...
	\ifx\pgfplots@already@computed@legend@node\pgfutil@empty
		...
		\begingroup
			...
			\ifnum0<\pgfplots@numplots\relax
				...
				\fi
			\pgfutil@repeat
			\t@pgfplots@tokb={\matrix[%
				% if someone tries to append something to legend style while
				% the legend is being processed, this here simply sets
				% these options.
				% This does also enable using 'legend pos' inside of
				% 'legend style'.
				/pgfplots/every axis legend/.append style/.code={\pgfkeysalso{##1}},%
				%/pgfplots/every axis legend/.show code,%
...
%\pgfkeys{/pgfplots/every axis legend/.show code}%
