...
\newcount\pgfplots@xtickalignnum
\newcount\pgfplots@ytickalignnum
\newcount\pgfplots@xtickposnum
\newcount\pgfplots@ytickposnum
\newcount\pgfplots@xaxislinesnum
\newcount\pgfplots@yaxislinesnum
\newcount\pgfplots@xaxisdiscontnum
\newcount\pgfplots@yaxisdiscontnum
...
\pgfkeys{%
	...
	/tikz/every axis/.belongs to family=/pgfplots/style commands,
	/tikz/every semilogx axis/.style={},
	/tikz/every semilogx axis/.belongs to family=/pgfplots/style commands,
	/tikz/every semilogy axis/.style={},
	/tikz/every semilogy axis/.belongs to family=/pgfplots/style commands,
	/tikz/every loglog axis/.style={},
	/tikz/every loglog axis/.belongs to family=/pgfplots/style commands,
	/tikz/every linear axis/.style={},
	/tikz/every linear axis/.belongs to family=/pgfplots/style commands,
	/tikz/every axis plot/.style={},
	/tikz/every axis plot/.belongs to family=/pgfplots/style commands,
	/tikz/every axis label/.style={},
	/tikz/every axis label/.belongs to family=/pgfplots/style commands,
	/tikz/every axis x label/.style={at={(0.5,0)},below,yshift=-15pt},
	/tikz/every axis x label/.belongs to family=/pgfplots/style commands,
	/tikz/every axis y label/.style={at={(0,0.5)},xshift=-35pt,rotate=90},
	/tikz/every axis y label/.belongs to family=/pgfplots/style commands,
	/tikz/every axis title/.style={at={(0.5,1)},above,yshift=6pt},
	/tikz/every axis title/.belongs to family=/pgfplots/style commands,
	/tikz/every tick/.style={very thin,gray},
	/tikz/every tick/.belongs to family=/pgfplots/style commands,
	/tikz/every minor tick/.style={},
	/tikz/every minor tick/.belongs to family=/pgfplots/style commands,
	/tikz/every major tick/.style={},
	/tikz/every major tick/.belongs to family=/pgfplots/style commands,
	/tikz/every x tick/.style={},
	/tikz/every x tick/.belongs to family=/pgfplots/style commands,
	/tikz/every minor x tick/.style={},
	/tikz/every minor x tick/.belongs to family=/pgfplots/style commands,
	/tikz/every major x tick/.style={},
	/tikz/every major x tick/.belongs to family=/pgfplots/style commands,
	/tikz/every y tick/.style={},
	/tikz/every y tick/.belongs to family=/pgfplots/style commands,
	/tikz/every minor y tick/.style={},
	/tikz/every minor y tick/.belongs to family=/pgfplots/style commands,
	/tikz/every major y tick/.style={},
	/tikz/every major y tick/.belongs to family=/pgfplots/style commands,
	/tikz/every axis grid/.style={help lines},
	/tikz/every axis grid/.belongs to family=/pgfplots/style commands,
	/tikz/every minor grid/.style={},
	/tikz/every minor grid/.belongs to family=/pgfplots/style commands,
	/tikz/every major grid/.style={},
	/tikz/every major grid/.belongs to family=/pgfplots/style commands,
	/tikz/every axis x grid/.style={},
	/tikz/every axis x grid/.belongs to family=/pgfplots/style commands,
	/tikz/every minor x grid/.style={},
	/tikz/every minor x grid/.belongs to family=/pgfplots/style commands,
	/tikz/every major x grid/.style={},
	/tikz/every major x grid/.belongs to family=/pgfplots/style commands,
	/tikz/every axis y grid/.style={},
	/tikz/every axis y grid/.belongs to family=/pgfplots/style commands,
	/tikz/every minor y grid/.style={},
	/tikz/every minor y grid/.belongs to family=/pgfplots/style commands,
	/tikz/every major y grid/.style={},
	/tikz/every major y grid/.belongs to family=/pgfplots/style commands,
	/tikz/every tick label/.style={},
	/tikz/every tick label/.belongs to family=/pgfplots/style commands,
	/tikz/every x tick label/.style={},
	/tikz/every x tick label/.belongs to family=/pgfplots/style commands,
	/tikz/every extra x tick/.style={},
	/tikz/every extra x tick/.belongs to family=/pgfplots/style commands,
...
% both=2
	...
	/pgfplots/tickpos/left/.code	={\pgfplots@tickposnum=0\pgfplots@xtickposnum=1\pgfplots@ytickposnum=1},
	/pgfplots/tickpos/left/.belongs to family=/pgfplots/tick,
	/pgfplots/tickpos/right/.code	={\pgfplots@tickposnum=1\pgfplots@xtickposnum=3\pgfplots@ytickposnum=3},
	/pgfplots/tickpos/right/.belongs to family=/pgfplots/tick,
	/pgfplots/tickpos/both/.code	={\pgfplots@tickposnum=2\pgfplots@xtickposnum=0\pgfplots@ytickposnum=0},
...
% center=2
	...
	/pgfplots/tick align/inside/.code	={\pgfplots@xtickalignnum=0\pgfplots@ytickalignnum=0},
	/pgfplots/tick align/inside/.belongs to family=/pgfplots/tick,
	/pgfplots/tick align/outside/.code	={\pgfplots@xtickalignnum=1\pgfplots@ytickalignnum=1},
	/pgfplots/tick align/outside/.belongs to family=/pgfplots/tick,
	/pgfplots/tick align/center/.code	={\pgfplots@xtickalignnum=2\pgfplots@ytickalignnum=2},
...
% top=3
	...
	/pgfplots/axis x line/box/.code	={\pgfplots@xaxislinesnum=0\pgfplots@xtickposnum=0},
	/pgfplots/axis x line/box/.belongs to family=/pgfplots, %/axis,
	/pgfplots/axis x line/bottom/.code	={\pgfplots@xaxislinesnum=1\pgfplots@xtickposnum=1},
	/pgfplots/axis x line/bottom/.belongs to family=/pgfplots, %/axis,
	/pgfplots/axis x line/middle/.code	={\pgfplots@xaxislinesnum=2\pgfplots@xtickposnum=2},
	/pgfplots/axis x line/middle/.belongs to family=/pgfplots, %/axis,
	/pgfplots/axis x line/top/.code	={\pgfplots@xaxislinesnum=3\pgfplots@xtickposnum=3},
	/pgfplots/axis x line/top/.belongs to family=/pgfplots, %/axis,
	/pgfplots/axis x line/none/.code	={\pgfplots@xaxislinesnum=4\pgfplots@xtickposnum=4},
...
% right=3
	...
	/pgfplots/axis y line/box/.code	={\pgfplots@yaxislinesnum=0\pgfplots@ytickposnum=0},
	/pgfplots/axis y line/box/.belongs to family=/pgfplots, %/axis,
	/pgfplots/axis y line/left/.code	={\pgfplots@yaxislinesnum=1\pgfplots@ytickposnum=1},
	/pgfplots/axis y line/left/.belongs to family=/pgfplots, %/axis,
	/pgfplots/axis y line/center/.code	={\pgfplots@yaxislinesnum=2\pgfplots@ytickposnum=2},
	/pgfplots/axis y line/center/.belongs to family=/pgfplots, %/axis,
	/pgfplots/axis y line/right/.code	={\pgfplots@yaxislinesnum=3\pgfplots@ytickposnum=3},
	/pgfplots/axis y line/right/.belongs to family=/pgfplots, %/axis,
	/pgfplots/axis y line/none/.code	={\pgfplots@yaxislinesnum=4\pgfplots@ytickposnum=4},
...
% open = 2
	...
	/pgfplots/axis x discontinuity/none/.code	={\pgfplots@xaxisdiscontnum=0},
	/pgfplots/axis x discontinuity/none/.belongs to family=/pgfplots, %/axis,
	/pgfplots/axis x discontinuity/crunch/.code	={\pgfplots@xaxisdiscontnum=1},
	/pgfplots/axis x discontinuity/crunch/.belongs to family=/pgfplots, %/axis,
	/pgfplots/axis x discontinuity/parallel/.code	={\pgfplots@xaxisdiscontnum=2},
...
% open = 2
	...
	/pgfplots/axis y discontinuity/none/.code	={\pgfplots@yaxisdiscontnum=0},
	/pgfplots/axis y discontinuity/none/.belongs to family=/pgfplots, %/axis,
	/pgfplots/axis y discontinuity/crunch/.code	={\pgfplots@yaxisdiscontnum=1},
	/pgfplots/axis y discontinuity/crunch/.belongs to family=/pgfplots, %/axis,
	/pgfplots/axis y discontinuity/parallel/.code	={\pgfplots@yaxisdiscontnum=2},
...
% log=1
	...
	/pgfplots/error bars/error bar style/.code={%
		\pgfkeysalso{/tikz/every error bar/.append style={#1}}%
	},
	/tikz/every error bar/.style={thin},
...
\def\pgfplots@drawyaxis@placecomputedtick#1[#2]{%
	...
	\or
		(\pgfplots@xcoordminTEX-\pgfplots@ytick@offset, \pgfplots@tmpa) -- ++( #1, 0pt)
	\or
		(                      -\pgfplots@ytick@offset, \pgfplots@tmpa) -- ++( #1, 0pt)
	\or
		(\pgfplots@xcoordmaxTEX+\pgfplots@ytick@offset, \pgfplots@tmpa)	-- ++(-#1, 0pt)
	\fi
	;
			...
			\ifpgfplots@needsminorloop
				\foreach \i in {1,...,9} {
					...
					\else
						...
						\else
							\ifpgfplots@yminorgrids
								\pgfplots@drawyaxis@placecomputedgridline[every axis grid,every minor grid,every axis y grid,every minor y grid]%
							\fi
							\ifpgfplots@yminorticks
								\pgfplots@drawyaxis@placecomputedtick\pgfplots@subtickwidth[every tick,every minor tick,every tick,every minor y tick]%
							\fi
						\fi
					\fi
				}%
			...
			\else
				...
				\else
					\ifpgfplots@ymajorgrids
						\pgfplots@drawyaxis@placecomputedgridline[every axis grid,every major grid, every axis y grid,every major y grid]%
					\fi
					\ifpgfplots@ymajorticks
						\pgfplots@drawyaxis@placecomputedtick\pgfplots@tickwidth[every tick,every major tick,every y tick,every major y tick]%
					\fi
				\fi
			\fi
			\endscope
...
\def\pgfplots@drawxaxis@placecomputedtick#1[#2]{%
	...
	\or
		(\pgfplots@tmpa, \pgfplots@ycoordminTEX-\pgfplots@xtick@offset) -- ++(0pt, #1)
	\or
		(\pgfplots@tmpa, 0pt                   -\pgfplots@xtick@offset) -- ++(0pt, #1)
	\or
		(\pgfplots@tmpa, \pgfplots@ycoordmaxTEX+\pgfplots@xtick@offset) -- ++(0pt,-#1)
	\fi
	;
...
\def\pgfplots@drawaxis@innerlines{%
	\ifnum\pgfplots@yaxislinesnum=2
		\draw[decorate,ydiscont,decoration={pre length=\ydisstart, post length=\ydisend}] (0pt,	\pgfplots@ycoordminTEX) -- (0pt,	\pgfplots@ycoordmaxTEX);
	\fi
	\ifnum\pgfplots@xaxislinesnum=2
		\draw[decorate,xdiscont,decoration={pre length=\xdisstart, post length=\xdisend}] (\pgfplots@xcoordminTEX, 0pt) -- (\pgfplots@xcoordmaxTEX, 0pt);
	\fi
}%
...
\def\pgfplots@drawaxis@lines{%
	...
	\ifcase\pgfplots@yaxisdiscontnum
		\tikzstyle{ydiscont}=[]
	\or
		\tikzstyle{ydiscont}=[decoration={zigzag,segment length=12pt, amplitude=4pt}]
		\advance \ydisend by -16pt
	\or
		\tikzstyle{ydiscont}=[decoration={ticks,segment length=4pt, amplitude=8pt}]
		\advance \ydisend by -8pt
	\fi
	\ifnum\pgfplots@ycoordmaxTEX<0
		\ydisstart=\ydisend
		\ydisend=4pt
	\else
		\ydisstart=4pt
	...
	\ifcase\pgfplots@xaxisdiscontnum
		\tikzstyle{xdiscont}=[]
	\or
		\tikzstyle{xdiscont}=[decoration={zigzag,segment length=12pt, amplitude=4pt}]
	\or
		\tikzstyle{xdiscont}=[decoration={ticks,segment length=4pt, amplitude=8pt}]
		\advance \xdisend by -8pt
	\fi
	\ifnum\pgfplots@xcoordmaxTEX<0
		\xdisstart=\xdisend
		\xdisend=4pt
	\else
		\xdisstart=4pt
			...
			\else
				...
				\else
					...
					\ifnum\pgfplots@xtickposnum=3
						\node at 
							(\pgfplots@tmpa,\pgfplots@xtick@origin+\pgfplots@xtick@offset)
							[above,every tick label,every x tick label]
							{\pgfplots@show@xticklabel\axisticknum\x};
					\else
						\node at 
							(\pgfplots@tmpa,\pgfplots@xtick@origin-\pgfplots@xtick@offset)
							[below,every tick label,every x tick label]
							{\pgfplots@show@xticklabel\axisticknum\x};
					\fi
				\fi
			\fi
			...
			\ifpgfplots@needsminorloop
				\foreach \i in {1,...,9} {
					...
					\else
						...
						\else
							\ifpgfplots@xminorgrids
								\pgfplots@drawxaxis@placecomputedgridline[every axis grid,every minor grid]%
							\fi
							\ifpgfplots@xminorticks
								\pgfplots@drawxaxis@placecomputedtick\pgfplots@subtickwidth[every tick,every minor tick,every x tick,every minor x tick]%
							\fi
						\fi
					\fi
				}%
			...
			\else
				...
				\else
					\ifpgfplots@xmajorgrids
						\pgfplots@drawxaxis@placecomputedgridline[every axis grid,every major grid,every axis x grid,every major x grid]%
					\fi
					\ifpgfplots@xmajorticks
						\pgfplots@drawxaxis@placecomputedtick\pgfplots@tickwidth[every tick,every major tick, every x tick,every major x tick]%
					\fi
				\fi
			\fi
			\endscope
...
\long\def\pgfplots@addplotimpl@expression#1#2;{%
	\global\pgfplots@EMERGENCY@FORCE@DATA@TRAFO@TO@IDENTITYtrue
	\pgfplots@addplotimpl@expression@limits{#1}%
	\pgfplots@addplot@enqueue@coords{}{}{\draw[every axis plot,#1] plot #2;}{}%
	\pgfplots@end@plot
}%
...
\long\def\pgfplots@addplotimpl@table@START#1#2#3#4;{%
	...
	\ifpgfplots@addplot@table@from@macro
		\pgfnumtablecopy#3\to\pgfplots@table
	\else
		\pgfnumtableread{#3} to \pgfplots@table
	\fi
	\ifx\pgfplots@plot@tbl@x\pgfutil@empty
		\pgfnumtablegetcolumnbyindex\pgfplots@plot@tbl@xindex\of\pgfplots@table\to\addplot@tbl@x
	\else
		\pgfnumtablegetcolumnbyname\pgfplots@plot@tbl@x\of\pgfplots@table\to\addplot@tbl@x
	\fi
	\ifx\pgfplots@plot@tbl@y\pgfutil@empty
		\pgfnumtablegetcolumnbyindex\pgfplots@plot@tbl@yindex\of\pgfplots@table\to\addplot@tbl@y
	\else
		\pgfnumtablegetcolumnbyname\pgfplots@plot@tbl@y\of\pgfplots@table\to\addplot@tbl@y
	\fi
	%
	\ifpgfplots@errorbars@enabled
		\let\addplot@tbl@error@x=\pgfutil@empty
		\let\addplot@tbl@error@y=\pgfutil@empty
		\pgfkeysgetvalue{/pgfplots/numeric table/x error index}\pgfplots@plot@tbl@error@xindex
		\pgfkeysgetvalue{/pgfplots/numeric table/x error}\pgfplots@plot@tbl@error@x
		\pgfkeysgetvalue{/pgfplots/numeric table/y error index}\pgfplots@plot@tbl@error@yindex
		\pgfkeysgetvalue{/pgfplots/numeric table/y error}\pgfplots@plot@tbl@error@y
		\ifx\pgfplots@plot@tbl@error@x\pgfutil@empty
			\ifx\pgfplots@plot@tbl@error@xindex\pgfutil@empty
			\else
				\pgfnumtablegetcolumnbyindex\pgfplots@plot@tbl@error@xindex\of\pgfplots@table\to\addplot@tbl@error@x
			\fi
		\else
			\pgfnumtablegetcolumnbyname\pgfplots@plot@tbl@error@x\of\pgfplots@table\to\addplot@tbl@error@x
		\fi
		\ifx\pgfplots@plot@tbl@error@y\pgfutil@empty
			\ifx\pgfplots@plot@tbl@error@yindex\pgfutil@empty
			\else
				\pgfnumtablegetcolumnbyindex\pgfplots@plot@tbl@error@yindex\of\pgfplots@table\to\addplot@tbl@error@y
			\fi
		\else
			\pgfnumtablegetcolumnbyname\pgfplots@plot@tbl@error@y\of\pgfplots@table\to\addplot@tbl@error@y
		\fi
	\fi
	%
	\pgfplots@PREPARE@COORD@STREAMS{#1}{#4}%
...
% #3:  any trailing path commands after the 'plot' command as such,
%      for example \addplot plot coordinates {...} -- (0,0);
%      would yield #3 =' -- (0,0)'
%
\long\def\pgfplots@PREPARE@COORD@STREAMS#1#2{%
	\ifpgfplots@errorbars@enabled
	...
	\ifpgfplots@filtercoords
		\pgfplots@coord@stream@INIT@process@filtered\pgfplots@coord@stream@recorded
	\else
		\ifpgfplots@draw@at@end
			\pgfplots@coord@stream@INIT@updatelimits
		\else
			\pgfplots@coord@stream@INIT@recorder
		\fi
	\fi
	...
	\def\pgfplots@coord@stream@end@@{%
		...
		% \tikzset{#1}
		\edef\pgfplots@TMP{every axis plot,every axis plot no \the\pgfplots@numplots/.try}%
		\pgfplotslist@TOK@a=\expandafter{\pgfplots@TMP,#1}%
...
%\pgfplots@message{processing plots coords with trailing path '#3'}%
	\pgfplots@PREPARE@COORD@STREAMS{#1}{#3}%
...
% #3= error for x coord (or empty)
% #4= error for y coord (or empty)
\def\pgfplots@filter@one@coord@pair#1#2#3#4{%
	...
	\else
		...
		\else
			\let\pgfplots@errorspec=\pgfutil@empty
			\ifpgfplots@draw@at@end
				...
				\ifpgfplots@errorbars@enabled
					\ifpgfplots@float@numerics@mode
						% store errors until later. Needs much more work... :-(
						\edef\pgfplots@errorspec{+-(#3,#4)}% doesn't hurt if they are empty
					\else
						\pgfplots@process@errorbar@for{\pgfplots@filter@tmp@x}{\pgfplots@filter@tmp@y}{#3}{#4}%
					\fi
				\fi
			\else
			...
			\edef\pgfplots@coord@stream@recorded{\the\pgfplots@toka (\pgfplots@filter@tmp@x,\pgfplots@filter@tmp@y)\pgfplots@errorspec}%
%\pgfplots@message{FILTERING: appended \pgfplots@filter@tmp@x,\pgfplots@filter@tmp@y}%  -> results in \pgfplots@coord@stream@recorded}%
		\fi
	\fi
}
...
\def\pgfplots@coord@stream@INIT@process@filtered#1{%
	\def\pgfplots@coord@stream@start{%
		\let\pgfplots@coord@stream@recorded=\pgfutil@empty
	}%
	\def\pgfplots@coord@stream@end{%
		\edef#1{plot coordinates {\pgfplots@coord@stream@recorded}}%
	}%
	\let\pgfplots@coord@stream@coord=\pgfplots@filter@one@coord@pair
}

% Initialises a coordinate stream which simply collects each point
% into \pgfplots@coord@stream@recorded
% and updates any axis limits on the fly.
\def\pgfplots@coord@stream@INIT@updatelimits{%
	\def\pgfplots@coord@stream@start{%
		\let\pgfplots@coord@stream@recorded=\pgfutil@empty
	}%
	\def\pgfplots@coord@stream@coord##1##2##3##4{%
		\expandafter\def\expandafter\pgfplots@coord@stream@recorded\expandafter{\pgfplots@coord@stream@recorded (##1,##2)}%
		\pgfplots@update@limits@for@one@point{##1}{##2}{##3}{##4}%
		\ifpgfplots@errorbars@enabled
			\pgfplots@process@errorbar@for{##1}{##2}{##3}{##4}%
		\fi
	}%
	\def\pgfplots@coord@stream@end{%
		\edef\pgfplots@coord@stream@recorded{plot coordinates {\pgfplots@coord@stream@recorded}}%
	}%
}

% Initialises a coordinate stream which collects each input point into
% \pgfplots@coord@stream@recorded.
\def\pgfplots@coord@stream@INIT@recorder{%
	\def\pgfplots@coord@stream@start{%
		\let\pgfplots@coord@stream@recorded=\pgfutil@empty
	}%
	\def\pgfplots@coord@stream@end{%
...
%\message{PROCESSING PLOT COORDS '#2' to call \meaning\pgfplots@foreach@plot@coord@do@CMD}%
...
\def\pgfplots@process@errorbar@for#1#2#3#4{%
%	\begingroup
	...
	\or
		\pgfplots@process@errorbar@@for{x}{+}%
	\or
		\pgfplots@process@errorbar@@for{x}{-}%
	\or
		\pgfplots@process@errorbar@@for{x}{+}% FIXME : INEFFICIENT! Scaling trafo is applied twice!
		\pgfplots@process@errorbar@@for{x}{-}%
	\fi
	\ifcase\pgfplots@errorbars@ydirection
	\or
		\pgfplots@process@errorbar@@for{y}{+}%
	\or
		\pgfplots@process@errorbar@@for{y}{-}%
	\or
		\pgfplots@process@errorbar@@for{y}{+}% FIXME : INEFFICIENT! Scaling trafo is applied twice!
		\pgfplots@process@errorbar@@for{y}{-}%
	\fi
%	\endgroup
}
...
% #1: either 'x' or 'y'
% #2: either '+' or '-'
\def\pgfplots@process@errorbar@@for#1#2{%
	...
	\ifcase\csname pgfplots@#1mode\endcsname
		\ifcase\csname pgfplots@errorbars@#1mode\endcsname
			\ifpgfplots@is@datascaled
				...
				\csname pgfplots@datascaletrafo@fromfixed@#1\endcsname{\pgfplots@error@coord}%
				\let\pgfplots@error@coord=\pgfmathresult
			\else
				\edef\pgfplots@error@coord{\csname pgfplots@errorbars@#1fixed\endcsname}%
			\fi
			\pgfmathparse{\csname pgfplots@#1arg\endcsname#2 \pgfplots@error@coord}%
			\let\pgfplots@error@coord=\pgfmathresult
		\or
			\pgfmathparse{\csname pgfplots@#1arg\endcsname*(1#2\csname pgfplots@errorbars@#1rel\endcsname)}%
			\let\pgfplots@error@coord=\pgfmathresult
		\or
		...
		\or
			...
			\ifx\pgfplots@error@coord\pgfutil@empty
			\else
				\pgfmathparse{\csname pgfplots@#1arg\endcsname*(1#2 \pgfplots@error@coord)}%
				\let\pgfplots@error@coord=\pgfmathresult
			\fi
		\fi
	\or
		\ifcase\csname pgfplots@errorbars@#1mode\endcsname
			\pgfplots@error{%
				Sorry, logarithmic axis and FIXED errorbars are not supported, sorry. 
				You will need to use relative errors.}%
			\let\pgfplots@error@coord=\pgfutil@empty
		\or
			\pgfmathparse{\csname pgfplots@#1arg\endcsname + ln(1#2\csname pgfplots@errorbars@#1rel\endcsname)}%
			\let\pgfplots@error@coord=\pgfmathresult%
		\or
			\pgfplots@error{%
				Sorry, logarithmic axis and FIXED errorbars are not supported, sorry. 
		...
		\or
			...
			\ifx\pgfplots@error@coord\pgfutil@empty
			\else
				\pgfmathparse{\csname pgfplots@#1arg\endcsname + ln(1#2 \pgfplots@error@coord)}%
				\let\pgfplots@error@coord=\pgfmathresult%
			\fi
		\fi
	\fi
	...
	\ifx\pgfplots@already@computed@legend@node\pgfutil@empty
		...
		\begingroup
			...
			\ifnum0<\pgfplots@numplots\relax
				...
				\fi
			\repeat
			\pgfplotslist@TOK@b={\matrix[every axis legend]}%
			\xdef\pgfplots@TMP{%
				\the\pgfplotslist@TOK@b {%
					\the\pgfplotslist@TOK@a
				};%
...
%\pgfplots@message{Direction #1: data max order=\the\data@max@order;  data dimen order=\the\data@dimen@order. }%
	\data@SHIFT=\data@dimen@order
	\advance\data@SHIFT by-\data@max@order
	...
	\loop
	\ifpgfplots@loop@CONTINUE
		\expandafter\edef\csname pgfplots@data@scale@trafo@SHIFT@#1\endcsname{\the\data@SHIFT}%
...
%\pgfplots@message{Current trafo SHIFT for #1 direction: \the\data@SHIFT; original #1 limits: [\pgfplots@min@float:\pgfplots@max@float]; current transformed #1 limits: [\pgfplots@min@fixed:\pgfplots@max@fixed]; cancellation check max-min running...}%
		\ifdim\data@tmp<0pt
		...
		\ifdim\data@tmp<1500pt% a multiplication with '10' results in max = 15000 which is the upper limit.
			...
			\ifdim\data@dimen<100pt% I guess if max-min = O(100), we have quite good accuracy
				...
				\else
					\advance\data@SHIFT by1
					\pgfplots@loop@CONTINUEtrue
				\fi
			\fi
		\fi
	\repeat
	\xdef\pgfplots@TMP{\csname pgfplots@data@scale@trafo@SHIFT@#1\endcsname}%
	\endgroup
...
%\pgfplots@message{#1-limits after data transformation: [\csname pgfplots@#1min\endcsname:\csname pgfplots@#1max\endcsname]}%
	%
...
\def\pgfplots@prepare@coord@filtering@for#1{%
	\expandafter\ifcase\csname pgfplots@#1mode\endcsname
		...
		\ifpgfplots@float@numerics@mode
			...
			% see 
			% \pgfplots@finish@datatrafo@@generate@errorbars
...
\def\pgfplots@set@keys@from@tikz@style#1{%
	...
	\pgfqkeysfiltered{/pgfplots}{/tikz/#1}%
