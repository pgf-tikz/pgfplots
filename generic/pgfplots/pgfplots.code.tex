...
% FIXME: simplify this code! It is just a replication of the default error stuff together with an xshift!
	...
	/pgfplots/mesh/true/.code={%
		...
		\if\pgfplots@perpointmeta@choice0
			...
			\fi
		\fi
		\pgfkeysalso{/tikz/draw=mapped color,/tikz/fill=none}%
	},
	...
	/pgfplots/z buffer/reverse xy seq,%
	%
...
%
% ABOUT THE ALGORITHM:
% Given \pgfplots@view@normalvec@[xyz], we know the view direction (in 3D!).
...
\def\pgfplots@decide@which@figure@surfaces@are@drawn{%
	\ifpgfplots@threedim
		\ifdim\pgfplots@view@normalvec@x>0pt
		...
		\fi
		\ifdim\pgfplots@view@normalvec@y>0pt
		...
		\fi
		\ifdim\pgfplots@view@normalvec@z>0pt
