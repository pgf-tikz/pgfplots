...
\long\def\pgfplots@addplotimpl@table@fromfile#1#2#3#4;{%
	\begingroup
	% FIXME : the other implementation (below) is CORRECT and WORKS
	% FAST. The problem: it does not support the
	% pgfplotstable-peculiarities like 'create on use' or 'alias'!
	\pgfplotstableset{#2}%
...
\def\pgfplots@addplotimpl@table@fromfile@listener@{%
	\ifx\pgfplots@plot@tbl@x\pgfutil@empty
		\pgfplotstablereadgetcolindex{\pgfplots@plot@tbl@xindex}{\pgfplots@current@point@x}%
	\else
		\pgfplotstablereadgetcolname{\pgfplots@plot@tbl@x}{\pgfplots@current@point@x}%
	\fi
	\ifx\pgfplots@plot@tbl@y\pgfutil@empty
		\pgfplotstablereadgetcolindex{\pgfplots@plot@tbl@yindex}{\pgfplots@current@point@y}%
	\else
		\pgfplotstablereadgetcolname{\pgfplots@plot@tbl@y}{\pgfplots@current@point@y}%
	\fi
}%
\def\pgfplots@addplotimpl@table@fromfile@listener@witherrors{%
	...
	\ifx\pgfplots@plot@tbl@error@x\pgfutil@empty
		\ifx\pgfplots@plot@tbl@error@xindex\pgfutil@empty
			\let\addplot@tbl@error@cur@x=\pgfutil@empty
		\else
			\pgfplotstablereadgetcolindex{\pgfplots@plot@tbl@error@xindex}{\addplot@tbl@error@cur@x}%
		\fi
	\else
		\pgfplotstablereadgetcolname{\pgfplots@plot@tbl@error@x}{\addplot@tbl@error@cur@x}%
	\fi
	\ifx\pgfplots@plot@tbl@error@y\pgfutil@empty
		\ifx\pgfplots@plot@tbl@error@yindex\pgfutil@empty
			\let\addplot@tbl@error@cur@y=\pgfutil@empty
