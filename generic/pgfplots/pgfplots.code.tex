...
\def\pgfplots@drawyaxis@excludetick{%
	\global\pgfplots@tickshowtrue
	\ifnum\pgfplots@yaxislinesnum=2
		\ifnum\pgfplots@xaxislinesnum=0
			\ifdim\pgfplots@tmpa=\pgfplots@ycoordminTEX
				\global\pgfplots@tickshowfalse
			\fi
			\ifdim\pgfplots@tmpa=\pgfplots@ycoordmaxTEX
				\global\pgfplots@tickshowfalse
			\fi
		\fi
		\ifnum\pgfplots@xaxislinesnum=1
			\ifdim\pgfplots@tmpa=\pgfplots@ycoordminTEX
				\global\pgfplots@tickshowfalse
			\fi
		\fi
		\ifnum\pgfplots@xaxislinesnum=2 %Does not work
%			\ifnum\pgfplots@tmpa=\pgfplots@ZERO@y
%				\global\pgfplots@tickshowfalse
%			\fi
		\fi
		\ifnum\pgfplots@xaxislinesnum=3
			\ifdim\pgfplots@tmpa=\pgfplots@ycoordmaxTEX
				\global\pgfplots@tickshowfalse
			\fi
		\fi
...
\def\pgfplots@drawyaxis@placecomputedtick#1[#2]{%
	...
	\fi
	\pgfplots@drawyaxis@excludetick
	\ifpgfplots@tickshow
		\draw[#2]
...
\def\pgfplots@drawxaxis@excludetick{%
	\pgfplots@tickshowtrue
	\ifnum\pgfplots@xaxislinesnum=2
		\ifnum\pgfplots@yaxislinesnum=0
			\ifnum\pgfplots@tmpa=\pgfplots@xcoordminTEX
				\global\pgfplots@tickshowfalse
			\fi
			\ifnum\pgfplots@tmpa=\pgfplots@xcoordmaxTEX
				\global\pgfplots@tickshowfalse
			\fi
		\fi
		\ifnum\pgfplots@yaxislinesnum=1
			\ifnum\pgfplots@tmpa=\pgfplots@xcoordminTEX
				\global\pgfplots@tickshowfalse
			\fi
		\fi
		\ifnum\pgfplots@yaxislinesnum=2 %Does not work
%			\ifnum\pgfplots@tmpa=\pgfplots@ZERO@x
%				\global\pgfplots@tickshowfalse
%			\fi
		\fi
		\ifnum\pgfplots@yaxislinesnum=3
			\ifnum\pgfplots@tmpa=\pgfplots@xcoordmaxTEX
				\global\pgfplots@tickshowfalse
			\fi
		\fi
...
\def\pgfplots@drawxaxis@placecomputedtick#1[#2]{%
	...
	\fi
	\pgfplots@drawxaxis@excludetick
	\ifpgfplots@tickshow
		\draw[#2]
...
\def\pgfplots@invoke@xfilter#1{%
	\pgfkeysvalueof{/pgfplots/x filter/.@cmd}#1\pgfeov%
}%
\def\pgfplots@invoke@yfilter#1{%
	\pgfkeysvalueof{/pgfplots/y filter/.@cmd}#1\pgfeov%
}%
...
\def\pgfplots@process@one@point#1#2#3#4{%
	...
	\expandafter\pgfplots@invoke@xfilter\expandafter{\pgfmathresult}%
	\let\pgfplots@current@point@x=\pgfmathresult
	%
	\pgfplots@prepare@ycoord{#2}%
	\expandafter\pgfplots@invoke@yfilter\expandafter{\pgfmathresult}%
	\let\pgfplots@current@point@y=\pgfmathresult
	%
...
\def\pgfplots@determinedefaultvalues{%
	...
	\ifpgfplots@xislinear
		\ifnum\pgfplots@minor@xtick@num=0\relax
			...
			\else
				\pgfplots@xminortickstrue
				\let\pgfplots@minor@xtick@num=\pgfplots@minor@tick@num
			\fi
		\fi
	\fi
	\ifpgfplots@yislinear
		\ifnum\pgfplots@minor@ytick@num=0\relax
			...
			\else
				\pgfplots@yminortickstrue
				\let\pgfplots@minor@ytick@num=\pgfplots@minor@tick@num
			\fi
		\fi
	\fi
	%
