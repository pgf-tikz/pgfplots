...
\long\def\pgfplotsutilforeachcommasep#1\as#2#3{%
	\long\def\pgfplotsutilforeachcommasep@do{#3}%
	\def\pgfplotsutilforeachcommasep@name{#2}%
	\pgfplotsutilforeachcommasep@parse#1,\pgfplots@EOI
}%
\def\pgfplotsutilforeachcommasep@parse{\futurelet\pgfplotsutilforeachcommasep@nexttok\pgfplotsutilforeachcommasep@checkend}%
\def\pgfplotsutilforeachcommasep@checkend{%
	\ifx\pgfplotsutilforeachcommasep@nexttok\pgfplots@EOI
		\expandafter\pgfutil@gobble
	\else
		\expandafter\pgfplotsutilforeachcommasep@next
	\fi
}%
\def\pgfplotsutilforeachcommasep@next#1,{%
	\expandafter\def\pgfplotsutilforeachcommasep@name{#1}%
	\pgfplotsutilforeachcommasep@do
	\pgfplotsutilforeachcommasep@parse
}%
