%--------------------------------------------
% $Header: /cvsroot/pgfplots/pgfplots/generic/pgfplots/util/pgfplotscolormap.code.tex,v 1.14 2009/06/11 07:13:20 ludewich Exp $
%
% Package pgfplots
%
...
\definecolor{mapped color}{rgb}{0,0,0}% make sure this color exists. It will be overwritten if needed.
