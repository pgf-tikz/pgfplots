%--------------------------------------------
% $Header: /cvsroot/pgfplots/pgfplots/generic/pgfplots/util/pgfplotscolormap.code.tex,v 1.12 2009/03/03 18:39:31 ludewich Exp $
%
% Package pgfplots
%
	...
	\pgfplotsarrayforeachungrouped{pgfpl@cm@#1}\as\cdata{%
		...
		\ifnum\c@pgf@counta>0
			...
			\ifnum\c@pgf@counta<\c@pgf@countb\relax
				...
				\multiply\pgf@xa by10 % we want [ 0 10000 ] not [0 1000] as domain
