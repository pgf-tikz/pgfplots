...
\ProvidesFileRCS[v\pgfversion] $Header: /cvsroot/pgfplots/pgfplots/generic/pgfplots/oldpgfcompatib/pgfplotsoldpgfsupp_pgflibraryplothandlers.code.tex,v 1.2 2008/05/20 11:44:30 ludewich Exp $
...
\pgfqkeys{/pgf}{%
	bar width/.store in=\pgfplotbarwidth,
	bar width=10pt,
	bar interval width/.store in=\pgfplotbarintervalwidth,
	bar interval width=1,
	bar interval shift/.store in=\pgfplotbarintervalshift,
	bar interval shift=0.5,
}
...
%
%    x_i + \pgfplotbarintervalshift * (x_{i+1} - x_i)
%
% with width
%
%    \pgfplotbarintervalwidth * (x_{i+1} - x_i).
%
...
\def\pgfplothandlerybarinterval{%
  \def\pgf@plotstreamstart{%
    ...
    \global\let\pgf@plotstreamspecial=\pgfutil@gobble%
    \global\let\pgf@plotstreamend=\pgfplotyzerolevelstreamend%
	\pgfmathparse{\pgfplotbarintervalwidth}%
	\xdef\pgfplotbarintervalwidth@{\pgfmathresult}%
	\pgfmathparse{\pgfplotbarintervalshift}%
