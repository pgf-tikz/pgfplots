...
\def\pgfplots@drawticklabels@onorientedsurf@prepareanchor#1{%
	...
	\or
		...
		\else
			...
			\def\pgfplots@loc@TMPa{}%
		\fi
		\pgfmathparse{\csname pgfplots@\pgfplotspointonorientedsurfaceB @inverseveclength\endcsname * \pgfplots@loc@TMPa \pgfkeysvalueof{/pgfplots/#1ticklabel dist}}%
		\let\pgfplots@loc@TMPa=\pgfmathresult
		\ifpgfplots@threedim
			\if0\pgfplotspointonorientedsurfaceabsetupfor@fixedsymbol
				% same as before: the N axis is on the lower axis limit.
			...
			\else
				\def\pgfplots@loc@TMPb{}%
			\fi
			\pgfmathparse{\csname pgfplots@\pgfplotspointonorientedsurfaceN @inverseveclength\endcsname * \pgfplots@loc@TMPb \pgfkeysvalueof{/pgfplots/#1ticklabel dist}}%
			\let\pgfplots@loc@TMPb=\pgfmathresult
		\else
			% z == (0,0) anyway. Use that here.
