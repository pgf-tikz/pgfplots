...
%\message{Got T^{-1}(H#1) = \Hmacro}%
		...
		\else
			...
			\pgfmathmultiply@{\Hmacro}{\csname pgfplotsmathlog#1@logten@inv\endcsname}%
...
%\message{final H=\pgf@sys@tonumber{\H} * log(10)}%
			\H=\csname pgfplotsmathlog#1@logten\endcsname\H\relax
			...
			\MIN=\csname pgfplotsmathlog#1@logten@inv\endcsname\MIN\relax
			...
			\ifdim\MIN<0pt
				...
				\advance\c@pgf@counta by-1
			\fi
			\MIN=\csname pgfplotsmathlog#1@logten\endcsname pt
			...
			\else
				...
				% 
				\ifdim\MINH<0pt
					\advance\MIN \csname pgfplotsmathlog#1@logten\endcsname pt
				\fi
			\fi
		\fi
		\MINH=\MIN
		...
		\ifdim\MAX<\pgfplots@tmpa
			...
			\H=\MAX
			\advance\H by-\MIN
			\H=\csname pgfplotsmathlog#1@logten@inv\endcsname\H
...
%\message{determined step size 10^{\Hmacro}}%
			...
			\MIN=\csname pgfplotsmathlog#1@logten\endcsname\MIN\relax
			\H=\csname pgfplotsmathlog#1@logten\endcsname\H\relax
			\MINH=\MIN\relax
