...
%		\expandafter\pgfplotsgetdirectionstoconvexhullforsurf\expandafter{\pgfplotspointonorientedsurfacespec}{\pgfplots@tmp@dir@b}{\pgfplots@tmp@dir@n}%
%		% TODO :
%		% 1. use \pgfplotsgetdirectionstoconvexhullforsurf here.
		% 2. decide whether to use 'west' or 'east' for z axis.
		%   That's not yet solved. I fear it needs again canvas
		%   coordinate checks. Maybe I can prepare that stuff together
		%   with the positioning stuff for tick label pos? The check
		%   should be the same.
		\if0\pgfplots@ticklabelside
