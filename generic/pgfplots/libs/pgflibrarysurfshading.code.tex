%--------------------------------------------
% $Header: /cvsroot/pgfplots/pgfplots/generic/pgfplots/libs/pgflibrarysurfshading.code.tex,v 1.4 2009/02/28 19:54:07 ludewich Exp $
%
% Package pgfplots
%
...
\def\pgfplotssys@do@surfshading@fillpaths{%
	...
	\immediate\pdfobj {<<
		/Type /Pattern
		/PatternType 2
		% PGF's trafo matrix doesn't help. I need the canvas trafo
		% matrix :-(
%		/Matrix [\pgf@pt@aa\space\pgf@pt@ab\space\pgf@pt@ba\space\pgf@pt@bb\space\pgf@sys@tonumber\pgf@pt@x\space\pgf@sys@tonumber\pgf@pt@y]
		% FIXME DEBUG EXPERIMENT
		% these parameters belong to the global transformation matrix
		% of the tikzpicture. It appears they are needed here:
		/Matrix [1 0 0 1 226.533 518.141] 
		/Shading 
			% A debug switch:
			\iftrue
	...
	\edef\pgfplots@loc@TMPa{%
		/pgfpatPlotsurface \the\pdflastobj\space 0 R
		%--------------------------------------------------
		% /pgfpatPlotsurface <<
		% 	/Type /Pattern
		% 	/PatternType 2
	...
	\pgfsys@setpatterncolored{Plotsurface}%
