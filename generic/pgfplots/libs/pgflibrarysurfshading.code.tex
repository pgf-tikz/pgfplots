%--------------------------------------------
% $Header: /cvsroot/pgfplots/pgfplots/generic/pgfplots/libs/pgflibrarysurfshading.code.tex,v 1.10 2009/03/03 22:26:06 ludewich Exp $
%
% Package pgfplots
%
...
\def\pgfplotslibrarysurfdraw{%
	...
	\pdfxform resources{
		/Pattern << \pgfplots@glob@TMPa >> % is that necessary? FIXME HACKERY
	}\pgfutil@tempboxa
	\leavevmode
