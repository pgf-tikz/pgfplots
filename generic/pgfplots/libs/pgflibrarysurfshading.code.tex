%--------------------------------------------
% $Header: /cvsroot/pgfplots/pgfplots/generic/pgfplots/libs/pgflibrarysurfshading.code.tex,v 1.11 2009/03/04 16:36:53 ludewich Exp $
%
% Package pgfplots
%
...
\def\pgfplotslibrarysurf@decode{%
	-16383.99998 16383.99998 % map TeX dimen contents 1:1
	-16383.99998 16383.99998
	0 10240 % phi: [ 0, 2^16-1 ] -> [ 0, X ] with phi(64000) = 10000 is the real maximum. Thus, phi(x) = 1/64 * x  and phi(2^16-1) is the decode limits.
}%
