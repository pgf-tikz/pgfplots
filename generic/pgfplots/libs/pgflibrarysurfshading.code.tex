%--------------------------------------------
% $Header: /cvsroot/pgfplots/pgfplots/generic/pgfplots/libs/pgflibrarysurfshading.code.tex,v 1.8 2009/03/03 12:46:55 ludewich Exp $
%
% Package pgfplots
%
...
\def\pgfplotslibrarysurf@decode@CDATAMAX{10000}
\def\pgfplotslibrarysurf@decode{%
	-16383.99998 16383.99998 % map TeX coordinates 1:1
	-16383.99998 16383.99998
	0 10306 % the 10000 should be used if CDATA is 64000 in binary encoding. Thus, 10306 has its equivalent at 65535
}%
...
\def\pgfplotslibrarysurfdraw{%
	...
	\pdfxform resources{
		/Pattern << \pgfplots@glob@TMPa >> % is that necessary?
	}\pgfutil@tempboxa
	\leavevmode
...
%		/Matrix [\pgf@pt@aa\space\pgf@pt@ab\space\pgf@pt@ba\space\pgf@pt@bb\space\pgf@sys@tonumber\pgf@pt@x\space\pgf@sys@tonumber\pgf@pt@y]
	...
	\expandafter\pgfutil@addpdfresource@patterns\expandafter{\pgfplots@glob@TMPa}%%
