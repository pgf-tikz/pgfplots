%--------------------------------------------
% $Header: /cvsroot/pgfplots/pgfplots/generic/pgfplots/libs/pgflibrarysurfshading.code.tex,v 1.5 2009/03/02 15:26:01 ludewich Exp $
%
% Package pgfplots
%
...
\def\pgfplotslibrarysurf@decode{%
	...
	-16384.9 16384.9
	0 65535% map cdata 1:1 ! It is a 2 byte integer.
}%
