...
%
% Input can be provided using
% - column names, 
%   	for example '/pgfplots/table/x=firstcol'
% - column indices,
%   	for example '/pgfplots/table/x index=3'
...
%   	 denote the input coordinate columns, the meta column (if any) and
%   	 configured, the error data (if any). It is allowed to provide
%   	 both, 'x' and 'x expr'.
%   	- \coordindex 
%   	- \lineno
%   	- \thisrow{<colname>}
%   	- \getthisrow{<colname>}{<\macro>}
%   The FPU will be used to generate content.
%   FIXME : this does only work for direct file input up to now.
%
% #1: arguments to \addplot[...]
% #2: arguments to table[...]
% #3: the argument of plot table{...}
