...
\def\pgfplots@addplotimpl@function@opt@#1#2#3#4#5{%
	...
	\ifpgfplots@translategnuplot
		\def\pgfplots@loc@TMPa{\pgfplotsutil@search@and@replace{^}{**}}%
...
%\message{executing \meaning\pgfplots@drawoptions'}%
			...
			\else
				...
				\else
					...
					\pgfplots@error{Sorry, the 'shader=interp' does not yet support 'mesh/ordering=colwise'... You continue now, but the plot will be transposed.}%
				\fi
