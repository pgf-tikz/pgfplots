...
% Takes the current values of
% - '/pgfplots/mesh/rows' 
% - '/pgfplots/mesh/cols'
% - '/pgfplots/mesh/num points'
% - \pgfplotsscanlinelength
% - '/pgfplots/mesh/ordering'
% and attempts to fill any missing values.
%
%
% #1 a integer which allows to configure how to deal with non-unique
% assignments. Use the following values:
% 0: leave 'rows' and 'cols' empty.
% 1: try to get reasonable defaults. If that proves to be impossible,
% issue an error message. If it is possible, provide a warning. In any
% case, rows and cols will be set to a number.
%
\def\pgfplotsautocompletemeshkeys#1{%
