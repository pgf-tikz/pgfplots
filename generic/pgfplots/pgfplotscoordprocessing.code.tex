...
\message{executing MODE '\meaning\pgfplots@drawmodes'}%
		...
		\if\pgfplotsplothandlermesh@ONEDIMMODE1
			% no filling in a onedimensional mesh mode.
			\let\pgfplotsplothandlermesh@usepath=\pgfusepathqstroke
		\fi
		%
		...
		\else
			...
			\def\pgfplotsplothandlermesh@preparedrawforcurrent{%
				\expandafter\pgfplotscolormapfind\expandafter[\pgfplotspointmetatransformedrange]
					[1.0]
					{\pgfplotsplothandlermesh@surfmode@cellcolor}
...
%\message{executing \meaning\pgfplots@drawoptions'}%
			...
			\ifcase\pgfplotsplothandlermesh@surfmode
				% 'flat corner':
				%
				...
				\t@pgfplots@tokb={%
					\pgfplots@perpointmeta@trafo@APPLY
					\let\pgfplotsplothandlermesh@surfmode@cellcolor=\pgfplotspointmetatransformed}%
			...
			\or
				...
				\fi
				\t@pgfplots@tokc={%
					\edef\pgfplotsplothandlermesh@surfmode@cellcolor{\pgf@sys@tonumber\pgfplots@tmpa}%
					\global\pgfplots@tmpa=0pt }%
				\edef\pgfplotsplothandlermesh@preparedrawforcurrent{%
					\the\t@pgfplots@tokb
					\the\t@pgfplots@tokc
...
\def\pgfplotsplothandlermesh@finish{%
	\ifnum\pgfplotsplothandlermesh@surfmode=2
