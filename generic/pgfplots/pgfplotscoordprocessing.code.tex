...
%		\scope
		...
		\else
			\pgfplots@error{Error: the arguments of plot[mesh/rows=\pgfplotsplothandlermesh@rows,mesh/cols=\pgfplotsplothandlermesh@cols] do NOT multiply to the total number of data points N = \pgfplotsplothandlermesh@numpoints! The data matrix appears to be incomplete...}%
		\fi
...
\message{executing MODE '\meaning\tikz@mode'}%
		\tikz@mode
		\iftikz@mode@fill
			\iftikz@mode@draw
...
%				\pgfplotsplothandlermesh@setcolor{mapped color}%
				% This activates tikz colors:
\message{executing \meaning\tikz@options'}%
				\tikz@options
			}%
		\fi
	}%
