...
\def\pgfplotspointonorientedsurfaceabmatchaxisline#1#2{%
	\edef\pgfplots@loc@TMPa{#1:\pgfplotspointonorientedsurfacespec}%
...
%  'v' :         is either a or b
%  '0' :         is either 0, a, b or 2 (i.e. NOT 1)
%  '1' :         is either 1, a, b or 2 (i.e. NOT 0)
% That's all. 
%
	...
	\else
		...
		\else
			\if1#1%
				...
				\fi
			\else
				\pgfplots@error{The character '#1' is no valid element for a three-character axis line description!}%
			\fi
		\fi
	\fi
}%
