		...
		\else
			...
			\def\pgfplotsplothandlermesh@preparedrawforcurrent{%
				\expandafter\pgfplotscolormapfind\expandafter[\pgfplotspointmetatransformedrange]
					[1.0]
					{\pgfplotsplothandlermesh@flatmode@cellcolor}
...
%\message{executing \meaning\pgfplots@drawoptions'}%
			...
			% Now, process the 'mesh/flat mode=corner|mean  key here:
			\if\pgfplotsplothandlermesh@flatmode0%
				...
				\t@pgfplots@tokb={%
					\pgfplots@perpointmeta@trafo@APPLY
					\let\pgfplotsplothandlermesh@flatmode@cellcolor=\pgfplotspointmetatransformed}%
				\edef\pgfplotsplothandlermesh@preparedrawforcurrent{%
					\the\t@pgfplots@tokb
					\the\t@pgfplots@toka
				}%
			\fi
			\if\pgfplotsplothandlermesh@flatmode1
				...
				\fi
				\t@pgfplots@tokc={%
					\edef\pgfplotsplothandlermesh@flatmode@cellcolor{\the\pgfplots@tmpa\relax}%
					\global\pgfplots@tmpa=0pt }%
				\edef\pgfplotsplothandlermesh@preparedrawforcurrent{%
					\the\t@pgfplots@tokb
					\the\t@pgfplots@tokc
