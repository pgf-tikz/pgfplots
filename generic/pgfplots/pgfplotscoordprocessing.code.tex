...
\def\pgfplotspointoutsideofaxis#1#2#3{%
	...
	\let\pgfplotspointoutsideofaxis@plug@addtolimit=\pgfplotspointoutsideofaxis@addtolimit@
	\edef\pgfplots@loc@TMPa{#1}%
...
\def\pgfplotspointouternormalvectorofaxis#1{%
	\def\pgfplotspointoutsideofaxis@plug@trafo##1##2{\def\pgfmathresult{##2}}%
	\def\pgfplotspointoutsideofaxis@plug@addtolimit##1##2##3{\def\pgfmathresult{##3}}%
	\edef\pgfplots@loc@TMPa{#1}%
...
\def\pgfplotspointoutsideofaxis@#1#2#3\relax#4#5{%
	\if v#1%
		\def\pgfplots@loc@point@orthogonal@to@v##1##2{%
			...
			\pgfplotspointoutsideofaxis@plug@addtolimit{y}{#2}{##1}\let\pgfplots@loc@TMPb=\pgfmathresult
			\pgfplotspointoutsideofaxis@plug@addtolimit{z}{#3}{##2}\let\pgfplots@loc@TMPc=\pgfmathresult
	...
	\else
		\if v#2%
			\def\pgfplots@loc@point@orthogonal@to@v##1##2{%
				...
				\pgfplotspointoutsideofaxis@plug@addtolimit{x}{#1}{##1}\let\pgfplots@loc@TMPb=\pgfmathresult
				\pgfplotspointoutsideofaxis@plug@addtolimit{z}{#3}{##2}\let\pgfplots@loc@TMPc=\pgfmathresult
		...
		\else
			\def\pgfplots@loc@point@orthogonal@to@v##1##2{%
				...
				\pgfplotspointoutsideofaxis@plug@addtolimit{x}{#1}{##1}\let\pgfplots@loc@TMPb=\pgfmathresult
				\pgfplotspointoutsideofaxis@plug@addtolimit{y}{#2}{##2}\let\pgfplots@loc@TMPc=\pgfmathresult
