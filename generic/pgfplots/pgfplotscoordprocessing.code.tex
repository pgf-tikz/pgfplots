...
% Returns either '' (empty) or - for each of the two variing sides of the
% oriented surface described by #1.
%
% The output value #2 = '' means that the positive b axis points to
% the direction of the convex hull of the projected axis.
%
...
\def\pgfplotsgetdirectionstoconvexhullforsurf#1#2#3{%
	% FIXME
	\pgfplots@error{ FIXME IMPLEMENT}%
}
