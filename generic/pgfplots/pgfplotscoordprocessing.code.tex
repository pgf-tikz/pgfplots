...
% \pgfplotsqpointoutsideofaxis and its variants (and, in fact, it used
% the same code).
...
\def\pgfplotspointoutsideofaxis@#1#2#3\relax#4#5{%
	...
	%
	% 
	% Now, compute the outer normal vector:
	...
	\edef\pgfplots@loc@TMPa{\pgf@sys@tonumber\pgf@xa}%
	%
	% scale outer normal vector by '#5':
	...
	%
	% Ok, apply the unit vector and move along the chosen axis:
