	...
	\else%
		...
		\def\pgfplots@plot@data{\pgfplotgnuplot[\pgfplots@plot@filename]{%
			...
			\ifpgfplots@xislinear
				\ifpgfplots@yislinear
				\else
					set logscale y 2.71828182845905; 
				\fi
			\else 
				\ifpgfplots@yislinear
					set logscale x 2.71828182845905; 
				\else
					set logscale xy 2.71828182845905; 
				\fi
			\fi
