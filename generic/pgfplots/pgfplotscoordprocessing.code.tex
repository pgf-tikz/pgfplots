...
\long\def\pgfplots@PREPARE@COORD@STREAM#1#2{%
	...
	\def\pgfplots@coord@stream@start@{%
		...
		\fi
		\pgfplotsmathdeclarepseudoconstant{x0}{\let\pgfmathresult=\pgfplots@current@point@x}%
		\pgfplotsmathdeclarepseudoconstant{x1}{\let\pgfmathresult=\pgfplots@current@point@y}%
		\pgfplotsmathdeclarepseudoconstant{x2}{\let\pgfmathresult=\pgfplots@current@point@z}%
...
\long\def\pgfplots@addplotimpl@expression@#1#2#3#4#5{%
	...
	\pgfplotsmathdeclarepseudoconstant{x}{\edef\pgfmathresult{\tikz@plot@var}}%
