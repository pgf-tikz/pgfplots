...
\def\pgfplotspoint@initialisation{%
	\global\let\pgfplotspointouternormalvectorofaxis@cache@x=\relax
	\global\let\pgfplotspointouternormalvectorofaxis@cache@y=\relax
	\global\let\pgfplotspointouternormalvectorofaxis@cache@z=\relax
}%
...
\def\pgfplotspointouternormalvectorofaxis@#1#2#3\relax{%
	...
	%
	% Ok, compute and normalize normal vector:
	\pgf@process{%
		\pgfpointnormalised
