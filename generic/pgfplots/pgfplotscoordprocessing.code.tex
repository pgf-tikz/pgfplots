...
%\message{executing \meaning\pgfplots@drawoptions'}%
			...
			\or
				...
				\fi
				\t@pgfplots@tokc={%
					\edef\pgfplotsplothandlermesh@surfmode@cellcolor{\the\pgfplots@tmpa\relax}%
					\global\pgfplots@tmpa=0pt }%
				\edef\pgfplotsplothandlermesh@preparedrawforcurrent{%
					\the\t@pgfplots@tokb
					\the\t@pgfplots@tokc
			...
			\or
				...
				\let\pgfplotslibrarysurf@cols=\pgfplotsplothandlermesh@cols
...
\def\pgfplotsplothandlermesh@finish{%
	\ifnum\pgfplotsplothandlermesh@surfmode=2
		...
		\def\pgfplots@clippath@use{fill,stroke}%
