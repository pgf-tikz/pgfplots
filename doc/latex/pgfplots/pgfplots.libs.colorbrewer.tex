...
|cycle list| with markers, you should make use of the features |cycle multi
...
|colormap|'s mean value fits the data (for example by forcing |point meta
min=-2| and |point meta max=+2|).
...
\begin{itemize}
    ...
    \item If you should need let's say the 5th color of the scheme
        ...
        |\tikz \fill[index of colormap={4 of GnBu-7}] (0,0) rectangle
        (1em,2ex);|
