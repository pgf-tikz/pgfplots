...
\end{codeexample}
	...
	The second possibility \declareandlabel{coordinate/.from} is unconditional and defines style information from a common source. Its major use is to define a source which expands to different values for each point, for example using |\thisrow|:
\begin{codeexample}[]
\begin{tikzpicture}
\begin{axis}
\addplot+ [
