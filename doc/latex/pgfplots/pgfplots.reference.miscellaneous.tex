...
One possible application is shown below\footnote{This example from the game theory was provided by Pavel Stříž.}: suppose you want to use |\usepackage{ocg}| in order to switch layers dynamically, for example in a beamer package. This can be implemented as follows:
