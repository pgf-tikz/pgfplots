...
\end{codeexample}
	...
	In case you are not interested in math expressions (for reasons of speed or in case you have string symbols), you can use the prefix `|value|' before the argument, i.e.
