...
If you use |latex| / |dvips| or |pdflatex|, no further modifications are necessary. For |dvipdfm|, you should use |\def\pgfsysdriver| line as indicated above in the examples (see also section~\ref{sec:drivers}).
