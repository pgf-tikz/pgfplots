...
\begin{pgfplotskey}{boxplot/estimator=\mchoice{value} (initially legacy)}
	...
	The choice \declaretext{legacy} is the one which was shipped with the first version of the |statistics| library. It is merely kept for reasons of backwards compatibility. 
\end{pgfplotskey}
