...
\end{tikzpicture}
\end{codeexample}
Note that \verbpdfref{\addplot3} allows to process three--dimensional input types, but the result will always be two--dimensional (the $z$ coordinate is ignored for point placement). However, the $z$ coordinate can be used to determine point colors (using |point meta=z|.
