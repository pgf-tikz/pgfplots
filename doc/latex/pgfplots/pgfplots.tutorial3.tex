...
\lstinputlisting[columns=fixed,breaklines=false,tabsize=15,lastline=6]{plotdata/concat_VV_together_grid.dat}
...
There is much more to say about |scatter| plots, and about |nodes near coords|. Please consider this subsection as a brief pointer to the respective sections in the reference manual.
