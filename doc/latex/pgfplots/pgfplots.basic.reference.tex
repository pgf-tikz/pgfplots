...
\end{codeexample}
	...
	\url{https://tex.stackexchange.com/a/141006/1537}: it demonstrates how to place the nodes generated by |nodes near coords| based on the value (either inside of a bar or above it).
