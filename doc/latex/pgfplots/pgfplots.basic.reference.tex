...
\end{codeexample}
    ...
    In \PGFPlots{}, the key |/pgfplots/use fpu| \todosp{cannot find this key
    anywhere else in the manual} is typically on, which means
...
\begin{commandlist}{%
    ...
    %
    \todosp{I assume there should be drawn a circle right?}
\begin{codeexample}[]
\begin{tikzpicture}
