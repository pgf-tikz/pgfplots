...
\def\pgfplotsexpensiveexample{%
	...
	\else
		\message{[NOTE: I am now about to typeset an expensive example. You will need to ENLARGE YOUR TeX MEMORY CAPACITIES if this fails - or use \string\pgfplotsmanualexternalexpensivetrue.]}%
	\fi
}%
...
\newenvironment{addplot3generic}{
  \begin{pgfmanualentry}
    ...
    \index{addplot3@\protect\textcolor{gray}{\protect\texttt{\protect\textbackslash addplot3}}}%
	}%
    \pgfmanualbody
}
{
