...
\pgfkeys{
	...
	%/codeexample/prettyprint/key value/colormap/.code 2 args={\{#1\}\{\pgfmanualprettyprintpgfkeys{#2}\}},
	%/codeexample/prettyprint/key value/of colormap/.code={\pgfmanualprettyprintpgfkeys{#1}},
	%/codeexample/prettyprint/key value/samples of colormap/.code={\pgfmanualprettyprintpgfkeys{#1}},
	%/codeexample/prettyprint/key value/colors of colormap/.code={\pgfmanualprettyprintpgfkeys{#1}},
	%
	%
