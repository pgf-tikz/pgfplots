...
\def\pgfplotsshortxystylekey #1=#2\pgfeov{%
	...
	\begin{pgfplotsxykey}{#1=\marg{key-value-list}}
		...
		(or the respective style for $y$, {\def\x{y}\texttt{\pgfmanualpdfref{#2}{#2}/\pgfmanualpdfref{/handlers/.append style}{.append style}=}\marg{key-value-list}, and $z$, {\def\x{z}\texttt{\pgfmanualpdfref{#2}{#2}/\pgfmanualpdfref{/handlers/.append style}{.append style}=}}\marg{key-value-list}).
