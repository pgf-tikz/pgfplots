...
\pgfkeys{%
	/codeexample/prettyprint/autolinks/.style={%
		...
		/codeexample/prettyprint/key value display only/.code={\pgfplotshyperref{##1}{##1}},
...
\def\pgfplotshyperlabel#1#2{%
	...
	\pgfutil@ifundefined{pgfplotsmanual@wrotehyperlabel@#1}{%
		\immediate\write\@auxout{%
			\noexpand\expandafter\noexpand\gdef
			\noexpand\csname pgfplotsmanual@hashyperlabel@#1\noexpand\endcsname{1}%
		}%
		\expandafter\gdef\csname pgfplotsmanual@hashyperlabel@#1\endcsname{1}%
		\expandafter\gdef\csname pgfplotsmanual@wrotehyperlabel@#1\endcsname{1}%
...
\def\pgfplotshyperref#1#2{%
	\begingroup
	\def\textbackslash{}% FIXME
	\edef\pgfplotshyperlabel@@{#1}%
	\pgfutil@ifundefined{pgfplotsmanual@hashyperlabel@#1}{%
		% try the /pgfplots/, /tikz/ and '\' prefixes...
		\pgfutil@ifundefined{pgfplotsmanual@hashyperlabel@/pgfplots/#1}{%
			\pgfutil@ifundefined{pgfplotsmanual@hashyperlabel@/tikz/#1}{%
				\pgfutil@ifundefined{pgfplotsmanual@hashyperlabel@\pgfmanual@pretty@backslash#1}{%
					\pgfplots@warning{pgfplotshyperref{#1}: target label does not exist.}%
					#2%
				}{%
					\edef\pgfplotshyperlabel@@{\pgfmanual@pretty@backslash\pgfplotshyperlabel@@}%
				}%
			}{%
