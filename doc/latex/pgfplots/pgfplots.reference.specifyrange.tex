...
\end{tikzpicture}
\end{codeexample}
	This access is possible inside of any axis description or any annotation (i.e. inside of |\node|, |\draw| or |\path|), but not inside of |\addplot| (limits may not be complete at this stage).
