...
\begin{enumerate}
	\item \PGFPlots\ has a new feature which allows to \emph{move axis labels tight to tick labels} automatically.
...
\end{codeexample}
	...
	\item The |scatter/classes| feature now produces proper legends. This may change the appearance of existing legends of plots with |scatter/classes|.
...
\begin{pgfplotskey}{compat=\mchoice{newest,pre 1.3} (initially pre 1.3)}
...
\subsection{The Team}
\PGFPlots\ has been written by Christian Feuersänger with the help of Pascal Wolkotte and Nick Papior Andersen as a spare time project. We hope it is useful and provides valueable plots.
...
I thank God for all hours of enjoyed programming. I thank Pascal Wolkotte, author of package |pgfgraph|, who joined development and contributed code for axis lines and tick alignment. I thank Stefan Tibus, who contributed the |plot shell| feature. I thank Tom Cashman for the contribution of the |reverse legend| feature. Furthermore, I thank Dr.~Schweitzer for many fruitful discussions and Dr.~Meine for his ideas and suggestions.
