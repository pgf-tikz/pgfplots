...
\title{%
	...
	Attention: you are using an unstable development version.
}
...
\begin{pgfplotskey}{compat=\mchoice{1.4,1.3,pre 1.3,default,newest} (initially default)}
...
\end{codeexample}
	...
	\PGFPlots\ version 1.4 fixes some small bugs related to axis scaling. This might lead to differences of $1--2\text{pt}$ compared to earlier versions. Use the choice |1.3| (or earlier) to disable these fixes.

	\PGFPlots\ version 1.3 comes with new features which may lead to significiantly different spacings compared to earlier versions:
	\begin{enumerate}
