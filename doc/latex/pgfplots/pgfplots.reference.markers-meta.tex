...
Since creating a |cycle list| from a |colormap| necessarily results omits markers and line style variations, it makes sense to combine the result with |cycle multiindex* list|, i.e.\ to join two existing lists. The following example joins a pure color list with markers:
\begin{codeexample}[]
\begin{tikzpicture}
\begin{axis}[
    colormap name=hot,colorbar,
