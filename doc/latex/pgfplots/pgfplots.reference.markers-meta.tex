...
\end{codeexample}
    ...
    \declaretext{samples of colormap}|=|\marg{number}| of
    |\meta{colormap name}. It chooses \meta{number} samples of the selected
    colormap, using the same distance to the next.
...
\end{codeexample}
    ...
    The complete syntax on how to customize |of colormap| is the same as the
    building block to define |colormap|s based on other |colormap|s as
    described in Section~\ref{sec:pgfplots:colormaps:based:on:others} on
