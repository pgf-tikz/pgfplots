...
\subsection{Mapping Point Meta and Color Maps}
	...
	\begin{itemize}
		...
		\item Second, every encountered value $m$ is mapped to $[0,1000]$ using a linear map: $m_{\text{min}} \to 0$; $m_{\text{max}}\to 1000$, and all values in-between are mapped linearly. This value is available in |\pgfplotspointmetatransformed|.
