...
%\pgfplotsshowcolormapexample{rgb=(1,0,0) rgb=(0,1,0) rgb255=(0,0,255) gray=(0.3) color=(green)}
	...
	A convenience key which is equivalent to a sequence of |color of colormap(|\meta{length}|)|, one for each element in \meta{list}. The \meta{list} is evaluated using |\foreach|.
	...
	A convenience key which is equivalent to a sequence of \meta{number} occurences of |color of colormap(|\meta{length}|)|.
	...
	A convenience key which is equivalent to a sequence of |index of colormap(|\meta{length}|)|, one for each element in \meta{list}. The \meta{list} is evaluated using |\foreach|.
