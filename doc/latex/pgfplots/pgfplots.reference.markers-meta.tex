...
\begin{codeexample}[]
\definecolor{color1}{cmyk}{0.6,0.9,0.5,0.2}
\tikz \fill[color1] 
	(0,0) rectangle (1em,0.6em);
\end{codeexample}
\noindent creates the color with $0.6$ parts \showcolorandname{cyan}, $0.9$ parts \showcolorandname{magenta}, $0.5$ parts \showcolorandname{yellow} and $0.2$ parts \showcolorandname{black};
