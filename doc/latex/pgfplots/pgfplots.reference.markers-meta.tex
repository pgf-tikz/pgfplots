...
\end{codeexample}
		...
		will expect point meta data as explicitly provided coordinate from the input streams. This data will be called |meta|. In a second step, this data will be put into the mathematical expression |meta^2+3| which depends on |meta|.
	\end{description}
