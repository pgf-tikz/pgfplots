...
\begin{enumerate}
	...
	\item The |trim left| and |trim right| feature\footnotesize{This is the \emph{only} supported way of restricted bounding boxes and image externalization (at least for pdf output).}. 
\end{enumerate}
