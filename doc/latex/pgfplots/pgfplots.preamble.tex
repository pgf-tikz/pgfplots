...
{
	\makeatletter
	\toks0=\expandafter{\pgfmanual@pretty@activepercent}%
	\toks1=\expandafter{\preambleconfig}%
	\toks2=\expandafter{\pgfmanual@pretty@activenl}%
	\xdef\tempb{%
		\noexpand\pgfkeys{/codeexample/typeset listing/.add code=
			{
			\noexpand\ifcode@execute
				\noexpand\pgfutil@in@{axis}{##1}%
				\noexpand\ifpgfutil@in@
					%\the\toks0
					\% Preamble: \noexpand\pgfmanualpdfref{\noexpand\textbackslash pgfplotsset}{\pgfmanual@pretty@backslash pgfplotsset}%
						\pgfmanual@pretty@lbrace \noexpand\pgfmanualprettyprintpgfkeys{\the\toks1 }\pgfmanual@pretty@rbrace %\the\toks2
				\noexpand\fi
			\noexpand\fi
			}{}
		}%
