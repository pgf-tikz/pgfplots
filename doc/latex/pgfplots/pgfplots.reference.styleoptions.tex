...
\begin{pgfplotsxykeylist}{%
	...
	These options modify parts of the axis line styles. They append options to |every inner x axis line| and |every outer x axis line| and the respective $y$ variants.
