...
\begin{keylist}{%
    ...
    These \todosp{why is the first value green and the second black?} two keys allow to reduce the size of the bounding box.
...
\begin{pgfplotskey}{%
    ...
    This key is controlled by the |compat| level. Its default is |default
    tikz|. Since |compat=1.8|, it is set to |upper bound|.
