...
While bounding box restrictions allow to reduce the picture's final size while keeping the same graphical output, clipping incluences both the picture size and the visible output.
