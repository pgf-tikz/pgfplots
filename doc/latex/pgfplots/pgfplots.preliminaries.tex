...
\begin{enumerate}
  \item \PGFPlots\ 1.11 introduces |\strut| for every default tick label. This allows tick labels to have the same baseline even if they have different heights.
