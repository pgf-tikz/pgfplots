...
\begin{enumerate}
	\item \PGFPlots\ 1.13 repairs axis labels in polar axis and ensures that the color chosen by |shader=flat| is independent of |z buffer| and |mesh/ordering|. Older compatibility levels are present to keep workarounds by end-users.
...
\begin{pgfplotskey}{compat=\mchoice{1.13,1.12,1.11,1.10,1.9,1.8,1.7,1.6,1.5.1,1.5,1.4,1.3,pre 1.3,default} (initially default)}
