...
\begin{enumerate}
	\item \PGFPlots\ 1.8 comes with a new revision for alignment of label- and tick scale label alignment. This revision is enabled with |compat=1.8| or higher.
...
\begin{pgfplotskey}{compat=\mchoice{1.8,1.7,1.6,1.5.1,1.5,1.4,1.3,pre 1.3,default} (initially default)}
