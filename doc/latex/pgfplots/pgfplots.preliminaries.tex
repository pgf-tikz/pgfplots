...
\end{codeexample}
        ...
        |enable tick line clipping|, \todosp{I cannot find this key anywhere
        else in the manual} and |boxplot/estimator|.
...
the |plot shell| feature. I thank Tom Cashman for the contribution of the
