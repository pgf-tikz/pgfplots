...
\begin{pgfplotskey}{%
	mesh/colorspace explicit color input=\mchoice{rgb,cmy,cmyk,gray,wave,hsb,HsB} (initially value of \texttt{colorspace explicit color output})%
}
\end{pgfplotskey}
