...
\end{codeexample}
	...
	The implementation of |mesh/interior colormap| works well for most examples; in particular, if the number of samples is large enough to resolve the boundary between inner and outer colormap. However, it might produce spurious artifacts if the mesh widths is too small. Consider using |mesh/refines=1| to refine your mesh automatically.
