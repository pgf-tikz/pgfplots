...
\end{codeexample}
		...
		Note that this specific colormap might benefit if each color has its specific legend. To this end, we could make use of |colorbar as legend|, i.e.\ using the following |colorbar|:
\begin{codeexample}[]
\pgfplotscolorbardrawstandalone[
	colormap={whiteblue}{color=(blue) 
		color=(white)},
...
\end{codeexample}
	...
	\begin{enumerate}
		...
		\item Undefining all of the items above in which case \PGFPlots\ will use as many contour levels as there are distinct colors in the current colormap.
	\end{enumerate}
