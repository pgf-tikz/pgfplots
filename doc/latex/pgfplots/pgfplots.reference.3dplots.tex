...
\begin{pgfplotskeylist}{patch table=\marg{table file name or inline table} (initially empty)}
...
\end{codeexample}
	...
	There are more values for |patch type| like \declaretext{bilinear}, \declaretext{triangle quadr}, \declaretext{biquadratic} and \declaretext{coons}. Please refer to the separate |patchplots| library in Section~\ref{sec:lib:patchplots}.
\end{pgfplotskey}
