...
\end{codeexample}
	...
	If you'd like to have individually colored segments inside of contours, you have to use a different plot handler. There is a simple alternative which works well in many cases: you can use a standard |mesh| plot combined with |patch type=line|:
...
\end{tikzpicture}
\end{codeexample}
	\noindent The preceding example uses a fixed |draw color| and |x filter|, |y filter|, and |z filter| to fix the contours in one of the axis planes.
