...
\end{tikzpicture}
\end{codeexample}
\noindent Note that this plot implicitly has |mesh/rows=1| because it has no end--of--scanline markers (empty lines). If in doubt, you can set |mesh/rows=1| explicitly to tell \PGFPlots\ that you have one--dimensional data (and not a matrix).
