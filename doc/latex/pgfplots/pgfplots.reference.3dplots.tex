...
\end{codeexample}
	...
	Typically, |filled contour| will be customized either by means of a |number|
	of contour lines or by selecting a list prescribed |levels|.
...
\end{tikzpicture}
\end{codeexample}
	The example above re-uses the colormap already explained in the documentation for |target pos min|: it concatenates two |of colormap| specifications and assigns specific |target pos|itions. The data file is shipped with \PGFPlots.
...
\pgfplotscolorbardrawstandalone[
	...
	of colormap/target pos max*=2050,
