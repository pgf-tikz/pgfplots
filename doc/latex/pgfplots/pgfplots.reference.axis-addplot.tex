...
\end{codeexample}
	...
	\item The accepted input format of tables is as follows:
		\begin{itemize}
			...
			Alternatively, you can use |row sep=\\| which enables `|\\|' as row separator. This is necessary if newline characters have been converted to white spaces by \TeX's character processing before \PGFPlots\ had a chance to see them. This happens if inline tables are provided inside of macros. Use |row sep=\\| and separate the rows by `|\\|' if you experience such problems. This is documented in more detail in the \PGFPlotstable\ manual which comes with \PGFPlots.
