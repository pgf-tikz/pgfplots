...
\begin{pgfplotskeylist}{%
	...
	The same variables are used for parametric and for non-parametric plots. Use |variable=t| to change them if you like (for |gnuplot|, there is such a distinction; see |gnuplot/parametric var1d|).
...
\begin{itemize}
	...
	For |parametric| plots, the variable names need to adjusted with |gnuplot/parametric var 1d| and |gnuplot/parametric var 2d| (since gnuplot uses |t| and |u,v| as initial values for |parametric| plots).
	\item 
...
\begin{pgfplotskeylist}{%
	gnuplot/parametric var 1d=\marg{variable name} (initially t),%
	gnuplot/parametric var 2d=\marg{variable name,variable name} (initially {u,v})%
	}
	...
	These keys are quite the same as |variable| and |variable y|, only for parametric plots. If you like to change variable for non-parametric plots, use |variable| and/or |variable y|.

	In case you don't want the distinction between parametric and non-parametric plots, use 
	
	|\pgfplotsset{gnuplot/parametric var 1d=,gnuplot/parametric var 2d=}|.
