...
\begin{pgfplotskey}{plot coordinates/math parser=\mchoice{true,false} (initially true)}
	An optimization which allows mathematical expressions in every coordinate inside of |plot coordinates|. It might improve speed to disable the math parser here.

	It is necessary to disable |plot coordinates/math parser| if you use some sort of symbolic transformations.
\end{pgfplotskey}
