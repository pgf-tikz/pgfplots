...
\begin{itemize}
	...
	For |parametric| plots, the variable names need to adjusted with |parametric/var 1d| and |parametric/var 2d| (since gnuplot uses |t| and |u,v| as initial values for |parametric| plots).
	\item 
