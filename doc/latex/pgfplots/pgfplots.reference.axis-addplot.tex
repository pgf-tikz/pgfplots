...
\begin{key}{/pgfplots/table/search path=\marg{comma-separated-list} (initially .)}
	...
	Use |.| to search in the current working directory. If the argument list contains no |.|, it will be prepended in front of all other values. If you want to search all other directories first, you have to provide `|.|' explicitly somewhere in the list.
