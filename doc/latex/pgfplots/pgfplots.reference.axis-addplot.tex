...
\paragraph{Warning:} The feature is only 95\% stable yet and may need some more testing. Use at your own risk.\\[0.5cm]
...
\begin{itemize}
	\item It must be possible to deduce the origin and the three (two--dimensional) unit vectors from the four provide |points|; the algorithm will fail otherwise. 
