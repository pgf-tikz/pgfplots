...
\end{codeexample}
	...
	Furthermore, a technical thing happens: the style |log basis ticks=|\marg{axis char} will be installed (for example |log basis ticks=y|). This style in turn will change |log number format code|.
