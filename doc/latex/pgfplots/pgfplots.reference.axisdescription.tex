...
Note that three dimensional axes only support \emph{either} |axis lines=box| \emph{or} |axis lines=center|, nothing in-between. See section~\ref{sec:pgfplots:axislines:3d} for examples of three dimensional axis line variations.
\end{pgfplotskeylist}
