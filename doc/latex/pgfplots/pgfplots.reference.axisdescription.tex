...
\end{codeexample}
	...
	\begin{stylekey}{/pgfplots/every legend macro picture}
		A style which is installed when |legend to macro| is used outside of a picture: a new picture will be created with |\tikz[/pgfplots/every legend macro picture]|. 
