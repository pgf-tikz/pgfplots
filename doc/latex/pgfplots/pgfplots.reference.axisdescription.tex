...
\begin{anchorlist}{near xticklabel opposite,near yticklabel opposite,near zticklabel opposite,near ticklabel opposite}
	...
	Mathematically speaking, the only difference is the sign in front of the normal vector.
...
\begin{tikzpicture}
    \begin{axis}[
        ...
        \fill[blue] (I.north east) circle(1pt);
        \fill[blue] (O.south west) circle(1pt);
		...
		\draw[green,-stealth] (yticklabel* cs:1) -- (yticklabel cs:1);
		\draw[blue] (yticklabel cs:1) -- (I.north east);
