...
Three dimensional axes also benefit from the |axis lines=box| or |axis lines=center| styles discussed in section~\ref{sec:pgfplots:axislines}. We only provide some examples here.

Note, however, that you can't mix different styles like |axis x line=center,axis z line=top|.
