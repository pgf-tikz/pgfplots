...
\begin{enumerate}
	...
	Consider using the |restrict x to domain*=|\meta{min}|:|\meta{max} key in such a case, where the \meta{min} and \meta{max} should be four times (say) of your axis limits (see page~\pageref{key:restrict:x:to:domain} for details).
