...
\begin{bug}[prio=8]
	stacked plots seem to fail if there are negative axis limits...!?

	see \url{http://tex.stackexchange.com/questions/196366/stacked-bar-plot-with-explicit-axis-domain}

	It works as soon as one adds \verb|disabledatascaling|
\end{bug}
