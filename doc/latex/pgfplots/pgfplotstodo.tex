...
pgfplotstests		&	for 1.5.1	&	for 1.5		& for 1.4		&2009-12-30					\\
manual				&	for 1.5.1	&	for 1.5		& for 1.5		&	\\
pgfplotstable.pdf	&	for 1.5.1	&	for 1.5		& for 1.5\\
...
1.5.1 todo:
\begin{enumerate}
	\item version number + revision number
	\item tag
	\item all test verifications (see above)
\end{enumerate}
...
\begin{doctodo}
	Using \verb|hide axis| or \verb|axis lines=none| causes the axis to vanish -- but it will still consume space due to the clip path!

	Document that \verb|clip=false| removes this clip path.
