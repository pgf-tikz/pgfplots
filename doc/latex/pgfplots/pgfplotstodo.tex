...
regressiontests		&	for 1.8	&	for 1.8		& for 1.8 (7\% fail)		&2009-12-30					\\
unittests			&	for 1.8	&   for 1.8     &               &     \\
manual				&	for 1.8	&	for 1.6		& for 1.5		&	\\
pgfplotstable.pdf	&	for 1.8	&	for 1.6		& for 1.5\\
example	latex		&	for 1.8	&	for 1.8     & 2009-12-30					\\
example	context		&	for 1.8	&	for 1.8     & 2009-12-30				\\
example	plain tex	&	for 1.8	&	for 1.8     & 2009-12-30				\\
tests context		&	for 1.8	&   for 1.8\\
\end{tabular}
...
\begin{bug}
	one cannot provide an empty inline table
\end{bug}
...
\begin{feature}
	the \verb|...| syntax in tick label position lists is inherently limited to $[-16384,16384]$ (it inherits the limitations of |\foreach|). Think about alternatives
\end{feature}
...
\begin{feature}
	...
	see \href{http://tex.stackexchange.com/questions/102798/for-stacked-bar-chart-how-to-render-zero-height-bars-as-invisible}
