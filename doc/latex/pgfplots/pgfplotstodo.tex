...
\begin{feature}[epic=Usability]
	...
	\begin{itemize}
		\item ensure that only ``plot--related'' items are replaced (not tikz basic stuff)
			...
			\end{itemize}
		\item modify all related functions
			\begin{itemize}
				\item sin
				\item cos
				\item tan
...
\begin{feature}[epic=Usability]
	...
	Is there a way to simplify operations like \url{http://tex.stackexchange.com/questions/172917/pgfplots-and-using-axis-cs-to-add-points} ?
\end{feature}
