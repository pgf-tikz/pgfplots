...
\begin{bug}[epic=boxplots, prio=6]
	...
	\url{http://www.compileonline.com/execute_r_online.php}

	\verb|quantile(x <- c(1,2, 3, 4,5), c(0.5), type = 5)|
\end{bug}

\begin{bug}{epic=boxplots,prio=8}
	boxplot statistics computation is non-standard and possibly wrong
