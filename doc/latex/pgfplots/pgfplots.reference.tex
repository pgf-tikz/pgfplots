...
\subsubsection{Combining Mathematical Expressions And File Data}
...
\label{pgfplots:addplot:table:expr}
	Besides the already discussed possibility to provide a column selection by means of column names (\declaretext{x}|=|\meta{name} or \declaretext{x index}|=|\meta{index}), it is also possible to provide mathematical expressions as arguments.
