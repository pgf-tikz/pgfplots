...
\label{pgfplots:scatter:src}
	...
	The value of |scatter src| determines how to get this data. 
	...
	Finally, it is possible to provide an arbitrary mathematical expression which involves zero, one or more of the values \declaretext{x} (the current $x$ coordinate), \declaretext{y} (the current $y$ coordinate), \declaretext{z} (the current $z$ coordinate).
