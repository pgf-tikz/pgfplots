...
\begin{style}{/pgfplots/every 3d description}
	\FIXME{document}
\end{style}

\begin{style}{/pgfplots/every 3d view {\meta{h}}{\meta{v}}}
	A style which can be used for fine tuning of the output for specific views.

	This style will be installed right after |every 3d description|.
