...
\addplot function[id=tan0,forget plot,domain=-1.5*pi+0.003:-0.5*pi-0.003] {tan(x)};
\addplot function[id=tan1,forget plot,domain=-0.5*pi+0.003: 0.5*pi-0.003] {tan(x)};
\addplot function[id=tan2,            domain= 0.5*pi+0.003: 1.5*pi-0.003] {tan(x)};
\legend{$\tan(x)$}
\end{axis}
\end{tikzpicture}
\end{codeexample}
...
\begin{tikzpicture}
	\begin{axis}[axis equal=false]
		\addplot[blue] function[domain=0:2*pi,samples=300] {sin(x)*sin(2*x)};
	\end{axis}
\end{tikzpicture}
\hspace{1cm}
\begin{tikzpicture}
...
\begin{tikzpicture}
	\begin{loglogaxis}[axis equal=false]
		\addplot function[domain=0:10000] {x**-2};
	\end{loglogaxis}
\end{tikzpicture}
\hspace{1cm}
\begin{tikzpicture}
