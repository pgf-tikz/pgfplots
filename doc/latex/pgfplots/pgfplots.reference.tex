...
\begin{command}{\pgfplotscolormaptoshadingspec\marg{colormap name}\marg{right end size}\marg{\textbackslash macro}}
	A command which converts a colormap into a \PGF\ shading's color specification for use in |\pgfdeclare*shading| (see the \PGF\ manual~\cite{tikz} for details).
...
\begin{pgfplotskeylist}{
	font=\mchoice{\textbackslash normalfont,\textbackslash small,\textbackslash tiny,$\dotsc$},
	max space between ticks=\marg{integer},
