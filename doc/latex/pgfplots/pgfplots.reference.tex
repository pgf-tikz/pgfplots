...
\end{tikzpicture}
\end{codeexample}
	This onedimensional |mesh| plot is actually a special case of the twodimensional mesh plots, so more detailled configuration, including how to change the color data, can be found in section~\ref{sec:2d:mesh}.
