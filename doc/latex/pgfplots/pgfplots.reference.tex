...
\begin{pgfplotsxycodekeylist}{
	...
	The output coordinate transformation |x coord inv trafo| is applied to tick positions just before evaluating the |xticklabel| and |yticklabel| keys. In fact, the tick label code may even use additional macros defined by the inverse transformation.
