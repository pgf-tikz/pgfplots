...
Of course, it is relatively simple to get the same coordinates with \declaretext{axis description cs}, except that |ticklabel cs| always knows the tick label sizes. However, |ticklabel cs| becomes far superior when it comes to three dimensional positioning:
...
\end{codeexample}
	...
	The lower end of this line starts at the lower end of the associates axis (with coordinate |0|) while the upper end, indicated by the coordinate |1| is at the higher end of the axis. The value |0.5| is in the middle of the axis.
