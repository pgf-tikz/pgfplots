...
\begin{pgfplotskey}{inner axis line style=\marg{key-value-list}}
	A style which appends \marg{key-value-list} to both, |every inner x axis line| and the $y$ variant.
\end{pgfplotskey}

\begin{pgfplotskey}{axis line style=\marg{key-value-list}}
	A style which appends \marg{key-value-list} to \emph{all} axis line appearance styles.
\end{pgfplotskey}
