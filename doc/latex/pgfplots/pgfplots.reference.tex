...
\begin{pgfplotskey}{legend pos=\mchoice{south west,south east,north west,north east,outer north east}}
	...
	Each of these styles appends appropriate |at={(|\meta{x}|,|\meta{y}|)},anchor=|\meta{name} values to |every axis legend|.
...
\begin{pgfplotskeylist}{point meta min,point meta max}
	The values of these keys contain the lower and upper bound of the color map, i.e.\ the lower and upper limit for the color bar. They can be reference with |\pgfkeysvalueof{/pgfplots/point meta min}| inside of |every colorbar|.
\end{pgfplotskeylist}
