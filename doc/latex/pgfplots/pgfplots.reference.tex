...
Axis descriptions are labels for $x$ and $y$ axis and titles. Axis descriptions are drawn after the plot is finished and they are not subjected to clipping. Coordinates without unit like |(0,0)| or |(1.03,1)| are interpreted as coordinates in the \declaretext{axis description cs}:
...
\begin{tikzpicture}
	\tikzset{
		every pin/.style={opacity=0.5,fill=yellow,rectangle,rounded corners=3pt,font=\tiny},
		small dot/.style={fill=black,circle,scale=0.3}
	}
	\tikzstyle{every pin}=[fill=yellow!50!white,rectangle,rounded corners=3pt,font=\tiny]
	\begin{axis}[
		clip=false,
...
\end{codeexample}
	...
	\item To place axis labels in 3D, you will need to use \declaretext{ticklabel cs} in favor of |axis description cs|, see page~\pageref{sec:ticklabelcs}.
\end{itemize}
