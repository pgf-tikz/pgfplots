...
\begin{key}{/pgfplots/domain=\meta{start}:\meta{end} (initially [-5:5])}
	 ...
	 \paragraph{Remark for \Tikz-users:} |/pgfplots/domain| and |/tikz/domain| are independent options.
\end{key}
...
\begin{key}{/pgfplots/samples=\marg{number} (initially 25)}
	 ...
	 \paragraph{Remark for \Tikz-users:} |/pgfplots/samples| and |/tikz/samples| are independent options.
\end{key}
...
\end{codeexample}
	 ...
	 \paragraph{Remark for \Tikz-users:} |/pgfplots/samples at| and |/tikz/samples at| are independent options.
