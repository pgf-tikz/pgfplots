...
\begin{addplotoperation}[]{table}{[\meta{column selection}]\marg{file}}
...
\subsubsection{\texttt{\textbackslash label} and \texttt{\textbackslash ref} for Legend Entries}
\PGFPlots\ offers a |\label| and |\ref| feature for \LaTeX\ to reference legend entries \emph{outside} of a plot figure.
\begin{codeexample}[]
