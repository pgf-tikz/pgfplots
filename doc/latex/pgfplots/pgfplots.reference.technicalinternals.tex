...
\begin{pgfplotskey}{clip mode=\mchoice{global,individual} (initially individual)}
	...
	The choice \declaretext{individual} instructs \PGFPlots\ to install one clip path for \emph{every} |\addplot| command. Consequently, the plot will be clipped. But most importantly, its markers will be drawn immediately after the clip path has been deactivated.
