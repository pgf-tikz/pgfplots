...
\pgfkeys{%
	...
	/codeexample/prettyprint/key value/.code={#1},
...
\def\pgfmanual@pretty@pgfkeys@collectkey#1{%
	...
	\else
		\ifx\pgfmanual@loc@TMPb\pgfmanual@pretty@eq
			% finish key name.
			\edef\pgfmanual@pretty@pgfkeys@collectkey@keyname{\the\toks0 }%
			\expandafter\pgfmanual@pretty@pgfkeys@processkey\expandafter{\the\toks0 }%
			#1%
...
%		\xdef\pgfmanual@glob@TMPa{#1}%
%	\endgroup
%\message{PROCESSING VALUE \meaning\pgfmanual@glob@TMPa!}%
	\def\pgfmanual@loc@TMPa{\pgfkeysvalueof{/codeexample/prettyprint/key value/.@cmd}}%
	\pgfmanual@loc@TMPa#1\pgfeov
}
