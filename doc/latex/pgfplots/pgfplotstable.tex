...
\begin{key}{/pgfplots/table/percent is letter=\mchoice{true,false} (initially false)}
	...
	The value \declaretext{true} means that a percent is just a normal letter without special meaning. The value \declaretext{false} means that percent is special as it used to be.
\end{key}
