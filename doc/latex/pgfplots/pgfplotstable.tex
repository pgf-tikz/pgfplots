...
\begin{command}{\pgfmathisint\marg{number constant}\marg{true code}\marg{false code}}
...
\begin{codeexample}[]
15 \pgfmathisint{15}{is an int: \pgfretval.}{is no int}\hspace{1em}
15.5 \pgfmathisint{15.5}{is an int: \pgfretval.}{is no int}
\end{codeexample}
\end{command}
