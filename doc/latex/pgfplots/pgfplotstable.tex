...
\begin{stylekey}{/pgfplots/table/set content=\marg{content}}
	A style which redefines |assign cell contents| to always return the value \marg{content}.
\end{stylekey}
...
The default implementation of |assign| is to produce empty strings. The default implementation of |assign last| is to invoke |assign|, so in case you never really use the next row's value, you won't need to touch |assign last|.
\end{command}
