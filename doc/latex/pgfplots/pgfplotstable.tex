...
\end{codeexample}
	...
	A further speciality of |col sep=braces| is that it has limited support for \emph{multi-line} cells: everything within balanced braces is considered to be part of a cell. This includes newlines. However, you may need to write |\space| or |~| at the end of each line because the end--of--line char is stripped from input (to remove spurious spaces in all other cases).
\end{key}
