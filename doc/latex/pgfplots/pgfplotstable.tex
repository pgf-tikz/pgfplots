...
\begin{codekey}{/pgfplots/table/postproc cell content}
	Allows to \emph{modify} the already assigned cell content, possibly content-dependend. Ideas could be to draw negative numbers in red, typeset single entries in bold face or insert replacement text.
