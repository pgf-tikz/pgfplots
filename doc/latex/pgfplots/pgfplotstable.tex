...
\pgfplotstabletypesetfile[
	...
	{pgfplotstable.example1.dat}
\end{codeexample}
	You can also access column \emph{indices} with |columns/{[index]|\meta{number}|}/.style| or, equivalently, with |column indices/|\meta{number}|/.style|. You need the extra braces in the first case.
...
\pgfplotstabletypesetfile[
	columns/{[index]0}/.style={select equal part entry of={0}{2},string type},
	columns/{[index]1}/.style={select equal part entry of={0}{2},string type},
	columns/{[index]2}/.style={select equal part entry of={1}{2},string type},
	columns/{[index]3}/.style={select equal part entry of={1}{2},string type},
	columns={A,B,A,B},
	outfile=testX.tex
]
	{pgfplotstable.example2.dat}
\end{codeexample}
	The example above shows the original file as-is on the left side. The right side shows columns A,B,A,B~-- but only half of the elements are shown, selected by indices \#0 or \#1 of \#2. The parts are equally large, integer remainders are dropped.
\end{stylekey}
