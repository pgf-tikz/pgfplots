...
Note that this coordinate system is actually the default one whenever one writes graphical elements in an axis. Consequently, you can refer to this documentation as reference only; you do not really need it (as of |compat=1.11|).
