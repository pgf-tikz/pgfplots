...
\begin{pgfplotsxykeylist}{/data point/\x,data point/pos \meta{fraction}/\x}
...
\begin{tikzpicture}
	...
	node[pos=0.25] {%
		\pgfplotspointplotattime
		$(\pgfmathprintnumber[relative=0]{\pgfkeysvalueof{/data point/x}},
		  \pgfmathprintnumber[relative=0]{\pgfkeysvalueof{/data point/y}})$
	}
	node[pos=0.7] {%
		\pgfplotspointplotattime
		$(\pgfmathprintnumber{\pgfkeysvalueof{/data point/x}},
